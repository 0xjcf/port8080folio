  ...
  render() {
    this.shadowRoot.innerHTML = `
      ...
      <div class="intro-container">
        ...
        <p style="color: var(--jasper); font-size: 1.1rem; margin-bottom: 2rem;">
        ...
        <!-- Real-world insight for credibility -->
        <div style="margin-top: 2rem; padding: 1.5rem; background: rgba(13, 153, 255, 0.05); border-radius: 8px; border: 1px solid rgba(13, 153, 255, 0.1);">
          <p style="color: var(--jasper); font-weight: 600; margin: 0 0 0.5rem 0; display: flex; align-items: center; gap: 0.5rem;">
            <span style="font-size: 1.2rem;">💡</span> From My Experience
          </p>
          <p style="color: var(--teagreen); margin: 0;">
            After building 15+ production apps, I've learned that 90% of "complex" state problems are actually just missing the right mental model. State machines provide that model.
          </p>
        </div>
      </div>
    `;
