...
(exports.id = 283),
  ...
  (exports.modules = {
    5283: (e, t, s) => {
      s.r(t), s.d(t, { default: () => Fe, parsers: () => Oe });
      var i,
        r,
        a = Object.create,
          ...
          ((e, t, s, i) => {
            if ((t && 'object' == typeof t) || 'function' == typeof t)
              for (let s of h(t))
                !p.call(e, s) &&
                  undefined !== s &&
                  n(e, s, { get: () => t[s], enumerable: !(i = o(t, s)) || i.enumerable });
            return e;
          })(!t && e && e.__esModule ? s : n(s, 'default', { value: e, enumerable: !0 }), e)
        ),
        d =
          ((i = (e) => {
            function t(e, t) {
            ...
            function r(e, t) {
              let { line: i, column: r, index: a } = e;
              return new s(i, r + t, a + t);
            }
            var a = 'BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED',
              n = {
              ...
              h = (e) =>
                'UpdateExpression' === e.type ? o.UpdateExpression[`${e.prefix}`] : o[e.type],
              l = {
                ...
                InvalidLhs: ({ ancestor: e }) => `Invalid left-hand side in ${h(e)}.`,
                InvalidLhsBinding: ({ ancestor: e }) =>
                  `Binding invalid left-hand side in ${h(e)}.`,
                InvalidLhsOptionalChaining: ({ ancestor: e }) =>
                  `Invalid optional chaining in the left-hand side of ${h(e)}.`,
              ...
              u = Object.assign(
                {
                  ...
                  PipeUnparenthesizedBody: ({ type: e }) =>
                    `Hack-style pipe body cannot be an unparenthesized ${h({ type: e })}; please wrap it in parentheses.`,
                },
                {
                  PipelineBodyNoArrow:
            ...
            function f({ toMessage: e, code: t, reasonCode: i, syntaxPlugin: r }) {
              let a = 'MissingPlugin' === i || 'MissingOneOfPlugins' === i;
              {
                let e = {
              ...
              return function n(o, h) {
                ...
                return (
                  ...
                  (l.pos = o.index),
                  (l.syntaxPlugin = r),
                  a && (l.missingPlugin = h.missingPlugin),
                  m(l, 'clone', function (e = {}) {
                    var t;
                    let { line: i, column: r, index: a } = null != (t = e.loc) ? t : o;
                    return n(new s(i, r, a), Object.assign({}, h, e.details));
                  }),
                  m(l, 'details', h),
                  Object.defineProperty(l, 'message', {
                    configurable: !0,
                    get() {
                      let t = `${e(h)} (${o.line}:${o.column})`;
            ...
            function y(e, s) {
              ...
              for (let r of Object.keys(e)) {
                ...
                i[r] = f(
                  Object.assign(
                    { code: 'BABEL_PARSER_SYNTAX_ERROR', reasonCode: r, toMessage: l },
                    s ? { syntaxPlugin: s } : {},
                    h
                  )
                );
            ...
            var x = Object.assign(
                ...
                y(p),
                y`pipelineOperator`(u)
              ),
              { defineProperty: P } = Object,
              g = (e, t) => {
                e && P(e, t, { enumerable: !1, value: e[t] });
              };
            function T(e) {
            ...
            function L(e, t) {
              return j(e, { beforeExpr: S, binop: t });
            }
            var M = -1,
              D = [],
              O = [],
            ...
            function j(e, t = {}) {
              ...
              return (
                ++M,
                O.push(e),
                F.push(null != (s = t.binop) ? s : -1),
                B.push(null != (i = t.beforeExpr) && i),
                R.push(null != (r = t.startsExpr) && r),
                U.push(null != (a = t.prefix) && a),
                D.push(new N(e, t)),
                M
              );
            }
            ...
            var H = {
              bracketL: j('[', { beforeExpr: S, startsExpr: E }),
              bracketHashL: j('#[', { beforeExpr: S, startsExpr: E }),
              bracketBarL: j('[|', { beforeExpr: S, startsExpr: E }),
              bracketR: j(']'),
              bracketBarR: j('|]'),
              braceL: j('{', { beforeExpr: S, startsExpr: E }),
              braceBarL: j('{|', { beforeExpr: S, startsExpr: E }),
              braceHashL: j('#{', { beforeExpr: S, startsExpr: E }),
              braceR: j('}'),
              braceBarR: j('|}'),
              parenL: j('(', { beforeExpr: S, startsExpr: E }),
              parenR: j(')'),
              comma: j(',', { beforeExpr: S }),
              semi: j(';', { beforeExpr: S }),
              colon: j(':', { beforeExpr: S }),
              doubleColon: j('::', { beforeExpr: S }),
              dot: j('.'),
              question: j('?', { beforeExpr: S }),
              questionDot: j('?.'),
              arrow: j('=>', { beforeExpr: S }),
              template: j('template'),
              ellipsis: j('...', { beforeExpr: S }),
              backQuote: j('`', { startsExpr: E }),
              dollarBraceL: j('${', { beforeExpr: S, startsExpr: E }),
              templateTail: j('...`', { startsExpr: E }),
              templateNonTail: j('...${', { beforeExpr: S, startsExpr: E }),
              at: j('@'),
              hash: j('#', { startsExpr: E }),
              interpreterDirective: j('#!...'),
              eq: j('=', { beforeExpr: S, isAssign: I }),
              assign: j('_=', { beforeExpr: S, isAssign: I }),
              slashAssign: j('_=', { beforeExpr: S, isAssign: I }),
              xorAssign: j('_=', { beforeExpr: S, isAssign: I }),
              moduloAssign: j('_=', { beforeExpr: S, isAssign: I }),
              incDec: j('++/--', { prefix: C, postfix: !0, startsExpr: E }),
              bang: j('!', { beforeExpr: S, prefix: C, startsExpr: E }),
              tilde: j('~', { beforeExpr: S, prefix: C, startsExpr: E }),
              doubleCaret: j('^^', { startsExpr: E }),
              doubleAt: j('@@', { startsExpr: E }),
              pipeline: L('|>', 0),
              ...
              bitShiftL: L('<</>>/>>>', 8),
              bitShiftR: L('<</>>/>>>', 8),
              plusMin: j('+/-', { beforeExpr: S, binop: 9, prefix: C, startsExpr: E }),
              modulo: j('%', { binop: 10, startsExpr: E }),
              star: j('*', { binop: 10 }),
              slash: L('/', 10),
              exponent: j('**', { beforeExpr: S, binop: 11, rightAssociative: !0 }),
              _in: k('in', { beforeExpr: S, binop: 7 }),
              _instanceof: k('instanceof', { beforeExpr: S, binop: 7 }),
              _break: k('break'),
              _case: k('case', { beforeExpr: S }),
              _catch: k('catch'),
              _continue: k('continue'),
              _debugger: k('debugger'),
              _default: k('default', { beforeExpr: S }),
              _else: k('else', { beforeExpr: S }),
              _finally: k('finally'),
              _function: k('function', { startsExpr: E }),
              _if: k('if'),
              _return: k('return', { beforeExpr: S }),
              _switch: k('switch'),
              _throw: k('throw', { beforeExpr: S, prefix: C, startsExpr: E }),
              _try: k('try'),
              _var: k('var'),
              _const: k('const'),
              _with: k('with'),
              _new: k('new', { beforeExpr: S, startsExpr: E }),
              _this: k('this', { startsExpr: E }),
              _super: k('super', { startsExpr: E }),
              _class: k('class', { startsExpr: E }),
              _extends: k('extends', { beforeExpr: S }),
              _export: k('export'),
              _import: k('import', { startsExpr: E }),
              _null: k('null', { startsExpr: E }),
              _true: k('true', { startsExpr: E }),
              _false: k('false', { startsExpr: E }),
              _typeof: k('typeof', { beforeExpr: S, prefix: C, startsExpr: E }),
              _void: k('void', { beforeExpr: S, prefix: C, startsExpr: E }),
              _delete: k('delete', { beforeExpr: S, prefix: C, startsExpr: E }),
              _do: k('do', { isLoop: w, beforeExpr: S }),
              _for: k('for', { isLoop: w }),
              _while: k('while', { isLoop: w }),
              _as: _('as', { startsExpr: E }),
              _assert: _('assert', { startsExpr: E }),
              _async: _('async', { startsExpr: E }),
              _await: _('await', { startsExpr: E }),
              _defer: _('defer', { startsExpr: E }),
              _from: _('from', { startsExpr: E }),
              _get: _('get', { startsExpr: E }),
              _let: _('let', { startsExpr: E }),
              _meta: _('meta', { startsExpr: E }),
              _of: _('of', { startsExpr: E }),
              _sent: _('sent', { startsExpr: E }),
              _set: _('set', { startsExpr: E }),
              _source: _('source', { startsExpr: E }),
              _static: _('static', { startsExpr: E }),
              _using: _('using', { startsExpr: E }),
              _yield: _('yield', { startsExpr: E }),
              _asserts: _('asserts', { startsExpr: E }),
              _checks: _('checks', { startsExpr: E }),
              _exports: _('exports', { startsExpr: E }),
              _global: _('global', { startsExpr: E }),
              _implements: _('implements', { startsExpr: E }),
              _intrinsic: _('intrinsic', { startsExpr: E }),
              _infer: _('infer', { startsExpr: E }),
              _is: _('is', { startsExpr: E }),
              _mixins: _('mixins', { startsExpr: E }),
              _proto: _('proto', { startsExpr: E }),
              _require: _('require', { startsExpr: E }),
              _satisfies: _('satisfies', { startsExpr: E }),
              _keyof: _('keyof', { startsExpr: E }),
              _readonly: _('readonly', { startsExpr: E }),
              _unique: _('unique', { startsExpr: E }),
              _abstract: _('abstract', { startsExpr: E }),
              _declare: _('declare', { startsExpr: E }),
              _enum: _('enum', { startsExpr: E }),
              _module: _('module', { startsExpr: E }),
              _namespace: _('namespace', { startsExpr: E }),
              _interface: _('interface', { startsExpr: E }),
              _type: _('type', { startsExpr: E }),
              _opaque: _('opaque', { startsExpr: E }),
              name: j('name', { startsExpr: E }),
              placeholder: j('%%', { startsExpr: E }),
              string: j('string', { startsExpr: E }),
              num: j('num', { startsExpr: E }),
              bigint: j('bigint', { startsExpr: E }),
              decimal: j('decimal', { startsExpr: E }),
              regexp: j('regexp', { startsExpr: E }),
              privateName: j('#name', { startsExpr: E }),
              eof: j('eof'),
              jsxName: j('jsxName'),
              jsxText: j('jsxText', { beforeExpr: S }),
              jsxTagStart: j('jsxTagStart', { startsExpr: E }),
            ...
            (D[8].updateContext = (e) => {
              ...
              (D[22].updateContext = (e) => {
                e[e.length - 1] === A.template ? e.pop() : e.push(A.template);
              }),
              (D[143].updateContext = (e) => {
                e.push(A.j_expr, A.j_oTag);
              });
            var Z =
            ...
            function ae(e, t) {
              ...
              for (let i = 0, r = t.length; i < r; i += 2) {
                if (((s += t[i]), s > e)) return !1;
                if (((s += t[i + 1]), s >= e)) return !0;
              }
              return !1;
            }
            function ne(e) {
              return e < 65
                ...
                : e <= 90 ||
                    (e < 97
                      ? 95 === e
                      : e <= 122 ||
                        (e <= 65535 ? e >= 170 && te.test(String.fromCharCode(e)) : ae(e, ie)));
            }
            function oe(e) {
              return e < 48
                ? 36 === e
            ...
            var fe = new Set([
              ...
              xe = class {
                ...
                declareName(e, t, s) {
                  ...
                  if (8 & t || 16 & t) {
                    ...
                    16 & t ? (r |= 4) : (i.firstLexicalName || (i.firstLexicalName = e), (r |= 2)),
                      i.names.set(e, r),
                ...
                checkRedeclarationInScope(e, t, s, i) {
                  this.isRedeclaredInScope(e, t, s) &&
                    this.parser.raise(x.VarRedeclaration, i, { identifierName: t });
                }
                isRedeclaredInScope(e, t, s) {
                  ...
                  let i = e.names.get(t);
                  return 16 & s
                    ? (2 & i) > 0 || (!this.treatFunctionsAsVarInScope(e) && (1 & i) > 0)
              ...
              be = y`flow`({
                ...
                EnumInvalidMemberInitializerSymbolType: ({ enumName: e, memberName: t }) =>
                  `Symbol enum members cannot be initialized. Use \`${t},\` in enum \`${e}\`.`,
                EnumInvalidMemberInitializerUnknownType: ({ enumName: e, memberName: t }) =>
                  `The enum member initializer for \`${t}\` needs to be a literal (either a boolean, number, or string) in enum \`${e}\`.`,
                EnumInvalidMemberName: ({ enumName: e, memberName: t, suggestion: s }) =>
                ...
                UnsupportedDeclareExportKind: ({ unsupportedExportKind: e, suggestion: t }) =>
            ...
            function Ce(e, t, s) {
              for (let i = t; i < s; i++) if (Ie(e.charCodeAt(i))) return !0;
              return !1;
            }
            var Ne = /(?:\s|\/\/.*|\/\*[^]*?\*\/)*/g,
              ve = /(?:[^\S\n\r\u2028\u2029]|\/\/.*|\/\*.*?\*\/)*/g;
            ...
            function De(e) {
              ...
              if ('JSXMemberExpression' === e.type) return De(e.object) + '.' + De(e.property);
            ...
            var Oe = class extends ye {
              ...
              Fe = class extends xe {
                ...
                createScope(e) {
                  return this.importsStack.push(new Set()), new Oe(e);
                }
                enter(e) {
                ...
                hasImport(e, t) {
                  ...
                  if (!t && s > 1)
                    for (let t = 0; t < s - 1; t++) if (this.importsStack[t].has(e)) return !0;
                  return !1;
                }
                declareName(e, t, s) {
                  if (4096 & t)
                    return (
                      this.hasImport(e, !0) &&
                        this.parser.raise(x.VarRedeclaration, s, { identifierName: e }),
                      void this.importsStack[this.importsStack.length - 1].add(e)
                    );
                  let i = this.currentScope(),
                    r = i.tsNames.get(e) || 0;
                  if (1024 & t) return this.maybeExportDefined(i, e), void i.tsNames.set(e, 16 | r);
                  super.declareName(e, t, s),
                    2 & t &&
                      (1 & t ||
                        (this.checkRedeclarationInScope(i, e, t, s), this.maybeExportDefined(i, e)),
                      (r |= 1)),
                    256 & t && (r |= 2),
                    512 & t && (r |= 4),
                    128 & t && (r |= 8),
                ...
                isRedeclaredInScope(e, t, s) {
                  ...
                  return (2 & i) > 0
                    ...
                    : 128 & s && (8 & i) > 0
                      ? !!(2 & e.names.get(t)) && !!(1 & s)
                      : !!(2 & s && (1 & i) > 0) || super.isRedeclaredInScope(e, t, s);
                }
                checkLocalExport(e) {
                  let { name: t } = e;
                  if (!this.hasImport(t)) {
            ...
            var Ue = class {
              ...
              hasPlugin(e) {
                if ('string' == typeof e) return this.plugins.has(e);
                {
                  ...
                  for (let e of Object.keys(s)) if ((null == i ? void 0 : i[e]) !== s[e]) return !1;
                  return !0;
                }
              }
              getPluginOption(e, t) {
            ...
            function He(e, t, s) {
              ...
              null === i || i.start > s.start ? _e(e, s.comments) : je(i, s.comments);
            }
            var ze = class extends Ue {
                ...
                finalizeComment(e) {
                  ...
                  if (null !== e.leadingNode || null !== e.trailingNode)
                    null !== e.leadingNode && je(e.leadingNode, s),
                      null !== e.trailingNode &&
                        (function (e, t) {
                    ...
                    if (44 === this.input.charCodeAt(this.offsetToSourcePos(r) - 1))
                      switch (i.type) {
                        ...
                        case 'ImportExpression':
                          He(i, [i.source, null != (t = i.options) ? t : null], e);
                          break;
              ...
              Ve = class e {
                ...
                init({
                  ...
                  (this.strict = !1 !== e && (!0 === e || 'module' === t)),
                    ...
                    (this.curLine = r),
                    (this.lineStart = -a),
                    (this.startLoc = this.endLoc = new s(r, a, i));
                }
            ...
            function Je(e, t, s, i, r, a) {
              ...
              for (;;) {
                ...
                if (92 === d) {
                  l += t.slice(c, s);
                  let n = Xe(t, s, i, r, 'template' === e, a);
                  null !== n.ch || p ? (l += n.ch) : (p = { pos: s, lineStart: i, curLine: r }),
                    ({ pos: s, lineStart: i, curLine: r } = n),
                    (c = s);
                } else
                  8232 === d || 8233 === d
                    ? (++r, (i = ++s))
            ...
            function We(e, t, s, i) {
              return 'template' === e
                ? 96 === t || (36 === t && 123 === s.charCodeAt(i + 1))
                : t === ('double' === e ? 34 : 39);
            }
            function Xe(e, t, s, i, r, a) {
              let n = !r;
              t++;
              let o = (e) => ({ pos: t, ch: e, lineStart: s, curLine: i }),
                h = e.charCodeAt(t++);
              switch (h) {
                case 110:
                  return o('\n');
                ...
                case 120: {
                  let r;
                  return (
                    ({ code: r, pos: t } = Ge(e, t, s, i, 2, !1, n, a)),
                    o(null === r ? null : String.fromCharCode(r))
                  );
                }
                case 117: {
                  let r;
                  return (
                    ({ code: r, pos: t } = Qe(e, t, s, i, n, a)),
                    o(null === r ? null : String.fromCodePoint(r))
                  );
                }
                case 116:
                  return o('\t');
                ...
                case 57:
                  if (r) return o(null);
                  a.strictNumericEscape(t - 1, s, i);
                default:
                  if (h >= 48 && h <= 55) {
                    let n = t - 1,
                      h = /^[0-7]+/.exec(e.slice(n, t + 2))[0],
                      l = parseInt(h, 8);
                    l > 255 && ((h = h.slice(0, -1)), (l = parseInt(h, 8))), (t += h.length - 1);
                    let p = e.charCodeAt(t);
                    if ('0' !== h || 56 === p || 57 === p) {
                      if (r) return o(null);
                      a.strictNumericEscape(n, s, i);
                    }
            ...
            function Ge(e, t, s, i, r, a, n, o) {
              let h,
                l = t;
              return (
                ({ n: h, pos: t } = Ye(e, t, s, i, 16, r, a, !1, o, !n)),
                null === h && (n ? o.invalidEscapeSequence(l, s, i) : (t = l - 1)),
                { code: h, pos: t }
              );
            }
            function Ye(e, t, s, i, r, a, n, o, h, l) {
              let p = t,
                c = 16 === r ? qe.hex : qe.decBinOct,
                u = 16 === r ? Ke.hex : 10 === r ? Ke.dec : 8 === r ? Ke.oct : Ke.bin,
                d = !1,
                m = 0;
              for (let p = 0, f = a ?? 1 / 0; p < f; ++p) {
                let a,
                  p = e.charCodeAt(t);
                if (95 === p && 'bail' !== o) {
                  let r = e.charCodeAt(t - 1),
                    a = e.charCodeAt(t + 1);
                  if (o) {
                    if (Number.isNaN(a) || !u(a) || c.has(r) || c.has(a)) {
                      if (l) return { n: null, pos: t };
                      h.unexpectedNumericSeparator(t, s, i);
                    }
                  } else {
                    if (l) return { n: null, pos: t };
                    h.numericSeparatorInEscapeSequence(t, s, i);
                  }
                  ++t;
                  continue;
                }
                if (
                  ((a = p >= 97 ? p - 97 + 10 : p >= 65 ? p - 65 + 10 : $e(p) ? p - 48 : 1 / 0),
                  a >= r)
                ) {
                  if (a <= 9 && l) return { n: null, pos: t };
                  if (a <= 9 && h.invalidDigit(t, s, i, r)) a = 0;
                  else {
                    if (!n) break;
                    (a = 0), (d = !0);
                  }
            ...
            function Qe(e, t, s, i, r, a) {
              let n;
              if (123 === e.charCodeAt(t)) {
                if (
                  (++t,
                  ({ code: n, pos: t } = Ge(e, t, s, i, e.indexOf('}', t) - t, !0, r, a)),
                  ++t,
                  null !== n && n > 1114111)
                ) {
                  if (!r) return { code: null, pos: t };
                  a.invalidCodePoint(t, s, i);
                }
              } else ({ code: n, pos: t } = Ge(e, t, s, i, 4, !1, r, a));
              return { code: n, pos: t };
            }
            function Ze(e, t, i) {
              return new s(i, e - t, e);
            }
            var et = new Set([103, 109, 115, 105, 121, 117, 100, 118]),
              tt = class {
                constructor(e) {
                  ...
                  (this.type = e.type),
                    ...
                    (this.end = t + e.end),
                    (this.loc = new i(e.startLoc, e.endLoc));
                }
              },
              st = class extends ze {
                constructor(e, t) {
                  super(),
                    ...
                    (this.errorHandlers_readInt = {
                      invalidDigit: (e, t, s, i) =>
                        !!(2048 & this.optionFlags) &&
                        (this.raise(x.InvalidDigit, Ze(e, t, s), { radix: i }), !0),
                      numericSeparatorInEscapeSequence: this.errorBuilder(
                        x.NumericSeparatorInEscapeSequence
                      ),
                    ...
                    (this.errorHandlers_readStringContents_string = Object.assign(
                      ...
                      this.errorHandlers_readCodePoint,
                      {
                        strictNumericEscape: (e, t, s) => {
                          this.recordStrictModeErrors(x.StrictNumericEscape, Ze(e, t, s));
                        },
                        unterminated: (e, t, s) => {
                          throw this.raise(x.UnterminatedString, Ze(e - 1, t, s));
                        },
                      }
                    )),
                    (this.errorHandlers_readStringContents_template = Object.assign(
                      ...
                      this.errorHandlers_readCodePoint,
                      {
                        ...
                        unterminated: (e, t, s) => {
                          throw this.raise(x.UnterminatedTemplate, Ze(e, t, s));
                        },
                      }
                    )),
                    (this.state = new Ve()),
                ...
                next() {
                  this.checkKeywordEscapes(),
                    256 & this.optionFlags && this.pushToken(new tt(this.state)),
                ...
                nextTokenStartSince(e) {
                  return (Ne.lastIndex = e), Ne.test(this.input) ? Ne.lastIndex : e;
                }
                lookaheadCharCode() {
                ...
                nextTokenInLineStartSince(e) {
                  return (ve.lastIndex = e), ve.test(this.input) ? ve.lastIndex : e;
                }
                ...
                skipBlockComment(e) {
                  ...
                  if (-1 === r) throw this.raise(x.UnterminatedComment, this.state.curPosition());
                  for (
                    this.state.pos = r + e.length, we.lastIndex = s + 2;
                    we.test(this.input) && we.lastIndex <= r;
                  )
                  ...
                  return 256 & this.optionFlags && this.pushToken(a), a;
                }
                skipLineComment(e) {
                  let t,
                    s = this.state.pos;
                  ...
                  e: for (; this.state.pos < this.length; ) {
                    ...
                    switch (s) {
                      ...
                      case 47:
                        ...
                        break;
                      default:
                        if (ke(s)) ++this.state.pos;
                        else if (45 === s && !this.inModule && 8192 & this.optionFlags) {
                          let s = this.state.pos;
                          if (
                          ...
                          if (60 !== s || this.inModule || !(8192 & this.optionFlags)) break e;
                          {
                            let e = this.state.pos;
                            if (
                ...
                readToken_numberSign() {
                  ...
                  if (123 === t || (91 === t && this.hasPlugin('recordAndTuple'))) {
                    if (
                      ...
                      throw this.raise(
                        123 === t
                          ? x.RecordExpressionHashIncorrectStartSyntaxType
                          : x.TupleExpressionHashIncorrectStartSyntaxType,
                        this.state.curPosition()
                      );
                    (this.state.pos += 2), 123 === t ? this.finishToken(7) : this.finishToken(1);
                  } else
                    ne(t)
                      ? (++this.state.pos, this.finishToken(139, this.readWord1(t)))
                      : 92 === t
                ...
                readToken_interpreter() {
                  ...
                  for (this.state.pos += 1; !Ie(e) && ++this.state.pos < this.length; )
                ...
                readToken_mult_modulo(e) {
                  ...
                  42 === e &&
                    42 === i &&
                    (s++, (i = this.input.charCodeAt(this.state.pos + 2)), (t = 57)),
                    61 === i && !this.state.inType && (s++, (t = 37 === e ? 33 : 30)),
                    this.finishOp(t, s);
                }
                    ...
                    if (124 === e) {
                      ...
                      if (this.hasPlugin('recordAndTuple') && 125 === t) {
                        if ('bar' !== this.getPluginOption('recordAndTuple', 'syntaxType'))
                          throw this.raise(
                            x.RecordExpressionBarIncorrectEndSyntaxType,
                            this.state.curPosition()
                          );
                      ...
                      if (this.hasPlugin('recordAndTuple') && 93 === t) {
                        if ('bar' !== this.getPluginOption('recordAndTuple', 'syntaxType'))
                          throw this.raise(
                            x.TupleExpressionBarIncorrectEndSyntaxType,
                            this.state.curPosition()
                          );
                  ...
                  switch (e) {
                    ...
                    case 91:
                      if (
                        ...
                        if ('bar' !== this.getPluginOption('recordAndTuple', 'syntaxType'))
                          throw this.raise(
                            x.TupleExpressionBarIncorrectStartSyntaxType,
                            this.state.curPosition()
                          );
                    ...
                    case 123:
                      if (
                        ...
                        if ('bar' !== this.getPluginOption('recordAndTuple', 'syntaxType'))
                          throw this.raise(
                            x.RecordExpressionBarIncorrectStartSyntaxType,
                            this.state.curPosition()
                          );
                ...
                readRegexp() {
                  let e,
                    ...
                    i = this.state.start + 1,
                    { pos: a } = this.state;
                  for (; ; ++a) {
                    if (a >= this.length) throw this.raise(x.UnterminatedRegExp, r(s, 1));
                    let i = this.input.charCodeAt(a);
                    if (Ie(i)) throw this.raise(x.UnterminatedRegExp, r(s, 1));
                    if (e) e = !1;
                    else {
                      if (91 === i) t = !0;
                      else if (93 === i && t) t = !1;
                      else if (47 === i && !t) break;
                      e = 92 === i;
                    }
                  }
                  let n = this.input.slice(i, a);
                  ++a;
                  let o = '',
                    h = () => r(s, a + 2 - i);
                  for (; a < this.length; ) {
                    ...
                    if (et.has(e))
                      118 === e
                        ? o.includes('u') && this.raise(x.IncompatibleRegExpUVFlags, h())
                        : 117 === e &&
                          o.includes('v') &&
                          this.raise(x.IncompatibleRegExpUVFlags, h()),
                        o.includes(t) && this.raise(x.DuplicateRegExpFlags, h());
                    else {
                      if (!oe(e) && 92 !== e) break;
                      this.raise(x.MalformedRegExpFlags, h());
                    }
                    ++a, (o += t);
                  }
                  (this.state.pos = a), this.finishToken(138, { pattern: n, flags: o });
                }
                readInt(e, t, s = !1, i = !0) {
                  let { n: r, pos: a } = Ye(
                    this.input,
                ...
                readRadixNumber(e) {
                  ...
                  null == a && this.raise(x.InvalidDigit, r(s, 2), { radix: e });
                  let n = this.input.charCodeAt(this.state.pos);
                  if (110 === n) ++this.state.pos, (i = !0);
                  else if (109 === n) throw this.raise(x.InvalidDecimal, s);
                  ...
                  if (i) {
                    ...
                    return void this.finishToken(136, e);
                  }
                ...
                readNumber(e) {
                  ...
                  !e &&
                    ...
                    this.raise(x.InvalidNumber, this.state.curPosition());
                  let h = this.state.pos - t >= 2 && 48 === this.input.charCodeAt(t);
                  if (h) {
                    let e = this.input.slice(t, this.state.pos);
                    if (
                      (this.recordStrictModeErrors(x.StrictOctalLiteral, s), !this.state.strict)
                    ) {
                      let t = e.indexOf('_');
                      t > 0 && this.raise(x.ZeroDigitNumericSeparator, r(s, t));
                    }
                    o = h && !/[89]/.test(e);
                  }
                  ...
                  if (
                    ...
                    (69 === l || 101 === l) &&
                      !o &&
                      ((l = this.input.charCodeAt(++this.state.pos)),
                      (43 === l || 45 === l) && ++this.state.pos,
                      null === this.readInt(10) && this.raise(x.InvalidOrMissingExponent, s),
                      (i = !0),
                      (n = !0),
                      (l = this.input.charCodeAt(this.state.pos))),
                    110 === l &&
                      ((i || h) && this.raise(x.InvalidBigIntLiteral, s),
                      ++this.state.pos,
                      (a = !0)),
                    109 === l)
                  ) {
                    this.expectPlugin('decimal', this.state.curPosition()),
                      (n || h) && this.raise(x.InvalidDecimal, s),
                      ++this.state.pos;
                    var p = !0;
                  }
                  if (ne(this.codePointAtPos(this.state.pos)))
                  ...
                  let u = o ? parseInt(c, 8) : parseFloat(c);
                ...
                readTemplateToken() {
                  ...
                  (this.state.pos = r + 1),
                    ...
                    i &&
                      (this.state.firstInvalidTemplateEscapePos = new s(
                        i.curLine,
                        i.pos - i.lineStart,
                        this.sourceToOffsetPos(i.pos)
                      )),
                    96 === this.input.codePointAt(r)
                      ? this.finishToken(24, i ? null : e + t + '`')
                      : (this.state.pos++, this.finishToken(25, i ? null : e + t + '${'));
                }
                ...
                readWord1(e) {
                  ...
                  for (
                    ...
                    if (oe(e)) this.state.pos += e <= 65535 ? 1 : 2;
                    else {
                      if (92 !== e) break;
                      {
                        (this.state.containsEsc = !0), (t += this.input.slice(i, this.state.pos));
                        let e = this.state.curPosition(),
                          r = this.state.pos === s ? ne : oe;
                        if (117 !== this.input.charCodeAt(++this.state.pos)) {
                          this.raise(x.MissingUnicodeEscape, this.state.curPosition()),
                            (i = this.state.pos - 1);
                          continue;
                        }
                        ++this.state.pos;
                        ...
                        null !== a &&
                          (r(a) || this.raise(x.EscapedCharNotAnIdentifier, e),
                ...
                readWord(e) {
                  let t = this.readWord1(e),
                    s = v.get(t);
                  void 0 !== s ? this.finishToken(s, X(s)) : this.finishToken(132, t);
                }
                checkKeywordEscapes() {
                  let { type: e } = this.state;
                  J(e) &&
                    this.state.containsEsc &&
                    this.raise(x.InvalidEscapedReservedWord, this.state.startLoc, {
                      reservedWord: X(e),
                    });
                }
                raise(e, t, i = {}) {
                  let r = e(t instanceof s ? t : t.loc.start, i);
                  if (!(2048 & this.optionFlags)) throw r;
                  return this.isLookahead || this.state.errors.push(r), r;
                }
                raiseOverwrite(e, t, i = {}) {
                  let r = t instanceof s ? t : t.loc.start,
                    a = r.index,
                    n = this.state.errors;
                  for (let t = n.length - 1; t >= 0; t--) {
                    let s = n[t];
                    if (s.loc.index === a) return (n[t] = e(r, i));
                    if (s.loc.index < a) break;
                  }
                  return this.raise(e, t, i);
                }
                updateContext(e) {}
                unexpected(e, t) {
                  throw this.raise(x.UnexpectedToken, e ?? this.state.startLoc, {
                    expected: t ? X(t) : null,
                  });
                }
                expectPlugin(e, t) {
                  if (this.hasPlugin(e)) return !0;
                  throw this.raise(x.MissingPlugin, t ?? this.state.startLoc, {
                    missingPlugin: [e],
                  });
                }
                expectOnePlugin(e) {
              ...
              rt = class {
                ...
                exit() {
                  ...
                  for (let [s, i] of Array.from(e.undefinedPrivateNames))
                    t
                      ? t.undefinedPrivateNames.has(s) || t.undefinedPrivateNames.set(s, i)
                      : this.parser.raise(x.InvalidPrivateFieldResolution, i, {
                          identifierName: s,
                        });
                }
                declarePrivateName(e, t, s) {
                  ...
                  if (3 & t) {
                    let s = n && r.get(e);
                    s
                      ? ((n = (3 & s) == (3 & t) || (4 & s) != (4 & t)), n || r.delete(e))
                      : n || r.set(e, t);
                  }
                  n && this.parser.raise(x.PrivateNameRedeclaration, s, { identifierName: e }),
                    i.add(e),
                    a.delete(e);
                }
                usePrivateName(e, t) {
                  ...
                  s
                    ...
                    : this.parser.raise(x.InvalidPrivateFieldResolution, t, { identifierName: e });
                }
              },
              at = class {
                constructor(e = 0) {
              ...
              ot = class {
                ...
                recordParameterInitializerError(e, t) {
                  ...
                  for (; !a.isCertainlyParameterDeclaration(); ) {
                    ...
                    a.recordDeclarationError(e, s), (a = i[--r]);
                  }
                ...
                recordAsyncArrowParametersError(e) {
                  ...
                  for (; i.canBeArrowParameterDeclaration(); )
                    2 === i.type && i.recordDeclarationError(x.AwaitBindingIdentifier, e),
                      (i = t[--s]);
                }
                validateAsPattern() {
                  let { stack: e } = this,
                  ...
                  t.canBeArrowParameterDeclaration() &&
                    t.iterateErrors(([t, s]) => {
                      ...
                      for (; r.canBeArrowParameterDeclaration(); )
                        r.clearDeclarationError(s.index), (r = e[--i]);
                    });
                }
              };
            function ht() {
            ...
            var lt = class extends st {
                addExtra(e, t, s, i = !0) {
                  ...
                  let { extra: r } = e;
                  null == r && ((r = {}), (e.extra = r)),
                    i ? (r[t] = s) : Object.defineProperty(r, t, { enumerable: i, value: s });
                }
                isContextual(e) {
                ...
                hasFollowingLineBreak() {
                  return Ce(this.input, this.state.end, this.nextTokenStart());
                }
                isLineTerminator() {
                ...
                semicolon(e = !0) {
                  (e ? this.isLineTerminator() : this.eat(13)) ||
                    this.raise(x.MissingSemicolon, this.state.lastTokEndLoc);
                }
                expect(e, t) {
                ...
                tryParse(e, t = this.state.clone()) {
                  ...
                  try {
                    ...
                    if (((this.state = t), e instanceof SyntaxError))
                      return { node: null, error: e, thrown: !0, aborted: !1, failState: i };
                    if (e === s)
                ...
                checkExpressionErrors(e, t) {
                  ...
                  if (!t) return !!(s || i || a || r);
                  null != s && this.raise(x.InvalidCoverInitializedName, s),
                    null != i && this.raise(x.DuplicateProto, i),
                    null != r && this.raise(x.UnexpectedPrivateField, r),
                ...
                enterInitialScopes() {
                  ...
                  (this.inModule || 1 & this.optionFlags) && (e |= 2),
                    ...
                    2 & this.optionFlags && (e |= 4);
                  let t = 1;
                  4 & this.optionFlags && (t |= 512), this.scope.enter(t), this.prodParam.enter(e);
                }
              ...
              ct = class {
                constructor(e, t, s) {
                  (this.type = ''),
                    ...
                    (this.end = 0),
                    (this.loc = new i(s)),
                    128 & (null == e ? void 0 : e.optionFlags) && (this.range = [t, 0]),
                    null != e && e.filename && (this.loc.filename = e.filename);
                }
              },
              ut = ct.prototype;
            ut.__clone = function () {
              let e = new ct(void 0, this.start, this.loc.start),
                t = Object.keys(this);
            ...
            var dt = class extends lt {
                ...
                finishNodeAt(e, t, s) {
                  return (
                    ...
                    (e.end = s.index),
                    (e.loc.end = s),
                    128 & this.optionFlags && (e.range[1] = s.index),
                    4096 & this.optionFlags && this.processComment(e),
                    e
                  );
                }
                resetStartLocation(e, t) {
                  (e.start = t.index),
                    (e.loc.start = t),
                    128 & this.optionFlags && (e.range[0] = t.index);
                }
                resetEndLocation(e, t = this.state.lastTokEndLoc) {
                  (e.end = t.index),
                    (e.loc.end = t),
                    128 & this.optionFlags && (e.range[1] = t.index);
                }
                ...
                cloneIdentifier(e) {
                  let { type: t, start: s, end: i, loc: r, range: a, name: n } = e,
                    o = Object.create(ut);
                  return (
                    (o.type = t),
                    (o.start = s),
                    ...
                    (o.range = a),
                    (o.name = n),
                    e.extra && (o.extra = e.extra),
                    o
                  );
                }
                cloneStringLiteral(e) {
                  let { type: t, start: s, end: i, loc: r, range: a, extra: n } = e,
                    o = Object.create(ut);
                  return (
                    (o.type = t),
                    (o.start = s),
              ...
              mt = (e) => ('ParenthesizedExpression' === e.type ? mt(e.expression) : e),
              ft = class extends dt {
                toAssignable(e, t = !1) {
                  var s, i;
                  let r;
                      ...
                      t
                        ? 'Identifier' === r.type
                          ? this.expressionScope.recordArrowParameterBindingError(
                              x.InvalidParenthesizedAssignment,
                              e
                            )
                          : 'MemberExpression' !== r.type &&
                            !this.isOptionalMemberExpression(r) &&
                            this.raise(x.InvalidParenthesizedAssignment, e)
                        : this.raise(x.InvalidParenthesizedAssignment, e)),
                    e.type)
                  ) {
                    case 'Identifier':
                      ...
                      for (let s = 0, i = e.properties.length, r = i - 1; s < i; s++) {
                        ...
                        this.toAssignableObjectExpressionProp(i, n, t),
                          n &&
                            ...
                            null != (a = e.extra) &&
                            a.trailingCommaLoc &&
                            this.raise(x.RestTrailingComma, e.extra.trailingCommaLoc);
                      }
                      break;
                    case 'ObjectProperty': {
                      let { key: s, value: i } = e;
                      this.isPrivateName(s) &&
                        this.classScope.usePrivateName(this.getPrivateNameSV(s), s.loc.start),
                    ...
                    case 'ArrayExpression':
                      this.castNodeTo(e, 'ArrayPattern'),
                        this.toAssignableList(
                          e.elements,
                          null == (i = e.extra) ? void 0 : i.trailingCommaLoc,
                          t
                        );
                      break;
                    case 'AssignmentExpression':
                      '=' !== e.operator && this.raise(x.MissingEqInAssignment, e.left.loc.end),
                ...
                toAssignableObjectExpressionProp(e, t, s) {
                  if ('ObjectMethod' === e.type)
                    ...
                    this.checkToRestConversion(i, !1),
                      ...
                      t || this.raise(x.RestTrailingComma, e);
                ...
                toAssignableList(e, t, s) {
                  ...
                  for (let r = 0; r <= i; r++) {
                    ...
                    a &&
                      ...
                      'RestElement' === a.type &&
                        (r < i
                          ? this.raise(x.RestTrailingComma, a)
                          : t && this.raise(x.RestTrailingComma, t)));
                  }
                }
                ...
                parseBindingList(e, t, s) {
                  let i = 1 & s,
                    ...
                    a = !0;
                  for (; !this.eat(e); )
                    if ((a ? (a = !1) : this.expect(12), i && this.match(12))) r.push(null);
                    else {
                      if (this.eat(e)) break;
                      if (this.match(21)) {
                        let i = this.parseRestBinding();
                        if (
                          ((this.hasPlugin('flow') || 2 & s) &&
                            (i = this.parseFunctionParamType(i)),
                          r.push(i),
                        ...
                        if (2 & s)
                          for (
                            ...
                            this.raise(x.UnsupportedParameterDecorator, this.state.startLoc);
                            this.match(26);
                          )
                ...
                parseBindingElement(e, t) {
                  ...
                  return (
                    (this.hasPlugin('flow') || 2 & e) && this.parseFunctionParamType(s),
                    t.length && ((s.decorators = t), this.resetStartLocationFromNode(s, t[0])),
                ...
                checkLVal(e, t, s = 64, i = !1, r = !1, a = !1) {
                  var n;
                  let o = e.type;
                  if (this.isObjectMethod(e)) return;
                  let h = this.isOptionalMemberExpression(e);
                  if (h || 'MemberExpression' === o)
                    return (
                      h &&
                        (this.expectPlugin('optionalChainingAssign', e.loc.start),
                        'AssignmentExpression' !== t.type &&
                          this.raise(x.InvalidLhsOptionalChaining, e, { ancestor: t })),
                      void (64 !== s && this.raise(x.InvalidPropertyBindingPattern, e))
                    );
                  if ('Identifier' === o) {
                    this.checkIdentifier(e, s, r);
                    let { name: t } = e;
                    return void (i && (i.has(t) ? this.raise(x.ParamDupe, e) : i.add(t)));
                  }
                  let l,
                    p,
                    c = this.isValidLVal(
                      o,
                      !(a || (null != (n = e.extra) && n.parenthesized)) &&
                        'AssignmentExpression' === t.type,
                      s
                    );
                  if (!0 === c) return;
                  if (!1 === c) {
                    let i = 64 === s ? x.InvalidLhs : x.InvalidLhsBinding;
                    return void this.raise(i, e, { ancestor: t });
                  }
                  'string' == typeof c
                    ? ((l = c), (p = 'ParenthesizedExpression' === o))
                    : ([l, p] = c);
                  let u = 'ArrayPattern' === o || 'ObjectPattern' === o ? { type: o } : t,
                    d = e[l];
                  if (Array.isArray(d)) for (let e of d) e && this.checkLVal(e, u, s, i, r, p);
                  else d && this.checkLVal(d, u, s, i, r, p);
                }
                checkIdentifier(e, t, s = !1) {
                  this.state.strict &&
                    (s ? me(e.name, this.inModule) : de(e.name)) &&
                    (64 === t
                      ? this.raise(x.StrictEvalArguments, e, { referenceName: e.name })
                      : this.raise(x.StrictEvalArgumentsBinding, e, { bindingName: e.name })),
                    8192 & t && 'let' === e.name && this.raise(x.LetInLexicalBinding, e),
                ...
                checkToRestConversion(e, t) {
                  switch (e.type) {
                    ...
                    case 'ObjectExpression':
                      if (t) break;
                    default:
                      this.raise(x.InvalidRestAssignmentPattern, e);
                  }
                }
                checkCommaAfterRest(e) {
                  return (
                    !!this.match(12) &&
                    (this.raise(
                      this.lookaheadCharCode() === e ? x.RestTrailingComma : x.ElementAfterRest,
                      this.state.startLoc
                    ),
                    !0)
                  );
            ...
            function Tt(e) {
              ...
              return (
                (!t ||
                  ...
                  !('TemplateLiteral' !== s.type || s.expressions.length > 0)) &&
                St(e.object)
              );
            }
            function bt(e, t) {
              ...
              return !!(
                ...
                (function (e, t) {
                  if ('UnaryExpression' === e.type) {
                    ...
                    if ('-' === s && At(i, t)) return !0;
                  }
                  return !1;
                })(e, t) ||
                ('TemplateLiteral' === i && 0 === e.expressions.length) ||
                Tt(e)
              );
            }
            function At(e, t) {
            ...
            function St(e) {
              return (
                'Identifier' === e.type ||
                ('MemberExpression' === e.type && !e.computed && St(e.object))
              );
            }
            var Et = y`placeholders`({
              ...
              Ct = {
                estree: (e) =>
                  class extends e {
                    parse() {
                      let e = T(super.parse());
                      return 256 & this.optionFlags && (e.tokens = e.tokens.map(T)), e;
                    }
                    ...
                    estreeParseChainExpression(e, t) {
                      ...
                      return (s.expression = e), this.finishNodeAt(s, 'ChainExpression', t);
                    }
                    directiveToStmt(e) {
                      let t = e.value;
                      delete e.value,
                      ...
                      return (
                        (s.expression = t), (s.directive = t.extra.rawValue), delete t.extra, s
                      );
                    }
                    fillOptionalPropertiesForTSESLint(e) {}
                    cloneEstreeStringLiteral(e) {
                      let { start: t, end: s, loc: i, range: r, raw: a, value: n } = e,
                    ...
                    parseMethod(e, t, s, i, r, a, n = !1) {
                      let o = this.startNode();
                      (o.kind = e.kind),
                        (o = super.parseMethod(o, t, s, i, r, a, n)),
                        delete o.kind;
                      let { typeParameters: h } = e;
                      h &&
                        (delete e.typeParameters,
                        (o.typeParameters = h),
                        this.resetStartLocationFromNode(o, h));
                      let l = this.castNodeTo(o, 'FunctionExpression');
                      return (
                        (e.value = l),
                    ...
                    parseClassPrivateProperty(...e) {
                      ...
                      return (
                        this.getPluginOption('estree', 'classFeatures') &&
                          (this.castNodeTo(t, 'PropertyDefinition'), (t.computed = !1)),
                        t
                      );
                    }
                      ...
                      return (
                        this.getPluginOption('estree', 'classFeatures') &&
                          (t.abstract && this.hasPlugin('typescript')
                            ? (delete t.abstract, this.castNodeTo(t, 'TSAbstractAccessorProperty'))
                    ...
                    parseObjectProperty(e, t, s, i) {
                      ...
                      return r && ((r.kind = 'init'), this.castNodeTo(r, 'Property')), r;
                    }
                    ...
                    toAssignableObjectExpressionProp(e, t, s) {
                      'Property' !== e.type || ('get' !== e.kind && 'set' !== e.kind)
                        ? 'Property' === e.type && e.method
                          ? this.raise(x.PatternHasMethod, e.key)
                          : super.toAssignableObjectExpressionProp(e, t, s)
                        : this.raise(x.PatternHasAccessor, e.key);
                    }
                      ...
                      return (
                        'Import' === s.callee.type
                          ? (this.castNodeTo(s, 'ImportExpression'),
                            ...
                            (s.options = null != (i = s.arguments[1]) ? i : null),
                    ...
                    parseExport(e, t) {
                      ...
                      switch (i.type) {
                        ...
                        case 'ExportDefaultDeclaration': {
                          var r;
                          let { declaration: e } = i;
                          'ClassDeclaration' === (null == e ? void 0 : e.type) &&
                            (null == (r = e.decorators) ? void 0 : r.length) > 0 &&
                            e.start === i.start &&
                    ...
                    stopParseSubscript(e, t) {
                      ...
                      return t.optionalChainMember
                        ? this.estreeParseChainExpression(s, e.loc.end)
                        : s;
                    }
                    parseMember(e, t, s, i, r) {
                      let a = super.parseMember(e, t, s, i, r);
                      return (
                        'OptionalMemberExpression' === a.type
                          ? this.castNodeTo(a, 'MemberExpression')
                          : (a.optional = !1),
                        a
                      );
                    }
                    ...
                    isObjectMethod(e) {
                      return (
                        'Property' === e.type && (e.method || 'get' === e.kind || 'set' === e.kind)
                      );
                    }
                    castNodeTo(e, t) {
                    ...
                    finishNodeAt(e, t, s) {
                      return T(super.finishNodeAt(e, t, s));
                    }
                    finishNode(e, t) {
                    ...
                    resetStartLocation(e, t) {
                      super.resetStartLocation(e, t), T(e);
                    }
                    resetEndLocation(e, t = this.state.lastTokEndLoc) {
                      super.resetEndLocation(e, t), T(e);
                    }
                  },
                jsx: (e) =>
                  class extends e {
                    jsxReadToken() {
                      ...
                      for (;;) {
                        if (this.state.pos >= this.length)
                          throw this.raise(Le.UnterminatedJsxContent, this.state.startLoc);
                        let s = this.input.charCodeAt(this.state.pos);
                        switch (s) {
                          case 60:
                          case 123:
                            return this.state.pos === this.state.start
                              ? void (60 === s && this.state.canStartJSXElement
                                  ? (++this.state.pos, this.finishToken(143))
                                  : super.getTokenFromCode(s))
                              : ((e += this.input.slice(t, this.state.pos)),
                                void this.finishToken(142, e));
                          case 38:
                            (e += this.input.slice(t, this.state.pos)),
                    ...
                    jsxReadString(e) {
                      ...
                      (t += this.input.slice(s, this.state.pos++)), this.finishToken(134, t);
                    }
                    jsxReadEntity() {
                      let e = ++this.state.pos;
                    ...
                    jsxParseAttributeValue() {
                      ...
                      switch (this.state.type) {
                        case 5:
                          return (
                            (e = this.startNode()),
                            this.setContext(A.brace),
                            this.next(),
                            (e = this.jsxParseExpressionContainer(e, A.j_oTag)),
                            'JSXEmptyExpression' === e.expression.type &&
                              this.raise(Le.AttributeIsEmpty, e),
                            e
                          );
                        case 143:
                        case 134:
                        ...
                        default:
                          throw this.raise(Le.UnsupportedJsxValue, this.state.startLoc);
                      }
                    }
                    ...
                    jsxParseElementAt(e) {
                      ...
                      if (!i.selfClosing) {
                            ...
                            case 5: {
                              ...
                              this.setContext(A.brace),
                                ...
                                this.match(21)
                                  ...
                                  : s.push(this.jsxParseExpressionContainer(e, A.j_expr));
                              break;
                            }
                            default:
                              this.unexpected();
                        ...
                        Me(i) && !Me(r) && null !== r
                          ? this.raise(Le.MissingClosingTagFragment, r)
                          : ((!Me(i) && Me(r)) ||
                              (!Me(i) && !Me(r) && De(r.name) !== De(i.name))) &&
                            this.raise(Le.MissingClosingTagElement, r, {
                              openingTagName: De(i.name),
                            });
                      }
                      if (
                        (Me(i)
                        ...
                        throw this.raise(Le.UnwrappedAdjacentJSXElements, this.state.startLoc);
                      return Me(i)
                    ...
                    updateContext(e) {
                      ...
                      if (56 === s && 143 === e)
                        t.splice(-2, 2, A.j_cTag), (this.state.canStartJSXElement = !1);
                      else if (143 === s) t.push(A.j_oTag);
                      else if (144 === s) {
                        let s = t[t.length - 1];
                        (s === A.j_oTag && 56 === e) || s === A.j_cTag
                          ? (t.pop(),
                            (this.state.canStartJSXElement = t[t.length - 1] === A.j_expr))
                          : (this.setContext(A.j_expr), (this.state.canStartJSXElement = !0));
                      } else
                  ...
                  class extends e {
                    ...
                    flowParsePredicate() {
                      ...
                      return (
                        ...
                        this.state.lastTokStartLoc.index > t.index + 1 &&
                          this.raise(be.UnexpectedSpaceBetweenModuloChecks, t),
                        this.eat(10)
                      ...
                      return this.match(80)
                        ...
                        : this.match(68)
                          ...
                          : this.match(74)
                            ...
                            : this.eatContextual(127)
                              ? this.match(16)
                                ? this.flowParseDeclareModuleExports(e)
                                : (t &&
                                    this.raise(be.NestedDeclareModule, this.state.lastTokStartLoc),
                      ...
                      for (this.expect(5); !this.match(8); ) {
                        ...
                        this.match(83)
                          ? (this.next(),
                            ...
                            super.parseImport(e))
                          : (this.expectContextual(125, be.UnsupportedStatementInDeclareModule),
                        ...
                        s.forEach((e) => {
                          !(function (e) {
                            ...
                            ? 'DeclareModuleExports' === e.type &&
                              (r && this.raise(be.DuplicateDeclareModuleExports, e),
                              'ES' === i && this.raise(be.AmbiguousDeclareModuleKind, e),
                              (i = 'CommonJS'),
                              (r = !0))
                            : ('CommonJS' === i && this.raise(be.AmbiguousDeclareModuleKind, e),
                              (i = 'ES'));
                        }),
                        (e.kind = i || 'CommonJS'),
                    ...
                    flowParseDeclareExportDeclaration(e, t) {
                      ...
                      if (
                        ...
                        throw this.raise(be.UnsupportedDeclareExportKind, this.state.startLoc, {
                    ...
                    checkNotUnderscore(e) {
                      '_' === e && this.raise(be.UnexpectedReservedUnderscore, this.state.startLoc);
                    }
                    checkReservedType(e, t, s) {
                      Te.has(e) &&
                        this.raise(s ? be.AssignReservedType : be.UnexpectedReservedType, t, {
                          reservedType: e,
                        });
                    }
                    ...
                    flowParseTypeParameter(e = !1) {
                      ...
                      return (
                        ...
                        this.match(29)
                          ? (this.eat(29), (s.default = this.flowParseType()))
                          : e && this.raise(be.MissingTypeParamDefault, t),
                    ...
                    flowInTopLevelContext(e) {
                      if (this.curContext() === A.brace) return e();
                      {
                    ...
                    flowParseTypeParameterInstantiation() {
                      ...
                      return (
                        ...
                        (this.state.inType = t),
                        !this.state.inType && this.curContext() === A.brace && this.reScan_lt_gt(),
                        this.expect(48),
                    ...
                    flowParseObjectType({
                      ...
                      for (
                        t && this.match(6)
                          ? (this.expect(6), (o = 9), (h = !0))
                          : (this.expect(5), (o = 8), (h = !1)),
                          n.exact = h;
                        !this.match(o);
                      ) {
                        let t = !1,
                          ...
                          null != a && this.unexpected(a),
                            this.eat(0)
                              ? (c && this.unexpected(c.loc.start),
                                n.internalSlots.push(this.flowParseObjectTypeInternalSlot(p, t)))
                              : n.indexers.push(this.flowParseObjectTypeIndexer(p, t, c));
                        else if (this.match(10) || this.match(47))
                          null != a && this.unexpected(a),
                            c && this.unexpected(c.loc.start),
                            n.callProperties.push(this.flowParseObjectTypeCallProperty(p, t));
                        else {
                          let e = 'init';
                          (this.isContextual(99) || this.isContextual(104)) &&
                            $(this.lookahead().type) &&
                            ((e = this.state.value), this.next());
                          let i = this.flowParseObjectTypeProperty(p, t, a, c, e, s, r ?? !h);
                          null === i
                            ? ((l = !0), (o = this.state.lastTokStartLoc))
                            : n.properties.push(i);
                        }
                        this.flowObjectTypeSemicolon(),
                          o &&
                            !this.match(8) &&
                            !this.match(9) &&
                            this.raise(be.UnexpectedExplicitInexactInObject, o);
                      }
                      this.expect(o), s && (n.inexact = l);
                      let p = this.finishNode(n, 'ObjectTypeAnnotation');
                      return (this.state.inType = a), p;
                    }
                    flowParseObjectTypeProperty(e, t, s, i, r, a, n) {
                      if (this.eat(21))
                        return this.match(12) || this.match(13) || this.match(8) || this.match(9)
                          ? (a
                              ? n || this.raise(be.InexactInsideExact, this.state.lastTokStartLoc)
                              : this.raise(be.InexactInsideNonObject, this.state.lastTokStartLoc),
                            i && this.raise(be.InexactVariance, i),
                            null)
                          : (a || this.raise(be.UnexpectedSpreadType, this.state.lastTokStartLoc),
                            null != s && this.unexpected(s),
                            i && this.raise(be.SpreadVariance, i),
                        ...
                        return (
                          this.match(47) || this.match(10)
                            ? ((e.method = !0),
                              ...
                              ('get' === r || 'set' === r) && this.flowCheckGetterSetterParams(e),
                              !a &&
                                'constructor' === e.key.name &&
                                e.value.this &&
                                this.raise(be.ThisParamBannedInConstructor, e.value.this))
                    ...
                    flowCheckGetterSetterParams(e) {
                      ...
                      e.value.this &&
                        ...
                        s !== t &&
                          this.raise('get' === e.kind ? x.BadGetterArity : x.BadSetterArity, e),
                        'set' === e.kind && e.value.rest && this.raise(x.BadSetterRestParameter, e);
                    }
                    ...
                    flowParseFunctionTypeParam(e) {
                      ...
                      return (
                        14 === a.type || 17 === a.type
                          ? (n && !e && this.raise(be.ThisParamMustBeFirst, r),
                            (t = this.parseIdentifier(n)),
                            this.eat(17) &&
                              ((s = !0), n && this.raise(be.ThisParamMayNotBeOptional, r)),
                      ...
                      switch (this.state.type) {
                        ...
                        default:
                          if (J(this.state.type)) {
                            let e = X(this.state.type);
                            return this.next(), super.createIdentifier(i, e);
                          }
                          if (z(this.state.type))
                            return this.isContextual(129)
                              ? this.flowParseInterfaceType()
                              : this.flowIdentToTypeAnnotation(s, i, this.parseIdentifier());
                      }
                      this.unexpected();
                    }
                    ...
                    parseConditional(e, t, s) {
                      ...
                      if (o || l.length > 0) {
                        ...
                        o && h.length > 1 && this.raise(be.AmbiguousConditionalArrow, i.startLoc),
                          o &&
                            1 === h.length &&
                            ((this.state = i),
                            e.push(h[0].start),
                      ...
                      return (
                        ...
                        (a.test = e),
                        (a.consequent = n),
                        (a.alternate = this.forwardNoArrowParamsConversionAt(a, () =>
                    ...
                    tryParseConditionalConsequent() {
                      ...
                      let e = this.parseMaybeAssignAllowIn(),
                        t = !this.match(14);
                      return (
                        this.state.noArrowParamsConversionAt.pop(), { consequent: e, failed: t }
                      );
                    }
                    getArrowLikeExpressions(e, t) {
                      ...
                      return t
                        ...
                        : (function (e, t) {
                            let s = [],
                              i = [];
                            for (let r = 0; r < e.length; r++) (t(e[r]) ? s : i).push(e[r]);
                            return [s, i];
                    ...
                    parseParenItem(e, t) {
                      ...
                      if (
                        (this.eat(17) && ((s.optional = !0), this.resetEndLocation(e)),
                        this.match(14))
                      ) {
                    ...
                    eatExportStar(e) {
                      return (
                        ...
                        (!(!this.isContextual(130) || 55 !== this.lookahead().type) &&
                      ...
                      super.parseClassMember(e, t, s),
                        t.declare &&
                          ...
                          'PropertyDefinition' !== t.type
                            ? this.raise(be.DeclareClassElement, i)
                            : t.value && this.raise(be.DeclareClassFieldInitializer, t.value));
                    }
                    isIterator(e) {
                    ...
                    readIterator() {
                      ...
                      (!this.isIterator(e) || !this.state.inType) &&
                        this.raise(x.InvalidIdentifier, this.state.curPosition(), {
                          identifierName: t,
                        }),
                    ...
                    toReferencedList(e, t) {
                      for (let i = 0; i < e.length; i++) {
                        ...
                        r &&
                          ...
                          (e.length > 1 || !t) &&
                          this.raise(be.TypeCastInPattern, r.typeAnnotation);
                      }
                      return e;
                    }
                    parseArrayLike(e, t, s, i) {
                      let r = super.parseArrayLike(e, t, s, i);
                      return (
                        t &&
                    ...
                    pushClassMethod(e, t, s, i, r, a) {
                      if (
                        (t.variance && this.unexpected(t.variance.loc.start),
                        delete t.variance,
                        this.match(47) &&
                          (t.typeParameters = this.flowParseTypeParameterDeclaration()),
                        super.pushClassMethod(e, t, s, i, r, a),
                        t.params && r)
                      ) {
                        let e = t.params;
                        e.length > 0 &&
                          this.isThisParam(e[0]) &&
                          this.raise(be.ThisParamBannedInConstructor, t);
                    ...
                    checkGetterSetterParams(e) {
                      ...
                      if (t.length > 0) {
                        ...
                        this.isThisParam(s) && 'get' === e.kind
                          ? this.raise(be.GetterMayNotHaveThisParam, s)
                          : this.isThisParam(s) && this.raise(be.SetterMayNotHaveThisParam, s);
                      }
                    }
                    parsePropertyNamePrefixOperator(e) {
                      e.variance = this.flowParseVariance();
                    }
                    parseObjPropValue(e, t, s, i, r, a, n) {
                      let o;
                      ...
                      let h = super.parseObjPropValue(e, t, s, i, r, a, n);
                      return o && ((h.value || h).typeParameters = o), h;
                    }
                    parseFunctionParamType(e) {
                      return (
                        this.eat(17) &&
                          ('Identifier' !== e.type && this.raise(be.PatternIsOptional, e),
                          this.isThisParam(e) && this.raise(be.ThisParamMayNotBeOptional, e),
                          (e.optional = !0)),
                        this.match(14)
                          ? (e.typeAnnotation = this.flowParseTypeAnnotation())
                          : this.isThisParam(e) && this.raise(be.ThisParamAnnotationRequired, e),
                        this.match(29) &&
                          this.isThisParam(e) &&
                          this.raise(be.ThisParamNoDefault, e),
                    ...
                    parseMaybeDefault(e, t) {
                      ...
                      return (
                        'AssignmentPattern' === s.type &&
                          ...
                          this.raise(be.TypeBeforeInitializer, s.typeAnnotation),
                        s
                      );
                    }
                    checkImportReflection(e) {
                      super.checkImportReflection(e),
                        e.module &&
                          'value' !== e.importKind &&
                          this.raise(be.ImportReflectionHasImportType, e.specifiers[0].loc.start);
                    }
                    ...
                    applyImportPhase(e, t, s, i) {
                      if ((super.applyImportPhase(e, t, s, i), t)) {
                        if (!s && this.match(65)) return;
                        e.exportKind = 'type' === s ? s : 'value';
                      } else
                        'type' === s && this.match(55) && this.unexpected(),
                    ...
                    parseImportSpecifier(e, t, s, i, r) {
                      let a = e.imported,
                        n = null;
                      'Identifier' === a.type &&
                        ('type' === a.name ? (n = 'type') : 'typeof' === a.name && (n = 'typeof'));
                      let o = !1;
                      if (this.isContextual(93) && !this.isLookaheadContextual('as')) {
                        let t = this.parseIdentifier(!0);
                        null === n || V(this.state.type)
                          ? ((e.imported = a),
                            (e.importKind = null),
                        ...
                        if (null !== n && V(this.state.type))
                          (e.imported = this.parseIdentifier(!0)), (e.importKind = n);
                        else {
                          if (t)
                            throw this.raise(x.ImportBindingIsString, e, { importName: a.value });
                          (e.imported = a), (e.importKind = null);
                        }
                        this.eatContextual(93)
                          ? (e.local = this.parseIdentifier())
                          : ((o = !0), (e.local = this.cloneIdentifier(e.imported)));
                      }
                      let h = Ae(e);
                      return (
                        s && h && this.raise(be.ImportTypeShorthandOnlyInPureImport, e),
                    ...
                    parseMaybeAssign(e, t) {
                      ...
                      if (this.hasPlugin('jsx') && (this.match(143) || this.match(47))) {
                        if (
                          ((r = this.state.clone()),
                          (i = this.tryParse(() => super.parseMaybeAssign(e, t), r)),
                          !i.error)
                        )
                          return i.node;
                        let { context: s } = this.state,
                          a = s[s.length - 1];
                        (a === A.j_oTag || a === A.j_expr) && s.pop();
                      }
                      if ((null != (s = i) && s.error) || this.match(47)) {
                        var a, n;
                        ...
                        let s,
                          o = this.tryParse((i) => {
                            ...
                            let a = this.forwardNoArrowParamsConversionAt(s, () => {
                              ...
                              return this.resetStartLocationFromNode(i, s), i;
                            });
                            null != (r = a.extra) && r.parenthesized && i();
                            let n = this.maybeUnwrapTypeCastExpression(a);
                            return (
                              'ArrowFunctionExpression' !== n.type && i(),
                              (n.typeParameters = s),
                        ...
                        if (
                          ...
                          if (!o.error && !o.aborted)
                            return (
                              o.node.async &&
                                this.raise(be.UnexpectedTypeParameterBeforeAsyncArrowFunction, s),
                              o.node
                            );
                          h = o.node;
                        }
                        if (null != (a = i) && a.node) return (this.state = i.failState), i.node;
                        if (h) return (this.state = o.failState), h;
                        throw null != (n = i) && n.thrown
                          ? i.error
                          : o.thrown
                            ? o.error
                            : this.raise(be.UnexpectedTokenAfterTypeParameter, s);
                      }
                      ...
                      if (
                        ...
                        for (let t = 0; t < e.params.length; t++)
                          this.isThisParam(e.params[t]) &&
                            t > 0 &&
                            this.raise(be.ThisParamMustBeFirst, e.params[t]);
                    ...
                    parseSubscripts(e, t, s) {
                      if (
                        ...
                        (s.callee = e),
                          (s.arguments = super.parseCallExpressionArguments(11)),
                        ...
                        let a = this.tryParse(() => super.parseSubscripts(e, t, s), i);
                    ...
                    parseSubscript(e, t, s, i) {
                      if (this.match(18) && this.isLookaheadToken_lt()) {
                        if (((i.optionalChainMember = !0), s)) return (i.stop = !0), e;
                        this.next();
                      ...
                      if (!s && this.shouldParseTypes() && (this.match(47) || this.match(51))) {
                        let s = this.startNodeAt(t);
                        s.callee = e;
                        let r = this.tryParse(
                          () => (
                            (s.typeArguments = this.flowParseTypeParameterInstantiationCallOrNew()),
                            this.expect(10),
                            (s.arguments = super.parseCallExpressionArguments(11)),
                        ...
                        if (r.node) return r.error && (this.state = r.failState), r.node;
                      }
                    ...
                    parseTopLevel(e, t) {
                      ...
                      return (
                        this.state.hasFlowComment &&
                          this.raise(be.UnterminatedFlowComment, this.state.curPosition()),
                        s
                      );
                    }
                    skipBlockComment() {
                    ...
                    flowEnumErrorBooleanMemberNotInitialized(e, { enumName: t, memberName: s }) {
                      this.raise(be.EnumBooleanMemberNotInitialized, e, {
                        memberName: s,
                        enumName: t,
                      });
                    }
                    ...
                    flowEnumErrorNumberMemberNotInitialized(e, t) {
                      this.raise(be.EnumNumberMemberNotInitialized, e, t);
                    }
                    flowEnumErrorStringMemberInconsistentlyInitialized(e, t) {
                      this.raise(be.EnumStringMemberInconsistentlyInitialized, e, t);
                    }
                    flowEnumMemberInit() {
                      let e = this.state.startLoc,
                      ...
                      switch (this.state.type) {
                        case 135: {
                          ...
                          return t()
                            ? { type: 'number', loc: s.loc.start, value: s }
                            : { type: 'invalid', loc: e };
                        }
                        case 134: {
                          let s = this.parseStringLiteral(this.state.value);
                          return t()
                            ? { type: 'string', loc: s.loc.start, value: s }
                            : { type: 'invalid', loc: e };
                        }
                        case 85:
                        case 86: {
                          ...
                          return t()
                            ? { type: 'boolean', loc: s.loc.start, value: s }
                            : { type: 'invalid', loc: e };
                        }
                        default:
                    ...
                    flowEnumCheckExplicitTypeMismatch(e, t, s) {
                      ...
                      null !== i && i !== s && this.flowEnumErrorInvalidMemberInitializer(e, t);
                    }
                    flowEnumMembers({ enumName: e, explicitType: t }) {
                      ...
                      for (; !this.match(8); ) {
                        ...
                        if ('' === h) continue;
                        /^[a-z]/.test(h) &&
                          this.raise(be.EnumInvalidMemberName, n, {
                            memberName: h,
                            suggestion: h[0].toUpperCase() + h.slice(1),
                            enumName: e,
                          }),
                          s.has(h) &&
                            this.raise(be.EnumDuplicateMemberName, n, {
                              memberName: h,
                              enumName: e,
                            }),
                          s.add(h);
                        let l = { enumName: e, explicitType: t, memberName: h };
                        switch (((a.id = n), o.type)) {
                          case 'boolean':
                            this.flowEnumCheckExplicitTypeMismatch(o.loc, l, 'boolean'),
                              (a.init = o.value),
                              i.booleanMembers.push(this.finishNode(a, 'EnumBooleanMember'));
                            break;
                          case 'number':
                            this.flowEnumCheckExplicitTypeMismatch(o.loc, l, 'number'),
                              (a.init = o.value),
                              i.numberMembers.push(this.finishNode(a, 'EnumNumberMember'));
                            break;
                          case 'string':
                            this.flowEnumCheckExplicitTypeMismatch(o.loc, l, 'string'),
                              (a.init = o.value),
                              i.stringMembers.push(this.finishNode(a, 'EnumStringMember'));
                            break;
                          case 'invalid':
                    ...
                    flowEnumStringMembers(e, t, { enumName: s }) {
                      ...
                      for (let e of t)
                        this.flowEnumErrorStringMemberInconsistentlyInitialized(e, { enumName: s });
                      return e;
                    }
                    ...
                    flowEnumBody(e, t) {
                      ...
                      switch (((e.hasUnknownMembers = n), r)) {
                        case 'boolean':
                          return (
                            (e.explicitType = !0),
                        ...
                        default: {
                          ...
                          return (
                            this.raise(be.EnumInconsistentMemberValues, i, { enumName: s }), t()
                          );
                        }
                      }
                    }
                ...
                typescript: (e) =>
                  class extends e {
                    constructor(...e) {
                      super(...e),
                        (this.tsParseInOutModifiers = this.tsParseModifiers.bind(this, {
                          ...
                          errorTemplate: xt.InvalidModifierOnTypeParameter,
                        })),
                        (this.tsParseConstModifier = this.tsParseModifiers.bind(this, {
                          allowedModifiers: ['const'],
                          disallowedModifiers: ['in', 'out'],
                          errorTemplate: xt.InvalidModifierOnTypeParameterPositions,
                        })),
                    ...
                    tsParseModifier(e, t, s) {
                      if (!z(this.state.type) && 58 !== this.state.type && 75 !== this.state.type)
                        return;
                      let i = this.state.value;
                      if (e.includes(i)) {
                        if ((s && this.match(106)) || (t && this.tsIsStartOfStaticBlocks())) return;
                    ...
                    tsParseModifiers(
                      {
                        ...
                        errorTemplate: i = xt.InvalidModifierOnTypeMember,
                      },
                      r
                    ) {
                      let a = (e, t, s, i) => {
                          t === s &&
                            r[i] &&
                            this.raise(xt.InvalidModifiersOrder, e, { orderedModifiers: [s, i] });
                        },
                        n = (e, t, s, i) => {
                          ((r[s] && t === i) || (r[i] && t === s)) &&
                            this.raise(xt.IncompatibleModifiers, e, { modifiers: [s, i] });
                        };
                      for (;;) {
                        let { startLoc: o } = this.state,
                          h = this.tsParseModifier(e.concat(t ?? []), s, r.static);
                        if (!h) break;
                        Pt(h)
                          ? r.accessibility
                            ? this.raise(xt.DuplicateAccessibilityModifier, o, { modifier: h })
                            : (a(o, h, h, 'override'),
                              a(o, h, h, 'static'),
                              a(o, h, h, 'readonly'),
                              (r.accessibility = h))
                          : gt(h)
                            ? (r[h] && this.raise(xt.DuplicateModifier, o, { modifier: h }),
                              (r[h] = !0),
                              a(o, h, 'in', 'out'))
                            : (hasOwnProperty.call(r, h)
                                ? this.raise(xt.DuplicateModifier, o, { modifier: h })
                                : (a(o, h, 'static', 'readonly'),
                                  a(o, h, 'static', 'override'),
                                  a(o, h, 'override', 'readonly'),
                                  a(o, h, 'abstract', 'override'),
                                  n(o, h, 'declare', 'override'),
                                  n(o, h, 'static', 'abstract')),
                              (r[h] = !0)),
                          null != t && t.includes(h) && this.raise(i, o, { modifier: h });
                      }
                    }
                    ...
                    tsParseImportType() {
                      ...
                      return (
                        ...
                        this.match(134)
                          ...
                          : (this.raise(xt.UnsupportedImportTypeArgument, this.state.startLoc),
                    ...
                    tsParseImportTypeWithPropertyValue() {
                      ...
                      return (
                        (e.properties = t), this.next(), this.finishNode(e, 'ObjectExpression')
                      );
                    }
                    tsParseEntityName(e) {
                      let t;
                    ...
                    tsParseTypeParameters(e) {
                      ...
                      return (
                        ...
                        0 === t.params.length && this.raise(xt.EmptyTypeParameters, t),
                    ...
                    tsParseBindingListForSignature() {
                      ...
                      for (let t of e) {
                        ...
                        ('AssignmentPattern' === e || 'TSParameterProperty' === e) &&
                          this.raise(xt.UnsupportedSignatureParameterKind, t, { type: e });
                      }
                      return e;
                    }
                    ...
                    tsIsUnambiguouslyIndexSignature() {
                      return this.next(), !!z(this.state.type) && (this.next(), this.match(14));
                    }
                    ...
                    tsParsePropertyOrMethodSignature(e, t) {
                      if ((this.eat(17) && (e.optional = !0), this.match(10) || this.match(47))) {
                        ...
                        s.kind &&
                          this.match(47) &&
                          this.raise(xt.AccessorCannotHaveTypeParameters, this.state.curPosition()),
                        ...
                        if ('get' === s.kind)
                          s[i].length > 0 &&
                            (this.raise(x.BadGetterArity, this.state.curPosition()),
                            this.isThisParam(s[i][0]) &&
                              this.raise(
                                xt.AccessorCannotDeclareThisParameter,
                                this.state.curPosition()
                              ));
                        else if ('set' === s.kind) {
                          if (1 !== s[i].length)
                            ...
                            this.isThisParam(e) &&
                              ...
                              'Identifier' === e.type &&
                                e.optional &&
                                this.raise(
                                  xt.SetAccessorCannotHaveOptionalParameter,
                                  this.state.curPosition()
                                ),
                              'RestElement' === e.type &&
                                this.raise(
                                  xt.SetAccessorCannotHaveRestParameter,
                                  this.state.curPosition()
                                );
                          }
                          s[r] && this.raise(xt.SetAccessorCannotHaveReturnType, s[r]);
                        } else s.kind = 'method';
                      ...
                      return (
                        e.elementTypes.forEach((e) => {
                          ...
                          t &&
                            ...
                            this.raise(xt.OptionalTypeBeforeRequired, e),
                            t ||
                              (t =
                                ('TSNamedTupleMember' === s && e.optional) ||
                                'TSOptionalType' === s);
                    ...
                    tsParseTupleElementType() {
                      let e,
                        ...
                        a = this.eat(21),
                        { startLoc: n } = this.state,
                        o = V(this.state.type) ? this.lookaheadCharCode() : null;
                      if (58 === o)
                        (e = !0),
                          (s = !1),
                        ...
                        58 === this.lookaheadCharCode()
                          ? ((e = !0),
                            (t = this.createIdentifier(this.startNodeAt(n), r)),
                            this.expect(17),
                            this.expect(14),
                            (i = this.tsParseType()))
                          : ((e = !1), (i = a), this.expect(17));
                      } else (i = this.tsParseType()), (s = this.eat(17)), (e = this.eat(14));
                      if (e) {
                        let e;
                        t
                          ? ((e = this.startNodeAt(n)),
                            (e.optional = s),
                            (e.label = t),
                            (e.elementType = i),
                            this.eat(17) &&
                              ((e.optional = !0),
                              this.raise(xt.TupleOptionalAfterType, this.state.lastTokStartLoc)))
                          : ((e = this.startNodeAt(n)),
                            (e.optional = s),
                            this.raise(xt.InvalidTupleMemberLabel, i),
                            (e.label = i),
                            (e.elementType = this.tsParseType())),
                          (i = this.finishNode(e, 'TSNamedTupleMember'));
                      } else if (s) {
                        let e = this.startNodeAt(n);
                        (e.typeAnnotation = i), (i = this.finishNode(e, 'TSOptionalType'));
                      }
                      if (a) {
                        let e = this.startNodeAt(r);
                        (e.typeAnnotation = i), (i = this.finishNode(e, 'TSRestType'));
                      }
                      return i;
                    }
                    ...
                    tsParseTemplateLiteralType() {
                      {
                        let e = this.startNode();
                        return (
                          (e.literal = super.parseTemplate(!1)), this.finishNode(e, 'TSLiteralType')
                        );
                      }
                    }
                        ...
                        case 53:
                          if ('-' === this.state.value) {
                            let e = this.startNode(),
                              t = this.lookahead();
                            return (
                              135 !== t.type && 136 !== t.type && this.unexpected(),
                    ...
                    tsParseUnionOrIntersectionType(e, t, s) {
                      ...
                      return 1 !== a.length || r ? ((i.types = a), this.finishNode(i, e)) : a[0];
                    }
                    ...
                    tsSkipParameterStart() {
                      if (z(this.state.type) || this.match(78)) return this.next(), !0;
                      if (this.match(5)) {
                    ...
                    tsParseTypePredicateAsserts() {
                      ...
                      return (
                        ...
                        !(
                          ...
                          (e &&
                            this.raise(x.InvalidEscapedReservedWord, this.state.lastTokStartLoc, {
                    ...
                    tsParseTypeAssertion() {
                      this.getPluginOption('typescript', 'disallowAmbiguousJSXLike') &&
                        this.raise(xt.ReservedTypeAssertion, this.state.startLoc);
                      let e = this.startNode();
                      return (
                        ...
                        s = this.tsParseDelimitedList('HeritageClauseElement', () => {
                          {
                            let e = this.startNode();
                            return (
                              (e.expression = this.tsParseEntityName(3)),
                              this.match(47) && (e.typeParameters = this.tsParseTypeArguments()),
                              this.finishNode(e, 'TSExpressionWithTypeArguments')
                            );
                          }
                        });
                      return s.length || this.raise(xt.EmptyHeritageClauseType, t, { token: e }), s;
                    }
                    tsParseInterfaceDeclaration(e, t = {}) {
                      ...
                      this.expectContextual(129),
                        ...
                        z(this.state.type)
                          ...
                          : ((e.id = null),
                            this.raise(xt.MissingInterfaceName, this.state.startLoc)),
                      ...
                      return (
                        ...
                        (e.typeAnnotation = this.tsInType(() => {
                          if (
                            ...
                            this.expect(29),
                            this.isContextual(114) && 46 !== this.lookaheadCharCode())
                          ) {
                            let e = this.startNode();
                    ...
                    tsParseImportEqualsDeclaration(e, t, s) {
                      ...
                      return (
                        'type' === e.importKind &&
                          'TSExternalModuleReference' !== i.type &&
                          this.raise(xt.ImportAliasHasImportType, i),
                        (e.moduleReference = i),
                        this.semicolon(),
                        ...
                        switch (t) {
                          ...
                          case 107:
                            if (this.hasPlugin('explicitResourceManagement') && this.isUsing())
                              return (
                                this.raise(
                                  xt.InvalidModifierOnUsingDeclaration,
                                  this.state.startLoc,
                                  'declare'
                                ),
                                (e.declare = !0),
                          ...
                          case 96:
                            if (this.hasPlugin('explicitResourceManagement') && this.isAwaitUsing())
                              return (
                                this.raise(
                                  xt.InvalidModifierOnAwaitUsingDeclaration,
                                  this.state.startLoc,
                                  'declare'
                                ),
                                (e.declare = !0),
                          ...
                          default:
                            if (z(t)) return this.tsParseDeclaration(e, this.state.value, !0, null);
                        }
                      });
                    }
                      ...
                      switch (t) {
                        ...
                        case 'module':
                          if (this.tsCheckLineTerminator(s)) {
                            ...
                            if (z(this.state.type))
                              return (
                                (e.kind = 'module'), this.tsParseModuleOrNamespaceDeclaration(e)
                              );
                          }
                          break;
                        case 'namespace':
                          if (this.tsCheckLineTerminator(s) && z(this.state.type))
                            return (
                              (e.kind = 'namespace'), this.tsParseModuleOrNamespaceDeclaration(e)
                            );
                          break;
                        case 'type':
                          if (this.tsCheckLineTerminator(s) && z(this.state.type))
                    ...
                    tsTryParseGenericAsyncArrowFunction(e) {
                      ...
                      return (
                        ...
                        s ? super.parseArrowExpression(s, null, !0) : void 0
                      );
                    }
                    ...
                    tsParseTypeArguments() {
                      ...
                      return (
                        ...
                        0 === e.params.length
                          ? this.raise(xt.EmptyTypeArguments, e)
                          : !this.state.inType &&
                            this.curContext() === A.brace &&
                            this.reScan_lt_gt(),
                        this.expect(48),
                    ...
                    parseBindingElement(e, t) {
                      let s = t.length ? t[0].loc.start : this.state.startLoc,
                        i = {};
                      this.tsParseModifiers(
                        {
                          allowedModifiers: [
                      ...
                      let r = i.accessibility,
                        a = i.override,
                        n = i.readonly;
                      !(4 & e) && (r || n || a) && this.raise(xt.UnexpectedParameterModifier, s);
                      ...
                      if (r || n || a) {
                        ...
                        return (
                          ...
                          a && (e.override = a),
                          'Identifier' !== h.type &&
                            'AssignmentPattern' !== h.type &&
                            this.raise(xt.UnsupportedParameterPropertyKind, e),
                          (e.parameter = h),
                    ...
                    tsDisallowOptionalPattern(e) {
                      for (let t of e.params)
                        'Identifier' !== t.type &&
                          ...
                          this.raise(xt.PatternIsOptional, t);
                    }
                    ...
                    parseFunctionBodyAndFinish(e, t, s = !1) {
                      ...
                      return i && !this.match(5) && this.isLineTerminator()
                        ...
                        : 'TSDeclareFunction' === i &&
                            this.state.isAmbientContext &&
                            (this.raise(xt.DeclareFunctionHasImplementation, e), e.declare)
                    ...
                    tsCheckForInvalidTypeCasts(e) {
                      e.forEach((e) => {
                        'TSTypeCastExpression' === (null == e ? void 0 : e.type) &&
                          this.raise(xt.UnexpectedTypeAnnotation, e.typeAnnotation);
                      });
                    }
                    toReferencedList(e, t) {
                    ...
                    parseArrayLike(e, t, s, i) {
                      let r = super.parseArrayLike(e, t, s, i);
                      return (
                        'ArrayExpression' === r.type && this.tsCheckForInvalidTypeCasts(r.elements),
                        r
                      );
                    }
                    parseSubscript(e, t, s, i) {
                      ...
                      if (this.match(47) || this.match(51)) {
                        let a,
                          n = this.tsTryParseAndCatch(() => {
                            ...
                            if (!n) return;
                            if (r && !this.match(10)) return void (a = this.state.curPosition());
                            if (Y(this.state.type)) {
                            ...
                            if (
                              48 === o ||
                              52 === o ||
                              (10 !== o && q(o) && !this.hasPrecedingLineBreak())
                            )
                              return;
                        ...
                        if ((a && this.unexpected(a, 10), n))
                          return (
                            'TSInstantiationExpression' === n.type &&
                              ((this.match(16) ||
                                (this.match(18) && 40 !== this.lookaheadCharCode())) &&
                                this.raise(
                                  xt.InvalidPropertyAccessAfterInstantiationExpression,
                                  this.state.startLoc
                                ),
                              !this.match(16) &&
                                !this.match(18) &&
                                (n.expression = super.stopParseSubscript(e, i))),
                            n
                          );
                      }
                      return super.parseSubscript(e, t, s, i);
                    ...
                    parseNewCallee(e) {
                      ...
                      super.parseNewCallee(e);
                      let { callee: s } = e;
                      'TSInstantiationExpression' === s.type &&
                        (null == (t = s.extra) || !t.parenthesized) &&
                        ((e.typeParameters = s.typeParameters), (e.callee = s.expression));
                    }
                    parseExprOp(e, t, s) {
                      let i;
                      if (
                        G(58) > s &&
                        !this.hasPrecedingLineBreak() &&
                        (this.isContextual(93) || (i = this.isContextual(120)))
                      ) {
                        let r = this.startNodeAt(t);
                        return (
                          (r.expression = e),
                          (r.typeAnnotation = this.tsInType(
                            () => (
                              ...
                              this.match(75)
                                ? (i &&
                                    this.raise(x.UnexpectedKeyword, this.state.startLoc, {
                                      keyword: 'const',
                                    }),
                          ...
                          this.finishNode(r, i ? 'TSSatisfiesExpression' : 'TSAsExpression'),
                          this.reScan_lt_gt(),
                          this.parseExprOp(r, t, s)
                        );
                      }
                    ...
                    checkImportReflection(e) {
                      super.checkImportReflection(e),
                        e.module &&
                          'value' !== e.importKind &&
                          this.raise(xt.ImportReflectionHasImportType, e.specifiers[0].loc.start);
                    }
                    ...
                    parseImport(e) {
                      ...
                      if (this.isContextual(130)) {
                        ...
                        if (61 === this.lookaheadCharCode())
                          return this.tsParseImportEqualsDeclaration(e, s);
                      ...
                      return (
                        'type' === t.importKind &&
                          ...
                          this.raise(xt.TypeImportCannotSpecifyDefaultAndNamed, t),
                        t
                      );
                    }
                    parseExport(e, t) {
                      if (this.match(83)) {
                        ...
                        return (
                          this.isContextual(130) && this.isPotentialImportPhase(!1)
                            ...
                            : (t.importKind = 'value'),
                          this.tsParseImportEqualsDeclaration(t, s, !0)
                        );
                      }
                      if (this.eat(29)) {
                        let t = e;
                    ...
                    parseVarStatement(e, t, s = !1) {
                      ...
                      if (!e.declare && ('using' === t || 'await using' === t))
                        return this.raiseOverwrite(xt.UsingDeclarationInAmbientContext, e, t), r;
                      for (let { id: e, init: s } of r.declarations)
                        s &&
                          ('var' === t || 'let' === t || e.typeAnnotation
                            ? this.raise(xt.InitializerNotAllowedInAmbientContext, s)
                            : bt(s, this.hasPlugin('estree')) ||
                              this.raise(
                                xt.ConstInitializerMustBeStringOrNumericLiteralOrLiteralEnumReference,
                                s
                              ));
                      return r;
                    }
                    ...
                    tsHasSomeModifiers(e, t) {
                      return t.some((t) => (Pt(t) ? e.accessibility === t : !!e[t]));
                    }
                        ...
                        this.tsIsStartOfStaticBlocks()
                          ? (this.next(),
                            ...
                            this.tsHasSomeModifiers(t, i) &&
                              this.raise(
                                xt.StaticBlockCannotHaveModifier,
                                this.state.curPosition()
                              ),
                    ...
                    parseClassMemberWithIsStatic(e, t, s, i) {
                      ...
                      if (r)
                        return (
                          e.body.push(r),
                          t.abstract && this.raise(xt.IndexSignatureHasAbstract, t),
                          t.accessibility &&
                            this.raise(xt.IndexSignatureHasAccessibility, t, {
                              modifier: t.accessibility,
                            }),
                          t.declare && this.raise(xt.IndexSignatureHasDeclare, t),
                          void (t.override && this.raise(xt.IndexSignatureHasOverride, t))
                        );
                      !this.state.inAbstractClass &&
                        t.abstract &&
                        this.raise(xt.NonAbstractClassHasAbstractMethod, t),
                        t.override && (s.hadSuperClass || this.raise(xt.OverrideNotInSubClass, t)),
                        super.parseClassMemberWithIsStatic(e, t, s, i);
                    }
                    parsePostMemberNameModifiers(e) {
                      this.eat(17) && (e.optional = !0),
                        e.readonly && this.match(10) && this.raise(xt.ClassMethodHasReadonly, e),
                        e.declare && this.match(10) && this.raise(xt.ClassMethodHasDeclare, e);
                    }
                    parseExpressionStatement(e, t, s) {
                      return (
                        ('Identifier' === t.type
                          ? this.tsParseExpressionStatement(e, t, s)
                          : void 0) || super.parseExpressionStatement(e, t, s)
                      );
                    }
                    shouldParseExportDeclaration() {
                    ...
                    parseExportDeclaration(e) {
                      ...
                      let t = this.state.startLoc,
                        s = this.eatContextual(125);
                      if (s && (this.isContextual(125) || !this.shouldParseExportDeclaration()))
                        throw this.raise(xt.ExpectedAmbientAfterExportDeclare, this.state.startLoc);
                      let i =
                        (z(this.state.type) && this.tsTryParseExportDeclaration()) ||
                    ...
                    parseClassId(e, t, s, i) {
                      if ((!t || s) && this.isContextual(113)) return;
                      super.parseClassId(e, t, s, e.declare ? 1024 : 8331);
                      let r = this.tsTryParseTypeParameters(this.tsParseInOutConstModifiers);
                    ...
                    parseClassProperty(e) {
                      if (
                        ...
                        this.state.isAmbientContext &&
                          ...
                          this.match(29) &&
                          this.raise(xt.DeclareClassFieldHasInitializer, this.state.startLoc),
                        e.abstract && this.match(29))
                      ) {
                        let { key: t } = e;
                        this.raise(xt.AbstractPropertyHasInitializer, this.state.startLoc, {
                          propertyName:
                    ...
                    parseClassPrivateProperty(e) {
                      return (
                        e.abstract && this.raise(xt.PrivateElementHasAbstract, e),
                        e.accessibility &&
                          this.raise(xt.PrivateElementHasAccessibility, e, {
                    ...
                    parseObjPropValue(e, t, s, i, r, a, n) {
                      ...
                      return (
                        o && (e.typeParameters = o), super.parseObjPropValue(e, t, s, i, r, a, n)
                      );
                    }
                    parseFunctionParams(e, t) {
                    ...
                    parseMaybeAssign(e, t) {
                      ...
                      if (this.hasPlugin('jsx') && (this.match(143) || this.match(47))) {
                        if (
                          ((o = this.state.clone()),
                          (h = this.tryParse(() => super.parseMaybeAssign(e, t), o)),
                          !h.error)
                        )
                          return h.node;
                        let { context: s } = this.state,
                          i = s[s.length - 1];
                        (i === A.j_oTag || i === A.j_expr) && s.pop();
                      }
                      if (!((null != (s = h) && s.error) || this.match(47)))
                        return super.parseMaybeAssign(e, t);
                      ...
                      if (!c.error && !c.aborted)
                        return p && this.reportReservedArrowTypeParam(p), c.node;
                      if (
                        !h &&
                        (yt(!this.hasPlugin('jsx')),
                        (l = this.tryParse(() => super.parseMaybeAssign(e, t), o)),
                        !l.error)
                      )
                        return l.node;
                      if (null != (i = h) && i.node) return (this.state = h.failState), h.node;
                      if (c.node)
                        return (
                      ...
                      throw (
                        (null == (a = h) ? void 0 : a.error) ||
                        c.error ||
                        (null == (n = l) ? void 0 : n.error)
                      );
                    }
                    reportReservedArrowTypeParam(e) {
                      ...
                      1 === e.params.length &&
                        ...
                        this.getPluginOption('typescript', 'disallowAmbiguousJSXLike') &&
                        this.raise(xt.ReservedArrowTypeParam, e);
                    }
                    parseMaybeUnary(e, t) {
                    ...
                    toAssignable(e, t = !1) {
                      switch (e.type) {
                        ...
                        case 'TSTypeAssertion':
                          t
                            ? this.expressionScope.recordArrowParameterBindingError(
                                xt.UnexpectedTypeCastInParameter,
                                e
                              )
                            : this.raise(xt.UnexpectedTypeCastInParameter, e),
                    ...
                    isValidLVal(e, t, s) {
                      switch (e) {
                        ...
                        case 'TSSatisfiesExpression':
                        case 'TSTypeAssertion':
                          return (64 !== s || !t) && ['expression', !0];
                        default:
                          return super.isValidLVal(e, t, s);
                      }
                    }
                    parseBindingAtom() {
                      return 78 === this.state.type
                    ...
                    parseMaybeDefault(e, t) {
                      ...
                      return (
                        'AssignmentPattern' === s.type &&
                          s.typeAnnotation &&
                          s.right.start < s.typeAnnotation.start &&
                          this.raise(xt.TypeAnnotationAfterAssign, s.typeAnnotation),
                        s
                      );
                    }
                    getTokenFromCode(e) {
                    ...
                    toAssignableListItem(e, t, s) {
                      let i = e[t];
                      'TSTypeCastExpression' === i.type && (e[t] = this.typeCastToParameter(i)),
                    ...
                    tsParseAbstractDeclaration(e, t) {
                      if (this.match(80))
                        return (
                          (e.abstract = !0), this.maybeTakeDecorators(t, this.parseClass(e, !0, !1))
                        );
                      if (this.isContextual(129)) {
                        if (!this.hasFollowingLineBreak())
                          return (
                            (e.abstract = !0),
                            this.raise(xt.NonClassMethodPropertyHasAbstractModifier, e),
                            this.tsParseInterfaceDeclaration(e)
                          );
                      } else this.unexpected(null, 80);
                    }
                    parseMethod(e, t, s, i, r, a, n) {
                      let o = super.parseMethod(e, t, s, i, r, a, n);
                      if (
                        (o.abstract || 'TSAbstractMethodDefinition' === o.type) &&
                        (this.hasPlugin('estree') ? o.value : o).body
                      ) {
                        let { key: e } = o;
                        this.raise(xt.AbstractMethodHasImplementation, o, {
                          methodName:
                            'Identifier' !== e.type || o.computed
                    ...
                    parseExportSpecifier(e, t, s, i) {
                      return !t && i
                        ...
                        : ((e.exportKind = 'value'), super.parseExportSpecifier(e, t, s, i));
                    }
                    parseImportSpecifier(e, t, s, i, r) {
                      return !t && i
                    ...
                    parseTypeOnlyImportExportSpecifier(e, t, s) {
                      ...
                      if (this.isContextual(93)) {
                        ...
                        if (this.isContextual(93)) {
                          ...
                          V(this.state.type)
                            ? ((o = !0),
                              (n = e),
                              (i = t ? this.parseIdentifier() : this.parseModuleExportName()),
                              (h = !1))
                            : ((i = s), (h = !1));
                        } else
                          V(this.state.type)
                      ...
                      o &&
                        ...
                        this.raise(
                          t
                            ? xt.TypeModifierIsUsedInTypeImports
                            : xt.TypeModifierIsUsedInTypeExports,
                          l
                        ),
                        (e[r] = n),
                        (e[a] = i),
                        ...
                        e[a] || (e[a] = this.cloneIdentifier(e[r])),
                        t && this.checkIdentifier(e[a], o ? 4098 : 4096);
                    }
                    fillOptionalPropertiesForTSESLint(e) {
                      switch (e.type) {
                        case 'ExpressionStatement':
                          return void (null != e.directive || (e.directive = void 0));
                        case 'RestElement':
                          e.value = void 0;
                        case 'Identifier':
                        case 'ArrayPattern':
                        ...
                        case 'ObjectPattern':
                          return (
                            null != e.decorators || (e.decorators = []),
                            null != e.optional || (e.optional = !1),
                            void (null != e.typeAnnotation || (e.typeAnnotation = void 0))
                          );
                        case 'TSParameterProperty':
                          return (
                            null != e.accessibility || (e.accessibility = void 0),
                            null != e.decorators || (e.decorators = []),
                            null != e.override || (e.override = !1),
                            null != e.readonly || (e.readonly = !1),
                            void (null != e.static || (e.static = !1))
                          );
                        ...
                        case 'ClassPrivateMethod':
                          return (
                            null != e.declare || (e.declare = !1),
                            null != e.returnType || (e.returnType = void 0),
                            void (null != e.typeParameters || (e.typeParameters = void 0))
                          );
                        case 'Property':
                          return void (null != e.optional || (e.optional = !1));
                        ...
                        case 'AccessorProperty':
                          null != e.declare || (e.declare = !1),
                            ...
                            null != e.readonly || (e.readonly = !1),
                            null != e.typeAnnotation || (e.typeAnnotation = void 0);
                        ...
                        case 'MethodDefinition':
                          return (
                            ...
                            null != e.decorators || (e.decorators = []),
                            null != e.override || (e.override = !1),
                            void (null != e.optional || (e.optional = !1))
                          );
                        case 'ClassExpression':
                          null != e.id || (e.id = null);
                        case 'ClassDeclaration':
                          return (
                            null != e.abstract || (e.abstract = !1),
                            null != e.declare || (e.declare = !1),
                            null != e.decorators || (e.decorators = []),
                            null != e.implements || (e.implements = []),
                            null != e.superTypeArguments || (e.superTypeArguments = void 0),
                            void (null != e.typeParameters || (e.typeParameters = void 0))
                          );
                        case 'TSTypeAliasDeclaration':
                        case 'VariableDeclaration':
                          return void (null != e.declare || (e.declare = !1));
                        case 'VariableDeclarator':
                          return void (null != e.definite || (e.definite = !1));
                        case 'TSEnumDeclaration':
                          return (
                            null != e.const || (e.const = !1),
                            void (null != e.declare || (e.declare = !1))
                          );
                        case 'TSEnumMember':
                          return void (null != e.computed || (e.computed = !1));
                        case 'TSImportType':
                          return (
                            null != e.qualifier || (e.qualifier = null),
                            void (null != e.options || (e.options = null))
                          );
                        case 'TSInterfaceDeclaration':
                          return (
                            null != e.declare || (e.declare = !1),
                            void (null != e.extends || (e.extends = []))
                          );
                        case 'TSModuleDeclaration':
                          return (
                            null != e.declare || (e.declare = !1),
                            void (null != e.global || (e.global = 'global' === e.kind))
                          );
                        case 'TSTypeParameter':
                          return (
                            null != e.const || (e.const = !1),
                            null != e.in || (e.in = !1),
                            void (null != e.out || (e.out = !1))
                          );
                      }
                    }
                  },
                    ...
                    parseV8Intrinsic() {
                      if (this.match(54)) {
                        ...
                        if ((this.next(), z(this.state.type))) {
                          ...
                          if ((this.castNodeTo(s, 'V8IntrinsicIdentifier'), this.match(10)))
                            return s;
                        }
                        this.unexpected(e);
                      }
                ...
                placeholders: (e) =>
                  class extends e {
                    ...
                    finishPlaceholder(e, t) {
                      let s = e;
                      return (
                        (!s.expectedNode || !s.type) && (s = this.finishNode(s, 'Placeholder')),
                        (s.expectedNode = t),
                        s
                      );
                    }
                    ...
                    chStartsBindingIdentifier(e, t) {
                      ...
                      return 37 === this.input.charCodeAt(s) && 37 === this.input.charCodeAt(s + 1);
                    }
                    ...
                    parseExpressionStatement(e, t) {
                      var s;
                      if ('Placeholder' !== t.type || (null != (s = t.extra) && s.parenthesized))
                      ...
                      this.semicolon();
                      let i = e;
                      return (i.name = t.name), this.finishPlaceholder(i, 'Statement');
                    }
                    parseBlock(e, t, s) {
                    ...
                    parseExport(e, t) {
                      ...
                      if (!this.isContextual(98) && !this.match(12))
                        return (
                          (i.specifiers = []),
                          (i.source = null),
                          (i.declaration = this.finishPlaceholder(s, 'Declaration')),
                      ...
                      return (
                        (r.exported = s),
                        (i.specifiers = [this.finishNode(r, 'ExportDefaultSpecifier')]),
                        super.parseExport(i, t)
                      );
                    }
                    isExportDefaultSpecifier() {
                      if (this.match(65)) {
                        ...
                        if (
                          ...
                          this.input.startsWith(X(133), this.nextTokenStartSince(e + 4))
                        )
                          return !0;
                      }
                    ...
                    checkExport(e) {
                      ...
                      null != t &&
                        t.length &&
                        (e.specifiers = t.filter((e) => 'Placeholder' === e.exported.type)),
                        super.checkExport(e),
                        (e.specifiers = t);
                    }
                    parseImport(e) {
                    ...
                    assertNoSpace() {
                      this.state.start > this.offsetToSourcePos(this.state.lastTokEndLoc.index) &&
                        this.raise(Et.UnexpectedSpace, this.state.lastTokEndLoc);
                    }
                  },
              },
              Nt = Object.keys(Ct),
              vt = class extends ft {
                checkProto(e, t, s, i) {
                  if (
                    ...
                    return s;
                  let r = e.key;
                  return '__proto__' === ('Identifier' === r.type ? r.name : r.value)
                    ? t
                      ? (this.raise(x.RecordNoProto, r), !0)
                      : (s &&
                          (i
                            ? null === i.doubleProtoLoc && (i.doubleProtoLoc = r.loc.start)
                            : this.raise(x.DuplicateProto, r)),
                        !0)
                    : s;
                }
                shouldExitDescending(e, t) {
                  return (
                    'ArrowFunctionExpression' === e.type && this.offsetToSourcePos(e.start) === t
                  );
                }
                getExpression() {
                  if ((this.enterInitialScopes(), this.nextToken(), this.match(140)))
                    throw this.raise(x.ParseExpressionEmptyInput, this.state.startLoc);
                  let e = this.parseExpression();
                  if (!this.match(140))
                    throw this.raise(x.ParseExpressionExpectsEOF, this.state.startLoc, {
                  ...
                  return (
                    ...
                    256 & this.optionFlags && (e.tokens = this.tokens),
                    e
                  );
                }
                parseExpression(e, t) {
                ...
                parseExpressionBase(e) {
                  ...
                  if (this.match(12)) {
                    ...
                    return (
                      this.toReferencedList(i.expressions), this.finishNode(i, 'SequenceExpression')
                    );
                  }
                  return s;
                }
                ...
                parseMaybeAssign(e, t) {
                  ...
                  if (r && this.prodParam.hasYield) {
                    this.next();
                    let e = this.parseYield(i);
                    return t && (e = t.call(this, e, i)), e;
                  }
                  e ? (s = !1) : ((e = new pt()), (s = !0));
                  let { type: a } = this.state;
                  (10 === a || z(a)) && (this.state.potentialArrowAt = this.state.start);
                  let n = this.parseMaybeConditional(e);
                  if ((t && (n = t.call(this, n, i)), (o = this.state.type) >= 29 && o <= 33)) {
                    let t = this.startNodeAt(i),
                      s = this.state.value;
                    if (((t.operator = s), this.match(29))) {
                      this.toAssignable(n, !0), (t.left = n);
                      let s = i.index;
                    ...
                    return (
                      ...
                      this.checkLVal(n, this.finishNode(t, 'AssignmentExpression')),
                      t
                    );
                  }
                  var o;
                  if ((s && this.checkExpressionErrors(e, !0), r)) {
                    let { type: e } = this.state;
                    if (
                      (this.hasPlugin('v8intrinsic') ? q(e) : q(e) && !this.match(54)) &&
                      !this.isAmbiguousPrefixOrIdentifier()
                    )
                      return (
                        this.raiseOverwrite(x.YieldNotInGeneratorFunction, i), this.parseYield(i)
                      );
                  }
                  return n;
                }
                ...
                parseExprOp(e, t, s) {
                  if (this.isPrivateName(e)) {
                    ...
                    (s >= G(58) || !this.prodParam.hasIn || !this.match(58)) &&
                      this.raise(x.PrivateInExpectedIn, e, { identifierName: t }),
                      this.classScope.usePrivateName(t, e.loc.start);
                  }
                  let i = this.state.type;
                  if ((r = i) >= 39 && r <= 59 && (this.prodParam.hasIn || !this.match(58))) {
                    let r = G(i);
                    if (r > s) {
                      if (39 === i) {
                        if (
                      ...
                      a.right = this.parseExprOpRightExpr(i, r);
                ...
                parseHackPipeBody() {
                  ...
                  return (
                    c.has(s.type) &&
                      !(null != (e = s.extra) && e.parenthesized) &&
                      this.raise(x.PipeUnparenthesizedBody, t, { type: s.type }),
                    this.topicReferenceWasUsedInCurrentContext() ||
                      this.raise(x.PipeTopicUnused, t),
                    s
                  );
                }
                checkExponentialAfterUnary(e) {
                  this.match(57) && this.raise(x.UnexpectedTokenUnaryExponentiation, e.argument);
                }
                parseMaybeUnary(e, t) {
                  let s = this.state.startLoc,
                  ...
                  if (((n = this.state.type), U[n])) {
                    ...
                    if (
                      ...
                      let e = a.argument;
                      'Identifier' === e.type
                        ? this.raise(x.StrictDelete, a)
                        : this.hasPropertyAsPrivateName(e) && this.raise(x.DeletePrivateField, a);
                    }
                    if (!r)
                      return (
                  ...
                  if (i) {
                    ...
                    if (
                      ...
                      return this.raiseOverwrite(x.AwaitNotInAsyncContext, s), this.parseAwait(s);
                  }
                  return o;
                }
                parseUpdate(e, t, s) {
                  ...
                  for (; W(this.state.type) && !this.canInsertSemicolon(); ) {
                ...
                parseSubscript(e, t, s, i) {
                  ...
                  if (!s && 15 === r) return this.parseBind(e, t, s, i);
                  if (Y(r)) return this.parseTaggedTemplateExpression(e, t, i);
                  let a = !1;
                  if (18 === r) {
                    if (
                      s &&
                      (this.raise(x.OptionalChainingNoNew, this.state.startLoc),
                      40 === this.lookaheadCharCode())
                    )
                      return this.stopParseSubscript(e, i);
                    (i.optionalChainMember = a = !0), this.next();
                  }
                  if (!s && this.match(10)) return this.parseCoverCallAndAsyncArrowHead(e, t, i, a);
                  {
                    let s = this.eat(0);
                    return s || a || this.eat(16)
                      ? this.parseMember(e, t, i, s, a)
                ...
                parseMember(e, t, s, i, r) {
                  ...
                  return (
                    ...
                    i
                      ...
                      : this.match(139)
                        ? ('Super' === e.type && this.raise(x.SuperPrivateField, t),
                          this.classScope.usePrivateName(this.state.value, this.state.startLoc),
                          (a.property = this.parsePrivateName()))
                        : (a.property = this.parseIdentifier(!0)),
                    s.optionalChainMember
                      ? ((a.optional = r), this.finishNode(a, 'OptionalMemberExpression'))
                ...
                parseBind(e, t, s, i) {
                  ...
                  return (
                    ...
                    (i.stop = !0),
                    this.parseSubscripts(this.finishNode(r, 'BindExpression'), t, s)
                  );
                }
                parseCoverCallAndAsyncArrowHead(e, t, s, i) {
                  ...
                  o && (this.expressionScope.enter(new nt(2)), (a = new pt())),
                    h && (n.optional = i),
                    (n.arguments = i
                      ? this.parseCallExpressionArguments(11)
                      : this.parseCallExpressionArguments(11, 'Super' !== e.type, n, a));
                  ...
                  return (
                    o && this.shouldParseAsyncArrow() && !i
                      ? ((s.stop = !0),
                        ...
                        (l = this.parseAsyncArrowFromCallExpression(this.startNodeAt(t), l)))
                      : (o && (this.checkExpressionErrors(a, !0), this.expressionScope.exit()),
                ...
                parseTaggedTemplateExpression(e, t, s) {
                  ...
                  return (
                    ...
                    s.optionalChainMember && this.raise(x.OptionalChainingNoTemplate, t),
                ...
                atPossibleAsyncArrow(e) {
                  return (
                    ...
                    e.end - e.start === 5 &&
                    this.offsetToSourcePos(e.start) === this.state.potentialArrowAt
                  );
                }
                finishCallExpression(e, t) {
                  if ('Import' === e.callee.type)
                    if (0 === e.arguments.length || e.arguments.length > 2)
                      this.raise(x.ImportCallArity, e);
                    else
                      for (let t of e.arguments)
                        'SpreadElement' === t.type && this.raise(x.ImportCallSpreadArgument, t);
                  return this.finishNode(e, t ? 'OptionalCallExpression' : 'CallExpression');
                }
                parseCallExpressionArguments(e, t, s, i) {
                  let r = [],
                    a = !0,
                  ...
                  for (this.state.inFSharpPipelineDirectBody = !1; !this.eat(e); ) {
                    ...
                    r.push(this.parseExprListItem(!1, i, t));
                  }
                ...
                parseAsyncArrowFromCallExpression(e, t) {
                  ...
                  return (
                    ...
                    this.parseArrowExpression(
                      ...
                      t.arguments,
                      !0,
                      null == (s = t.extra) ? void 0 : s.trailingCommaLoc
                    ),
                    t.innerComments && _e(e, t.innerComments),
                    t.callee.trailingComments && _e(e, t.callee.trailingComments),
                    e
                  );
                }
                parseNoCallExpr() {
                ...
                parseExprAtom(e) {
                  ...
                  switch (i) {
                    ...
                    case 83:
                      return (
                        ...
                        this.match(16)
                          ...
                          : this.match(10)
                            ? 512 & this.optionFlags
                              ? this.parseImportCall(t)
                              : this.finishNode(t, 'Import')
                            : (this.raise(x.UnsupportedImport, this.state.lastTokStartLoc),
                              this.finishNode(t, 'Import'))
                      );
                    case 78:
                      return (
                    ...
                    case 15: {
                      ...
                      throw this.raise(x.UnsupportedBind, e);
                    }
                    case 139:
                      return (
                        this.raise(x.PrivateInExpectedIn, this.state.startLoc, {
                    ...
                    default:
                      if (137 === i) return this.parseDecimalLiteral(this.state.value);
                      if (2 === i || 1 === i)
                ...
                parseTopicReferenceThenEqualsSign(e, t) {
                  ...
                  if (s)
                    return (
                      ...
                      this.state.pos--,
                      this.state.end--,
                      (this.state.endLoc = r(this.state.endLoc, -1)),
                  ...
                  if (this.testTopicReferenceConfiguration(s, t, i))
                    return 'hack' === s
                      ? (this.topicReferenceIsAllowedInCurrentContext() ||
                          this.raise(x.PipeTopicUnbound, t),
                        this.registerTopicReference(),
                        this.finishNode(e, 'TopicReference'))
                      : (this.topicReferenceIsAllowedInCurrentContext() ||
                          this.raise(x.PrimaryTopicNotAllowed, t),
                        this.registerTopicReference(),
                        this.finishNode(e, 'PipelinePrimaryTopicReference'));
                  throw this.raise(x.PipeTopicUnconfiguredToken, t, { token: X(i) });
                }
                testTopicReferenceConfiguration(e, t, s) {
                  switch (e) {
                    case 'hack':
                      return this.hasPlugin(['pipelineOperator', { topicToken: X(s) }]);
                    case 'smart':
                      return 27 === s;
                    default:
                      throw this.raise(x.PipeTopicRequiresHackPipes, t);
                  }
                }
                parseAsyncArrowUnaryFunction(e) {
                  this.prodParam.enter(Re(!0, this.prodParam.hasYield));
                  let t = [this.parseIdentifier()];
                  return (
                    this.prodParam.exit(),
                    this.hasPrecedingLineBreak() &&
                      this.raise(x.LineTerminatorBeforeArrow, this.state.curPosition()),
                    this.expect(19),
                ...
                parseSuper() {
                  ...
                  return (
                    this.next(),
                    !this.match(10) || this.scope.allowDirectSuper || 16 & this.optionFlags
                      ? !this.scope.allowSuper &&
                        !(16 & this.optionFlags) &&
                        this.raise(x.UnexpectedSuper, e)
                      : this.raise(x.SuperNotAllowed, e),
                    !this.match(10) &&
                      !this.match(0) &&
                      !this.match(16) &&
                      this.raise(x.UnsupportedSuper, e),
                    this.finishNode(e, 'Super')
                  );
                }
                parsePrivateName() {
                  let e = this.startNode(),
                    t = this.startNodeAt(r(this.state.startLoc, 1)),
                    s = this.state.value;
                  return (
                    this.next(),
                ...
                parseMetaProperty(e, t, s) {
                  ...
                  return (
                    ...
                    (e.property.name !== s || i) &&
                      this.raise(x.UnsupportedMetaProperty, e.property, {
                        target: t.name,
                  ...
                  }
                  {
                    ...
                    return (
                      this.isContextual(101) &&
                        (this.inModule || this.raise(x.ImportMetaOutsideModule, t),
                        (this.sawUnambiguousESM = !0)),
                ...
                parseParenAndDistinguishExpression(e) {
                  let t,
                    s = this.state.startLoc;
                  this.next(), this.expressionScope.enter(new nt(1));
                  ...
                  for (; !this.match(11); ) {
                    if (p) p = !1;
                      ...
                      (this.expect(
                        12,
                        null === l.optionalParametersLoc ? null : l.optionalParametersLoc
                      ),
                      this.match(11))
                    ) {
                    ...
                    if (this.match(21)) {
                      ...
                      if (
                        ...
                        h.push(this.parseParenItem(this.parseRestBinding(), e)),
                  ...
                  return e && this.shouldParseArrow(h) && (u = this.parseArrow(u))
                    ? (this.checkDestructuringPrivate(l),
                      this.expressionScope.validateAsPattern(),
                      this.expressionScope.exit(),
                      this.parseArrowExpression(u, h, !1),
                      u)
                    : (this.expressionScope.exit(),
                      h.length || this.unexpected(this.state.lastTokStartLoc),
                      n && this.unexpected(n),
                      a && this.unexpected(a),
                      this.checkExpressionErrors(l, !0),
                      this.toReferencedListDeep(h, !0),
                      h.length > 1
                        ? ((t = this.startNodeAt(o)),
                          (t.expressions = h),
                          this.finishNode(t, 'SequenceExpression'),
                          this.resetEndLocation(t, c))
                        : (t = h[0]),
                      this.wrapParenthesis(s, t));
                }
                wrapParenthesis(e, t) {
                ...
                parseNewOrNewTarget() {
                  ...
                  if ((this.next(), this.match(16))) {
                    ...
                    return this.scope.allowNewTarget || this.raise(x.UnexpectedNewTarget, s), s;
                  }
                ...
                parseNewCallee(e) {
                  ...
                  (e.callee = s),
                    t &&
                      ('Import' === s.type || 'ImportExpression' === s.type) &&
                      this.raise(x.ImportCallNotNewExpression, s);
                }
                parseTemplateElement(e) {
                  let { start: t, startLoc: s, end: i, value: a } = this.state,
                    n = t + 1,
                    o = this.startNodeAt(r(s, 1));
                  null === a &&
                    (e ||
                      this.raise(
                        x.InvalidEscapeSequenceTemplate,
                        r(this.state.firstInvalidTemplateEscapePos, 1)
                      ));
                  let h = this.match(24),
                    l = h ? -1 : -2,
                    p = i + l;
                  (o.value = {
                    ...
                    cooked: null === a ? null : a.slice(1, l),
                  }),
                    (o.tail = h),
                    this.next();
                  let c = this.finishNode(o, 'TemplateElement');
                  return this.resetEndLocation(c, r(this.state.lastTokEndLoc, l)), c;
                }
                parseTemplate(e) {
                  let t = this.startNode(),
                ...
                parseObjectLike(e, t, s, i) {
                  ...
                  for (o.properties = [], this.next(); !this.match(e); ) {
                    ...
                    let r;
                    t
                      ? (r = this.parseBindingProperty())
                      : ((r = this.parsePropertyDefinition(i)), (a = this.checkProto(r, s, a, i))),
                      s &&
                        !this.isObjectProperty(r) &&
                        'SpreadElement' !== r.type &&
                        this.raise(x.InvalidRecordProperty, r),
                  ...
                  return (
                    t ? (h = 'ObjectPattern') : s && (h = 'RecordExpression'), this.finishNode(o, h)
                  );
                }
                ...
                parsePropertyDefinition(e) {
                  ...
                  if (this.match(26))
                    for (
                      this.hasPlugin('decorators') &&
                      this.raise(x.UnsupportedPropertyDecorator, this.state.startLoc);
                      this.match(26);
                    )
                  ...
                  t.length && ((i.decorators = t), (t = [])),
                    (i.method = !1),
                    e && (s = this.state.startLoc);
                  let n = this.eat(55);
                  this.parsePropertyNamePrefixOperator(i);
                  let o = this.state.containsEsc;
                  if (
                    (this.parsePropertyName(i, e), !n && !o && this.maybeAsyncOrAccessorProp(i))
                  ) {
                    let { key: e } = i,
                      t = e.name;
                    'async' === t &&
                      ...
                      ('get' === t || 'set' === t) &&
                        ...
                        this.match(55) &&
                          ((n = !0),
                          this.raise(x.AccessorIsGenerator, this.state.curPosition(), { kind: t }),
                          this.next()),
                        this.parsePropertyName(i));
                  }
                  return this.parseObjPropValue(i, s, n, r, !1, a, e);
                }
                getGetterSetterExpectedParamCount(e) {
                ...
                checkGetterSetterParams(e) {
                  ...
                  i.length !== s &&
                    this.raise('get' === e.kind ? x.BadGetterArity : x.BadSetterArity, e),
                    'set' === e.kind &&
                      'RestElement' === (null == (t = i[i.length - 1]) ? void 0 : t.type) &&
                      this.raise(x.BadSetterRestParameter, e);
                }
                  ...
                  if (!e.computed && 'Identifier' === e.key.type) {
                    if ((this.checkReservedWord(e.key.name, e.key.loc.start, !0, !1), s))
                      ...
                      null != i
                        ...
                        : this.raise(x.InvalidCoverInitializedName, s),
                        (e.value = this.parseMaybeDefault(t, this.cloneIdentifier(e.key)));
                ...
                parseObjPropValue(e, t, s, i, r, a, n) {
                  let o =
                    this.parseObjectMethod(e, s, i, r, a) || this.parseObjectProperty(e, t, r, n);
                ...
                parsePropertyName(e, t) {
                  if (this.eat(0))
                    ...
                    let s,
                      { type: i, value: r } = this.state;
                    if (V(i)) s = this.parseIdentifier(!0);
                    else
                      switch (i) {
                        case 135:
                ...
                parseMethod(e, t, s, i, r, a, n = !1) {
                  this.initFunction(e, s),
                    (e.generator = t),
                    this.scope.enter(530 | (n ? 576 : 0) | (r ? 32 : 0)),
                    this.prodParam.enter(Re(s, e.generator)),
                ...
                parseArrayLike(e, t, s, i) {
                  ...
                  return (
                    this.next(),
                    (a.elements = this.parseExprList(e, !s, i, a)),
                    (this.state.inFSharpPipelineDirectBody = r),
                ...
                parseArrowExpression(e, t, s, i) {
                  ...
                  return (
                    t &&
                      ((this.state.maybeInArrowParameters = !0),
                      this.setArrowFunctionParameters(e, t, i)),
                    ...
                    (this.state.labels = []),
                      ...
                      (e.body = this.parseBlock(!0, !1, (r) => {
                        ...
                        r &&
                          a &&
                          this.raise(
                            x.IllegalLanguageModeDirective,
                            ('method' !== e.kind && 'constructor' !== e.kind) || !e.key
                              ? e
                              : e.key.loc.end
                          );
                        let n = !i && this.state.strict;
                ...
                checkParams(e, t, s, i = !0) {
                  ...
                  for (let t of e.params) this.checkLVal(t, a, 5, r, i);
                }
                ...
                parseExprListItem(e, t, s) {
                  ...
                  if (this.match(12))
                    e ||
                      this.raise(x.UnexpectedToken, this.state.curPosition(), { unexpected: ',' }),
                      (i = null);
                    ...
                    this.expectPlugin('partialApplication'),
                      s || this.raise(x.UnexpectedArgumentPlaceholder, this.state.startLoc);
                    let e = this.startNode();
                ...
                createIdentifierAt(e, t, s) {
                  return (
                    (e.name = t), (e.loc.identifierName = t), this.finishNodeAt(e, 'Identifier', s)
                  );
                }
                parseIdentifierName(e) {
                  let t,
                    { startLoc: s, type: i } = this.state;
                  V(i) ? (t = this.state.value) : this.unexpected();
                  let r = i <= 92;
                  return (
                    e ? r && this.replaceToken(132) : this.checkReservedWord(t, s, r, !1),
                    this.next(),
                    t
                  );
                }
                checkReservedWord(e, t, s, i) {
                  ...
                  if (!(e.length > 10) && ((r = e), fe.has(r)))
                    if (
                      ...
                      this.raise(x.UnexpectedKeyword, t, { keyword: e });
                    else if ((this.state.strict ? (i ? me : ue) : ce)(e, this.inModule))
                      this.raise(x.UnexpectedReservedWord, t, { reservedWord: e });
                    else if ('yield' === e) {
                      if (this.prodParam.hasYield)
                        return void this.raise(x.YieldBindingIdentifier, t);
                    } else if ('await' === e) {
                      if (this.prodParam.hasAwait)
                        return void this.raise(x.AwaitBindingIdentifier, t);
                      if (this.scope.inStaticBlock)
                        return void this.raise(x.AwaitBindingIdentifierInStaticBlock, t);
                      this.expressionScope.recordAsyncArrowParametersError(t);
                    } else if ('arguments' === e && this.scope.inClassAndNotInNonArrowFunction)
                      return void this.raise(x.ArgumentsInClass, t);
                }
                ...
                parseAwait(e) {
                  ...
                  return (
                    this.expressionScope.recordParameterInitializerError(
                      x.AwaitExpressionFormalParameter,
                      t
                    ),
                    this.eat(55) && this.raise(x.ObsoleteAwaitStar, t),
                ...
                parseYield(e) {
                  let t = this.startNodeAt(e);
                  this.expressionScope.recordParameterInitializerError(x.YieldInParameter, t);
                  let s = !1,
                    i = null;
                ...
                parseImportCall(e) {
                  if (
                    ...
                    if (this.match(11)) this.addTrailingCommaExtraToNode(e.source);
                      ...
                      this.eat(12) &&
                        (this.addTrailingCommaExtraToNode(e.options), !this.match(11)))
                    ) {
                      do {
                ...
                checkPipelineAtInfixOperator(e, t) {
                  this.hasPlugin(['pipelineOperator', { proposal: 'smart' }]) &&
                    ...
                    this.raise(x.PipelineHeadSequenceExpression, t);
                }
                ...
                checkSmartPipeTopicBodyEarlyErrors(e) {
                  if (this.match(19)) throw this.raise(x.PipelineBodyNoArrow, this.state.startLoc);
                  this.topicReferenceWasUsedInCurrentContext() ||
                    this.raise(x.PipelineTopicUnused, e);
                }
              ...
              Ot = class extends vt {
                parseTopLevel(e, t) {
                  return (
                    ...
                    256 & this.optionFlags &&
                      (e.tokens = (function (e, t, s) {
                        for (let i = 0; i < e.length; i++) {
                          let a = e[i],
                            { type: n } = a;
                          if ('number' == typeof n) {
                            if (139 === n) {
                              let { loc: t, start: s, value: n, end: o } = a,
                                h = s + 1,
                                l = r(t.start, 1);
                              e.splice(
                                i,
                ...
                parseProgram(e, t = 140, s = this.options.sourceType) {
                  if (
                    ((e.sourceType = s),
                    ...
                    if (!(64 & this.optionFlags) && this.scope.undefinedExports.size > 0)
                      for (let [e, t] of Array.from(this.scope.undefinedExports))
                        this.raise(x.ModuleExportUndefined, t, { localName: e });
                  ...
                  return (
                    (i =
                      140 === t
                        ...
                        : this.finishNodeAt(e, 'Program', r(this.state.startLoc, -1))),
                    i
                  );
                }
                stmtToDirective(e) {
                ...
                chStartsBindingIdentifier(e, t) {
                  if (ne(e)) {
                    if (((Dt.lastIndex = t), Dt.test(this.input))) {
                      let e = this.codePointAtPos(Dt.lastIndex);
                      if (!oe(e) && 92 !== e) return !1;
                    }
                    return !0;
                  }
                  return 92 === e;
                  ...
                  switch (s) {
                        ...
                        a ||
                          this.raise(
                            this.state.strict
                              ? x.StrictFunction
                              : this.options.annexB
                                ? x.SloppyFunctionAnnexB
                                : x.SloppyFunction,
                            this.state.startLoc
                          ),
                        this.parseFunctionStatement(i, !1, !r && a)
                      );
                    case 80:
                      return (
                        r || this.unexpected(), this.parseClass(this.maybeTakeDecorators(t, i), !0)
                      );
                    case 69:
                          ...
                          this.allowsUsing()
                            ? r
                              ? this.recordAwaitIfAllowed() ||
                                this.raise(x.AwaitUsingNotInAsyncContext, i)
                              : this.raise(x.UnexpectedLexicalDeclaration, i)
                            : this.raise(x.UnexpectedUsingDeclaration, i),
                          this.next(),
                    ...
                    case 107:
                      ...
                      return (
                        ...
                        this.allowsUsing()
                          ? r || this.raise(x.UnexpectedLexicalDeclaration, this.state.startLoc)
                          : this.raise(x.UnexpectedUsingDeclaration, this.state.startLoc),
                    ...
                    case 82: {
                      ...
                      return (
                        !(8 & this.optionFlags) &&
                          !n &&
                          this.raise(x.UnexpectedImportExport, this.state.startLoc),
                        this.next(),
                        (e = 83 === s ? this.parseImport(i) : this.parseExport(i, t)),
                    ...
                    default:
                      if (this.isAsyncFunction())
                        return (
                          r ||
                            this.raise(
                              x.AsyncFunctionInSingleStatementContext,
                              this.state.startLoc
                            ),
                          this.next(),
                          this.parseFunctionStatement(i, !0, !r && a)
                        );
                  }
                  let o = this.state.value,
                    h = this.parseExpression();
                  return z(s) && 'Identifier' === h.type && this.eat(14)
                    ? this.parseLabeledStatement(i, o, h, e)
                    : this.parseExpressionStatement(i, h, t);
                }
                assertModuleNodeAllowed(e) {
                  !(8 & this.optionFlags) && !this.inModule && this.raise(x.ImportOutsideModule, e);
                }
                ...
                maybeTakeDecorators(e, t, s) {
                  ...
                  return (
                    e &&
                      (null != (i = t.decorators) && i.length
                        ? ('boolean' !=
                            typeof this.getPluginOption('decorators', 'decoratorsBeforeExport') &&
                            this.raise(x.DecoratorsBeforeAfterExport, t.decorators[0]),
                  ...
                  if (this.match(82))
                    e || this.unexpected(),
                      this.decoratorsEnabledBeforeExport() ||
                        this.raise(x.DecoratorExportClass, this.state.startLoc);
                  ...
                  if ((this.next(), this.hasPlugin('decorators'))) {
                    ...
                    if (this.match(10)) {
                      ...
                      this.next(),
                        ...
                        this.expect(11),
                        (t = this.wrapParenthesis(s, t));
                      let i = this.state.startLoc;
                      (e.expression = this.parseMaybeDecoratorArguments(t, s)),
                        !1 === this.getPluginOption('decorators', 'allowCallParenthesized') &&
                          e.expression !== t &&
                          this.raise(x.DecoratorArgumentsOutsideParentheses, i);
                    } else {
                      for (t = this.parseIdentifier(!1); this.eat(16); ) {
                        ...
                        (e.object = t),
                          this.match(139)
                            ...
                            : (e.property = this.parseIdentifier(!0)),
                          (e.computed = !1),
                          (t = this.finishNode(e, 'MemberExpression'));
                      }
                      e.expression = this.parseMaybeDecoratorArguments(t, s);
                    }
                ...
                verifyBreakContinue(e, t) {
                  ...
                  if (s === this.state.labels.length) {
                    ...
                    this.raise(x.IllegalBreakContinue, e, { type: s });
                  }
                }
                ...
                parseForStatement(e) {
                  ...
                  let s = this.isContextual(100);
                  {
                    let i = this.isAwaitUsing(),
                      r = i || this.isForUsing(),
                      a = (s && this.hasFollowingBindingAtom()) || r;
                    if (this.match(74) || this.match(75) || a) {
                      ...
                      i
                        ? ((s = 'await using'),
                          this.recordAwaitIfAllowed() ||
                            this.raise(x.AwaitUsingNotInAsyncContext, this.state.startLoc),
                          this.next())
                        : (s = this.state.value),
                        this.next(),
                        this.parseVar(a, !0, s);
                      let n = this.finishNode(a, 'VariableDeclaration'),
                        o = this.match(58);
                      return (
                        o && r && this.raise(x.ForInUsing, n),
                        (o || this.isContextual(102)) && 1 === n.declarations.length
                          ? this.parseForIn(e, n, t)
                          : (null !== t && this.unexpected(t), this.parseFor(e, n))
                      );
                    }
                  }
                  ...
                  if (
                    (n &&
                      (s && this.raise(x.ForOfLet, a),
                      null === t && i && 'Identifier' === a.type && this.raise(x.ForOfAsync, a)),
                    n || this.match(58))
                  ) {
                    this.checkDestructuringPrivate(r), this.toAssignable(a, !0);
                    let s = n ? 'ForOfStatement' : 'ForInStatement';
                    return this.checkLVal(a, { type: s }), this.parseForIn(e, a, t);
                  }
                  return (
                ...
                parseReturnStatement(e) {
                  return (
                    this.prodParam.hasReturn || this.raise(x.IllegalReturn, this.state.startLoc),
                    this.next(),
                    this.isLineTerminator()
                      ? (e.argument = null)
                ...
                parseSwitchStatement(e) {
                  ...
                  let t,
                    s = (e.cases = []);
                  this.expect(5), this.state.labels.push(Lt), this.scope.enter(256);
                  for (let e; !this.match(8); )
                    if (this.match(61) || this.match(65)) {
                      let i = this.match(61);
                      t && this.finishNode(t, 'SwitchCase'),
                        s.push((t = this.startNode())),
                        (t.consequent = []),
                        this.next(),
                        i
                          ? (t.test = this.parseExpression())
                          : (e &&
                              this.raise(x.MultipleDefaultsInSwitch, this.state.lastTokStartLoc),
                            (e = !0),
                            (t.test = null)),
                        this.expect(14);
                ...
                parseThrowStatement(e) {
                  return (
                    this.next(),
                    this.hasPrecedingLineBreak() &&
                      this.raise(x.NewlineAfterThrow, this.state.lastTokEndLoc),
                ...
                parseTryStatement(e) {
                  if (
                    (this.next(), (e.block = this.parseBlock()), (e.handler = null), this.match(62))
                  ) {
                    let t = this.startNode();
                    this.next(),
                      this.match(10)
                  ...
                  return (
                    ...
                    !e.handler && !e.finalizer && this.raise(x.NoCatchOrFinally, e),
                ...
                parseWithStatement(e) {
                  return (
                    this.state.strict && this.raise(x.StrictWith, this.state.startLoc),
                    this.next(),
                ...
                parseLabeledStatement(e, t, s, i) {
                  for (let e of this.state.labels)
                    e.name === t && this.raise(x.LabelRedeclaration, s, { labelName: t });
                  let r = (a = this.state.type) >= 90 && a <= 92 ? 1 : this.match(71) ? 2 : null;
                  var a;
                  for (let t = this.state.labels.length - 1; t >= 0; t--) {
                    let s = this.state.labels[t];
                    if (s.statementStart !== e.start) break;
                    (s.statementStart = this.sourceToOffsetPos(this.state.start)), (s.kind = r);
                  }
                  return (
                ...
                parseBlockBody(e, t, s, i, r) {
                  let a = (e.body = []),
                    n = (e.directives = []);
                  this.parseBlockOrModuleBlockBody(a, t ? n : void 0, s, i, r);
                }
                parseBlockOrModuleBlockBody(e, t, s, i, r) {
                  ...
                  for (; !this.match(i); ) {
                    ...
                    if (t && !o) {
                      if (this.isValidDirective(i)) {
                        ...
                        t.push(e),
                          !n && 'use strict' === e.value.value && ((n = !0), this.setStrict(!0));
                        continue;
                      }
                  ...
                  null == r || r.call(this, n), a || this.setStrict(!1), this.next();
                }
                parseFor(e, t) {
                  return (
                    (e.init = t),
                ...
                parseForIn(e, t, s) {
                  ...
                  return (
                    ...
                    'VariableDeclaration' === t.type &&
                      ...
                      this.raise(x.ForInOfLoopInitializer, t, {
                        type: i ? 'ForInStatement' : 'ForOfStatement',
                      }),
                    'AssignmentPattern' === t.type &&
                      this.raise(x.InvalidLhs, t, { ancestor: { type: 'ForStatement' } }),
                    (e.left = t),
                      ...
                      null === e.init &&
                        ...
                        (t && (this.match(58) || this.isContextual(102)))
                          ? ('const' === s || 'using' === s || 'await using' === s) &&
                            ...
                            this.raise(x.DeclarationMissingInitializer, this.state.lastTokEndLoc, {
                              kind: s,
                            })
                          : this.raise(x.DeclarationMissingInitializer, this.state.lastTokEndLoc, {
                              kind: 'destructuring',
                ...
                parseVarId(e, t) {
                  ...
                  ('using' === t || 'await using' === t) &&
                    ...
                    this.raise(x.UsingDeclarationHasBindingPattern, s.loc.start),
                    this.checkLVal(s, { type: 'VariableDeclarator' }, 'var' === t ? 5 : 8201),
                    (e.id = s);
                }
                ...
                parseFunction(e, t = 0) {
                  ...
                  this.initFunction(e, a),
                    this.match(55) &&
                      (s && this.raise(x.GeneratorInSingleStatementContext, this.state.startLoc),
                      this.next(),
                      (e.generator = !0)),
                    i && (e.id = this.parseFunctionId(r));
                  let n = this.state.maybeInArrowParameters;
                  return (
                    (this.state.maybeInArrowParameters = !1),
                    this.scope.enter(514),
                    this.prodParam.enter(Re(a, e.generator)),
                ...
                parseFunctionParams(e, t) {
                  this.expect(10),
                    this.expressionScope.enter(new at(3)),
                  ...
                  if (
                    ...
                    this.withSmartMixTopicForbiddingContext(() => {
                      for (; !this.match(8); ) {
                        ...
                        let e = this.startNode();
                        i.length &&
                          ((e.decorators = i), this.resetStartLocationFromNode(e, i[0]), (i = [])),
                          this.parseClassMember(r, e, s),
                          'constructor' === e.kind &&
                            e.decorators &&
                            e.decorators.length > 0 &&
                            this.raise(x.DecoratorConstructor, e);
                      }
                    }),
                    (this.state.strict = t),
                    this.next(),
                ...
                parseClassMemberWithIsStatic(e, t, s, i) {
                    ...
                    return (
                      ...
                      t
                        ...
                        : (this.isNonstaticConstructor(r) &&
                            this.raise(x.ConstructorIsGenerator, r.key),
                          void this.pushClassMethod(e, r, !0, !1, !1, !1))
                    );
                  }
                  let c = !this.state.containsEsc && z(this.state.type),
                    u = this.parseClassElementName(t),
                    d = c ? u.name : null,
                    m = this.isPrivateName(u),
                  ...
                  if ((this.parsePostMemberNameModifiers(p), this.isClassMethod())) {
                    ...
                    let i = this.isNonstaticConstructor(r),
                      n = !1;
                    i &&
                      ((r.kind = 'constructor'),
                      s.hadConstructor &&
                        !this.hasPlugin('typescript') &&
                        this.raise(x.DuplicateConstructor, u),
                      i &&
                        this.hasPlugin('typescript') &&
                        t.override &&
                        this.raise(x.OverrideOnConstructor, u),
                      (s.hadConstructor = !0),
                      (n = s.hadSuperClass)),
                      this.pushClassMethod(e, r, !1, !1, i, n);
                  } else if (this.isClassProperty())
                    m ? this.pushClassPrivateProperty(e, o) : this.pushClassProperty(e, n);
                  else if ('async' !== d || this.isLineTerminator())
                    if (('get' !== d && 'set' !== d) || (this.match(55) && this.isLineTerminator()))
                      if ('accessor' !== d || this.isLineTerminator())
                        this.isLineTerminator()
                          ? m
                      ...
                      this.resetPreviousNodeTrailingComments(u), (l.kind = d);
                      let t = this.match(139);
                      this.parseClassElementName(r),
                        t
                          ? this.pushClassPrivateMethod(e, a, !1, !1)
                          : (this.isNonstaticConstructor(r) &&
                              this.raise(x.ConstructorIsAccessor, r.key),
                    ...
                    this.parseClassElementName(l),
                      ...
                      s
                        ...
                        : (this.isNonstaticConstructor(r) &&
                            this.raise(x.ConstructorIsAsync, r.key),
                          this.pushClassMethod(e, r, t, !0, !1, !1));
                  }
                }
                parseClassElementName(e) {
                  ...
                  if (
                    ((132 === t || 134 === t) &&
                      e.static &&
                      'prototype' === s &&
                      this.raise(x.StaticPrototype, this.state.startLoc),
                    139 === t)
                  ) {
                    'constructor' === s &&
                      this.raise(x.ConstructorClassPrivateField, this.state.startLoc);
                ...
                parseClassStaticBlock(e, t) {
                  ...
                  this.parseBlockOrModuleBlockBody(r, void 0, !1, 8),
                    ...
                    null != (s = t.decorators) && s.length && this.raise(x.DecoratorStaticBlock, t);
                }
                pushClassProperty(e, t) {
                  !t.computed &&
                    this.nameIsConstructor(t.key) &&
                    this.raise(x.ConstructorClassField, t.key),
                ...
                pushClassMethod(e, t, s, i, r, a) {
                  e.body.push(this.parseMethod(t, s, i, r, a, 'ClassMethod', !0));
                }
                pushClassPrivateMethod(e, t, s, i) {
                    ...
                    'get' === r.kind
                      ...
                      : 'set' === r.kind
                        ? r.static
                          ...
                          : 1
                        : 0;
                  this.declareClassPrivateMethodInScope(r, a);
                }
                declareClassPrivateMethodInScope(e, t) {
                  this.classScope.declarePrivateName(
                ...
                parseClassProperty(e) {
                  return (
                    this.parseInitializer(e), this.semicolon(), this.finishNode(e, 'ClassProperty')
                  );
                }
                parseClassAccessorProperty(e) {
                  return (
                ...
                parseClassId(e, t, s, i = 8331) {
                  if (z(this.state.type))
                    ...
                    if (!s && t) throw this.raise(x.MissingClassName, this.state.startLoc);
                    e.id = null;
                  }
                }
                parseClassSuper(e) {
                ...
                parseExport(e, t) {
                  let s = this.parseMaybeImportPhase(e, !0),
                    i = this.maybeParseExportDefaultSpecifier(e, s),
                    r = !i || this.eat(12),
                    a = r && this.eatExportStar(e),
                    n = a && this.maybeParseExportNamespaceSpecifier(e),
                    o = r && (!n || this.eat(12)),
                    h = i || a;
                  if (a && !n) {
                    if ((i && this.unexpected(), t))
                      throw this.raise(x.UnsupportedDecoratorExport, e);
                    return (
                  ...
                  if (
                    (i && r && !a && !p && this.unexpected(null, 5),
                    n && o && this.unexpected(null, 98),
                    h || p)
                  ) {
                    if (((l = !1), t)) throw this.raise(x.UnsupportedDecoratorExport, e);
                  ...
                  if (h || p || l) {
                    ...
                    let s = e;
                    if (
                      (this.checkExport(s, !0, !1, !!s.source),
                      'ClassDeclaration' === (null == (c = s.declaration) ? void 0 : c.type))
                    )
                      this.maybeTakeDecorators(t, s.declaration, s);
                    else if (t) throw this.raise(x.UnsupportedDecoratorExport, e);
                    return (
                      (this.sawUnambiguousESM = !0), this.finishNode(s, 'ExportNamedDeclaration')
                    );
                  }
                  if (this.eat(65)) {
                    let s = e,
                      i = this.parseExportDefaultExpression();
                    if (((s.declaration = i), 'ClassDeclaration' === i.type))
                      this.maybeTakeDecorators(t, i, s);
                    else if (t) throw this.raise(x.UnsupportedDecoratorExport, e);
                    return (
                      this.checkExport(s, !0, !0),
                      (this.sawUnambiguousESM = !0),
                ...
                maybeParseExportNamespaceSpecifier(e) {
                  if (this.isContextual(93)) {
                    ...
                    return (
                      ...
                      e.specifiers.push(this.finishNode(s, 'ExportNamespaceSpecifier')),
                      !0
                    );
                  }
                  return !1;
                ...
                maybeParseExportNamedSpecifiers(e) {
                  if (this.match(5)) {
                    ...
                    let s = 'type' === t.exportKind;
                    return (
                      t.specifiers.push(...this.parseExportSpecifiers(s)),
                      (t.source = null),
                ...
                maybeParseExportDeclaration(e) {
                  return (
                    ...
                    ((e.specifiers = []),
                    (e.source = null),
                    this.hasPlugin('importAssertions') ? (e.assertions = []) : (e.attributes = []),
                  ...
                  if (this.match(26))
                    return (
                      this.hasPlugin('decorators') &&
                        ...
                        this.raise(x.DecoratorBeforeExport, this.state.startLoc),
                      this.parseClass(
                ...
                isExportDefaultSpecifier() {
                  ...
                  if (z(e)) {
                    ...
                    if ((130 === e || 129 === e) && !this.state.containsEsc) {
                      ...
                      if (
                        123 === t ||
                        (this.chStartsBindingIdentifier(t, e) && !this.input.startsWith('from', e))
                      )
                  ...
                  if (44 === this.input.charCodeAt(t) || (z(this.state.type) && s)) return !0;
                  if (this.match(65) && s) {
                ...
                shouldParseExportDeclaration() {
                  ...
                  if (this.hasPlugin('explicitResourceManagement')) {
                    if (this.isUsing())
                      return this.raise(x.UsingDeclarationExport, this.state.startLoc), !0;
                    if (this.isAwaitUsing())
                      return this.raise(x.UsingDeclarationExport, this.state.startLoc), !0;
                  }
                  return (
                    ...
                    if (s) {
                      if (
                        ...
                        'Identifier' === t.type &&
                          ...
                          this.raise(x.ExportDefaultFromAsIdentifier, t);
                      }
                    } else if (null != (r = e.specifiers) && r.length)
                      for (let t of e.specifiers) {
                        ...
                        if ((this.checkDuplicateExports(t, s), !i && t.local)) {
                          let { local: e } = t;
                          'Identifier' !== e.type
                            ? this.raise(x.ExportBindingIsString, t, {
                                localName: e.value,
                                exportName: s,
                              })
                ...
                checkDuplicateExports(e, t) {
                  this.exportedIdentifiers.has(t) &&
                    ('default' === t
                      ? this.raise(x.DuplicateDefaultExport, e)
                      : this.raise(x.DuplicateExport, e, { exportName: t })),
                ...
                parseExportSpecifiers(e) {
                  ...
                  for (this.expect(5); !this.eat(8); ) {
                    ...
                    (a.local = this.parseModuleExportName()),
                      t.push(this.parseExportSpecifier(a, r, e, i));
                  }
                  return t;
                }
                parseExportSpecifier(e, t, s, i) {
                ...
                parseModuleExportName() {
                  if (this.match(134)) {
                    ...
                    return (
                      t &&
                        this.raise(x.ModuleExportNameHasLoneSurrogate, e, {
                ...
                isJSONModuleImport(e) {
                  return (
                    ...
                    e.assertions.some(
                      ({ key: e, value: t }) =>
                        'json' === t.value &&
                        ('Identifier' === e.type ? 'type' === e.name : 'type' === e.value)
                    )
                  );
                }
                checkImportReflection(e) {
                  ...
                  if ('source' === e.phase)
                    'ImportDefaultSpecifier' !== s &&
                      this.raise(x.SourcePhaseImportRequiresDefault, t[0].loc.start);
                  else if ('defer' === e.phase)
                    'ImportNamespaceSpecifier' !== s &&
                      this.raise(x.DeferImportRequiresNamespace, t[0].loc.start);
                  else if (e.module) {
                    var i;
                    'ImportDefaultSpecifier' !== s &&
                      this.raise(x.ImportReflectionNotBinding, t[0].loc.start),
                      (null == (i = e.assertions) ? void 0 : i.length) > 0 &&
                        this.raise(x.ImportReflectionHasAssertion, t[0].loc.start);
                  }
                }
                checkJSONModuleImport(e) {
                  if (this.isJSONModuleImport(e) && 'ExportAllDeclaration' !== e.type) {
                    ...
                    if (null != t) {
                      ...
                      void 0 !== e && this.raise(x.ImportJSONBindingNotDefault, e.loc.start);
                    }
                  }
                }
                isPotentialImportPhase(e) {
                ...
                applyImportPhase(e, t, s, i) {
                  t ||
                    ('module' === s
                      ? (this.expectPlugin('importReflection', i), (e.module = !0))
                      : this.hasPlugin('importReflection') && (e.module = !1),
                    'source' === s
                      ? (this.expectPlugin('sourcePhaseImports', i), (e.phase = 'source'))
                      : 'defer' === s
                        ? (this.expectPlugin('deferredImportEvaluation', i), (e.phase = 'defer'))
                ...
                parseMaybeImportPhase(e, t) {
                  ...
                  let s = this.startNode(),
                    ...
                    { type: r } = this.state;
                  return (V(r) ? 98 !== r || 102 === this.lookaheadCharCode() : 12 !== r)
                    ? (this.applyImportPhase(e, t, i, s.loc.start), null)
                    : (this.applyImportPhase(e, t, null), this.createIdentifier(s, i));
                }
                isPrecedingIdImportPhase(e) {
                  let { type: t } = this.state;
                  return z(t) ? 98 !== t || 102 === this.lookaheadCharCode() : 12 !== t;
                }
                parseImport(e) {
                  return this.match(134)
                    ? this.parseImportSourceAndAttributes(e)
                    : this.parseImportSpecifiersAndAfter(e, this.parseMaybeImportPhase(e, !1));
                }
                parseImportSpecifiersAndAfter(e, t) {
                  e.specifiers = [];
                  let s = !this.maybeParseDefaultImportSpecifier(e, t) || this.eat(12),
                ...
                parseImportSourceAndAttributes(e) {
                  return (
                    null != e.specifiers || (e.specifiers = []),
                    (e.source = this.parseImportSource()),
                    this.maybeParseImportAttributes(e),
                ...
                parseImportAttributes() {
                  ...
                  do {
                    ...
                    if (
                      (t.has(i) &&
                        this.raise(x.ModuleAttributesWithDuplicateKeys, this.state.startLoc, {
                          key: i,
                        }),
                      t.add(i),
                      this.match(134)
                ...
                parseModuleAttributes() {
                  ...
                  do {
                    ...
                    if (
                      ((s.key = this.parseIdentifier(!0)),
                      'type' !== s.key.name &&
                        this.raise(x.ModuleAttributeDifferentFromType, s.key),
                      t.has(s.key.name) &&
                        this.raise(x.ModuleAttributesWithDuplicateKeys, s.key, { key: s.key.name }),
                      t.add(s.key.name),
                      this.expect(14),
                      !this.match(134))
                    )
                  ...
                  if (this.match(76)) {
                    ...
                    this.next(),
                      this.hasPlugin('moduleAttributes')
                        ? ((t = this.parseModuleAttributes()),
                          this.addExtra(e, 'deprecatedWithLegacySyntax', !0))
                    ...
                    this.isContextual(94) && !this.hasPrecedingLineBreak()
                      ? (!this.hasPlugin('deprecatedImportAssert') &&
                          !this.hasPlugin('importAssertions') &&
                          this.raise(x.ImportAttributesUseAssert, this.state.startLoc),
                        this.hasPlugin('importAssertions') ||
                ...
                maybeParseDefaultImportSpecifier(e, t) {
                  if (t) {
                    ...
                    return (
                      (s.local = t),
                      e.specifiers.push(this.finishImportSpecifier(s, 'ImportDefaultSpecifier')),
                      !0
                    );
                  }
                  return (
                    !!V(this.state.type) &&
                    (this.parseImportSpecifierLocal(e, this.startNode(), 'ImportDefaultSpecifier'),
                    !0)
                  );
                }
                ...
                parseImportSpecifier(e, t, s, i, r) {
                  if (this.eatContextual(93)) e.local = this.parseIdentifier();
                    ...
                    let { imported: s } = e;
                    if (t) throw this.raise(x.ImportBindingIsString, e, { importName: s.value });
                ...
                constructor(e, t, s) {
                  (e = (function (e) {
                    ...
                    if (1 === t.startLine)
                      ...
                      (null == e.startColumn || null == e.startIndex) &&
                      null != e.startIndex
                    )
                      throw new Error(
                  ...
                  let i = 0;
                  e.allowAwaitOutsideFunction && (i |= 1),
                    e.allowReturnOutsideFunction && (i |= 2),
                    e.allowImportExportEverywhere && (i |= 8),
                    e.allowSuperOutsideMethod && (i |= 16),
                    e.allowUndeclaredExports && (i |= 64),
                    e.allowNewTargetOutsideFunction && (i |= 4),
                    e.allowYieldOutsideFunction && (i |= 32),
                    e.ranges && (i |= 128),
                    e.tokens && (i |= 256),
                    e.createImportExpressions && (i |= 512),
                    e.createParenthesizedExpressions && (i |= 1024),
                    e.errorRecovery && (i |= 2048),
                    e.attachComment && (i |= 4096),
                    e.annexB && (i |= 8192),
                    (this.optionFlags = i);
                }
                getScopeHandler() {
            ...
            function Rt(e, t) {
              ...
              if (null != e && e.plugins) {
                for (let t of e.plugins) {
                  let e, s;
                  'string' == typeof t ? (e = t) : ([e, s] = t), i.has(e) || i.set(e, s || {});
                }
                (function (e) {
                  if (e.has('decorators')) {
                  ...
                  if (e.has('pipelineOperator')) {
                    ...
                    if ('hack' === i) {
                      ...
                      if (
                        '#' === t &&
                        'hash' === (null == (s = e.get('recordAndTuple')) ? void 0 : s.syntaxType)
                      )
                        throw new Error(
                          `Plugin conflict between \`["pipelineOperator", { proposal: "hack", topicToken: "#" }]\` and \`${JSON.stringify(['recordAndTuple', e.get('recordAndTuple')])}\`.`
                        );
                    } else if (
                      'smart' === i &&
                      'hash' === (null == (t = e.get('recordAndTuple')) ? void 0 : t.syntaxType)
                    )
                      throw new Error(
                        `Plugin conflict between \`["pipelineOperator", { proposal: "smart" }]\` and \`${JSON.stringify(['recordAndTuple', e.get('recordAndTuple')])}\`.`
                      );
                  }
                  if (e.has('moduleAttributes')) {
                    ...
                    if ('may-2020' !== e.get('moduleAttributes').version)
                      throw new Error(
                  ...
                  (s = (function (e) {
                    let t = [];
                    for (let s of Nt) e.has(s) && t.push(s);
                    let s = t.join('|'),
                      i = Ut.get(s);
                    if (!i) {
                      i = Ft;
                      for (let e of t) i = Ct[e](i);
                      Ut.set(s, i);
                    }
                    return i;
                  })(i));
          ...
          () => (r || i((r = { exports: {} }).exports), r.exports)),
        m = {};
      c(m, { parsers: () => Oe });
      var f = {};
      c(f, {
        ...
        __js_expression: () => ge,
        __ts_expression: () => Te,
        __vue_event_binding: () => xe,
        __vue_expression: () => ge,
        __vue_ts_event_binding: () => Pe,
        __vue_ts_expression: () => Te,
        babel: () => xe,
        'babel-flow': () => be,
        'babel-ts': () => Pe,
      });
      ...
      function w(e) {
        var t, s, i;
        let r = (null == (t = e.range) ? void 0 : t[0]) ?? e.start,
          a =
            null == (i = (null == (s = e.declaration) ? void 0 : s.decorators) ?? e.decorators)
              ? void 0
              : i[0];
        return a ? Math.min(w(a), r) : r;
      }
      function I(e) {
        var t;
      ...
      var C = function (e) {
        ...
        N = C(['Block', 'CommentBlock', 'MultiLine']),
        v = C([
          'Line',
          'CommentLine',
          'SingleLine',
        ...
        L = function (e) {
          return (
            k.has(e) ||
              k.set(e, N(e) && '*' === e.value[0] && /@(?:type|satisfies)\b/u.test(e.value)),
            k.get(e)
          );
        },
        M = new WeakMap(),
        ...
        O = null;
      function F(e) {
        if (null !== O && (O.property, 1)) {
          let e = O;
          return (O = F.prototype = null), e;
        }
        return (O = F.prototype = e ?? Object.create(null)), new F();
      }
      for (let e = 0; e <= 10; e++) F();
      var B = (function (e, t = 'type') {
        ...
        R = function e(t, s) {
          ...
          let i = B(t);
          for (let r = 0; r < i.length; r++) t[i[r]] = e(t[i[r]], s);
          return s(t) || t;
        };
      function U(e) {
        if ('TSTypeParameter' === e.type && 'string' == typeof e.name) {
          let t = w(e);
            ...
            for (let s = e.length - 1; s >= 0; s--) {
              ...
              if (
                (t &&
                  ...
                  D(i) &&
                  D(t) &&
                  (e.splice(s + 1, 1), (i.value += '*//*' + t.value), (i.range = [w(i), I(t)])),
                !v(i) && !N(i))
              )
                throw new TypeError(`Unknown comment type: "${i.type}".`);
              t = i;
            }
          })(a);
          let o =
            ...
            (e = R(e, (t) => {
              switch (t.type) {
                case 'ParenthesizedExpression': {
                  let { expression: e } = t,
                    i = w(t);
                  if ('TypeCastExpression' === e.type) return (e.range = [i, I(t)]), e;
                  let o = !1;
                  if (!n) {
                    if (!s) {
                      s = [];
                      for (let e of a) L(e) && s.push(I(e));
                    }
                    let e = ((e, t, s) => {
                      if (!e || null != t) {
                        if (t.findLast) return t.findLast(s);
                    ...
                    o = e && 0 === r.slice(e, i).trim().length;
                  }
                  if (!o) return (e.extra = { ...e.extra, parenthesized: !0 }), e;
                  break;
                }
                ...
                case 'TemplateElement':
                  if ('flow' === i || 'hermes' === i || 'espree' === i || 'typescript' === i || n) {
                    let e = w(t) + 1,
                      s = I(t) - (t.tail ? 1 : 2);
                    t.range = [e, s];
                  }
                ...
                case 'VariableDeclaration': {
                  ...
                  null != e && e.init && ';' !== r[I(e)] && (t.range = [w(t), I(e)]);
                  break;
                }
                ...
                case 'TSIntersectionType':
                  ...
                  break;
                case 'TSMappedType':
                  if (!t.constraint && !t.key) {
                    let { name: e, constraint: s } = U(t.typeParameter);
                    (t.constraint = s), (t.key = e), delete t.typeParameter;
                  }
                  break;
                case 'TSEnumDeclaration':
                  if (!t.body) {
                    let e = I(t.id),
                      ...
                      i =
                        e +
                        (function (e, t, s) {
                          let i = e.originalText.slice(t, s);
                          for (let r of e[Symbol.for('comments')]) {
                            ...
                            if (a < t) continue;
                            let n = a - e;
                            i = i.slice(0, e - t) + ' '.repeat(n) + i.slice(a - t);
                          }
                          return i;
                        })(
                          { originalText: r, [Symbol.for('comments')]: a },
                          e,
                          s[0] ? w(s[0]) : I(t)
                        ).indexOf('{');
                    (t.body = { type: 'TSEnumBody', members: s, range: [i, I(t)] }),
                      delete t.members;
                  }
                  break;
                case 'ImportExpression':
                  'hermes' === i && t.attributes && !t.options && (t.options = t.attributes);
              }
            })).type
              ? e.program
              : e;
          return (
            o.interpreter && (a.unshift(o.interpreter), delete o.interpreter),
            n && e.hashbang && (a.unshift(e.hashbang), delete e.hashbang),
            'Program' === e.type && (e.range = [0, r.length]),
            e
          );
        },
        z = function (e, t) {
          let s = new SyntaxError(e + ' (' + t.loc.start.line + ':' + t.loc.start.column + ')');
          return Object.assign(s, t);
        },
        V = function (e) {
          let { message: t, loc: s, reasonCode: i } = e;
          if (!s) return e;
          let { line: r, column: a } = s,
            n = e;
          ...
          return (
            ...
            t.startsWith('Unexpected parseExpression() input: ') && (t = t.slice(36)),
            z(t, { loc: { start: { line: r, column: a + 1 } }, cause: n })
          );
        },
        $ = (e, t, s, i) => {
          if (!e || null != t)
      ...
      function se(e) {
        ...
        let s = (function (e) {
          ...
          { pragmas: i, comments: r } = (function (e) {
            e = $(!1, e.replace(K, '').replace(q, ''), Q, '$1');
            let t = '';
            for (; t !== e; ) (t = e), (e = $(!1, e, G, '\n$1 $2\n'));
            e = e.replace(X, '').trimEnd();
            let s,
              i = Object.create(null),
              r = $(!1, e, Y, '').replace(X, '').trimEnd();
            for (; (s = Y.exec(e)); ) {
              let e = $(!1, s[2], W, '');
              if ('string' == typeof i[s[1]] || Array.isArray(i[s[1]])) {
                let t = i[s[1]];
                i[s[1]] = [...Z, ...(Array.isArray(t) ? t : [t]), e];
              } else i[s[1]] = e;
            }
      ...
      function ie(e) {
        let { pragmas: t } = se(e);
        return te.some((e) => Object.prototype.hasOwnProperty.call(t, e));
      }
      function re(e) {
        let { pragmas: t } = se(e);
        return ee.some((e) => Object.prototype.hasOwnProperty.call(t, e));
      }
      var ae = function (e) {
          return (
        ...
        oe = 'script',
        he = function (e, t) {
          let { type: s = 'JsExpressionRoot', rootMarker: i, text: r } = t,
            { tokens: a, comments: n } = e;
          return (
            delete e.tokens,
            delete e.comments,
            { tokens: a, comments: n, type: s, node: e, range: [0, r.length], rootMarker: i }
          );
        },
        le = (e) =>
          ae(
              ...
              return (s, i = {}) => {
                ...
                if (
                  ...
                  ('babel' === i.parser || '__babel_estree' === i.parser) &&
                    (function (e, t) {
                      if (null != t && t.endsWith('.js.flow')) return !0;
                      let s = S(e);
                      ...
                      let i = (function (e, t) {
                        let s = null,
                          i = t;
                        for (; i !== s; )
                          (s = i), (i = P(e, i)), (i = T(e, i)), (i = A(e, i)), (i = b(e, i));
                        return i;
                      })(e, 0);
                      return !1 !== i && (e = e.slice(0, i)), me.test(e);
                    })(s, r))
                )
                  return (i.parser = 'babel-flow'), be.parse(s, i);
                let a = t,
                  n =
                    i.__babelSourceType ??
                    (function (e) {
                      if ('string' == typeof e) {
                        ...
                        if (/\.(?:cjs|cts)$/iu.test(e)) return oe;
                      }
                    })(r);
                n === oe && (a = a.map((e) => ({ ...e, sourceType: n })));
                let o = /%[A-Z]/u.test(s);
                s.includes('|>')
                  ? (a = (o ? [...ue, ce] : ue).flatMap((e) => a.map((t) => de([e], t))))
                  : o && (a = a.map((e) => de([ce], e)));
                let h,
                  l = e ? y.parseExpression : y.parse;
                try {
                  h = (function (e) {
                    let t = [];
                    for (let s of e)
                    ...
                    a.map(
                      (e) => () =>
                        (function (e, t, s) {
                          let i = e(t, s),
                            r = i.errors.find((e) => !fe.has(e.reasonCode));
                          if (r) throw r;
                          return i;
                        })(l, s, e)
                    )
                ...
                return e && (h = he(h, { text: s, rootMarker: i.rootMarker })), H(h, { text: s });
              };
            })(e)
          ),
        pe = {
        ...
        de = (e, t = pe) => ({ ...t, plugins: [...t.plugins, ...e] }),
        me = /@(?:no)?flow\b/u,
        fe = new Set([
          'StrictNumericEscape',
          'StrictWith',
        ...
        ye = [de(['jsx'])],
        xe = le({ optionsCombinations: ye }),
        Pe = le({ optionsCombinations: [de(['jsx', 'typescript']), de(['typescript'])] }),
        ge = le({ isExpression: !0, optionsCombinations: [de(['jsx'])] }),
        Te = le({ isExpression: !0, optionsCombinations: [de(['typescript'])] }),
        be = le({ optionsCombinations: [de(['jsx', ['flow', { all: !0 }], 'flowComments'])] }),
        Ae = le({ optionsCombinations: ye.map((e) => de(['estree'], e)) }),
        Se = {};
      c(Se, { json: () => ke, 'json-stringify': () => De, json5: () => Le, jsonc: () => Me });
      var Ee = u(d(), 1),
        we = function (e) {
          return Array.isArray(e) && e.length > 0;
        },
        Ie = { tokens: !1, ranges: !1, attachComment: !1, createParenthesizedExpressions: !0 };
      function Ce(e, t = {}) {
        let s,
          { allowComments: i = !0, allowEmpty: r = !1 } = t;
        try {
          s = (0, Ee.parseExpression)(e, Ie);
        } catch (t) {
          if (
            r &&
            ...
            try {
              s = (function (e) {
                let t = (0, Ee.parse)(e, Ie),
                  { program: s } = t;
                if (0 === s.body.length && 0 === s.directives.length && !s.interpreter) return t;
              })(e);
            } catch {}
          if (!s) throw V(t);
        }
        if (!i && we(s.comments)) throw Ne(s.comments[0], 'Comment');
        return (
          (s = he(s, { type: 'JsonRoot', text: e })),
          'File' === s.node.type ? delete s.node : ve(s.node),
          s
        );
      }
      function Ne(e, t) {
        ...
        return z(`${t} is not allowed in JSON.`, { loc: { start: s, end: i } });
      }
      function ve(e) {
        switch (e.type) {
          case 'ArrayExpression':
          ...
          case 'ObjectExpression':
            ...
            return;
          case 'ObjectProperty':
            if (e.computed) throw Ne(e.key, 'Computed key');
            if (e.shorthand) throw Ne(e.key, 'Shorthand property');
            return 'Identifier' !== e.key.type && ve(e.key), void ve(e.value);
          case 'UnaryExpression': {
            let { operator: t, argument: s } = e;
            if ('+' !== t && '-' !== t) throw Ne(e, `Operator '${e.operator}'`);
            if (
              'NumericLiteral' === s.type ||
              ('Identifier' === s.type && ('Infinity' === s.name || 'NaN' === s.name))
            )
              return;
            throw Ne(s, `Operator '${t}' before '${s.type}'`);
          }
          case 'Identifier':
            if ('Infinity' !== e.name && 'NaN' !== e.name && 'undefined' !== e.name)
              throw Ne(e, `Identifier '${e.name}'`);
            return;
          case 'TemplateLiteral':
            if (we(e.expressions)) throw Ne(e.expressions[0], "'TemplateLiteral' with expression");
      ...
      var ke = ae({ parse: (e) => Ce(e), hasPragma: () => !0, hasIgnorePragma: () => !1 }),
        Le = ae((e) => Ce(e)),
        Me = ae((e) => Ce(e, { allowEmpty: !0 })),
        De = ae({ parse: (e) => Ce(e, { allowComments: !1 }), astFormat: 'estree-json' }),
        Oe = { ...f, ...Se },
        Fe = m;
    },
  });
//# sourceMappingURL=283.extension.js.map
