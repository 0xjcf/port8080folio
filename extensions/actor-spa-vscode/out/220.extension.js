...
(exports.id = 220),
  ...
  (exports.modules = {
    3220: (e, t, r) => {
      ...
      var n = Object.create,
          ...
          ((e, t, r, n) => {
            if ((t && 'object' == typeof t) || 'function' == typeof t)
              for (let r of i(t))
                !u.call(e, r) &&
                  undefined !== r &&
                  s(e, r, { get: () => t[r], enumerable: !(n = o(t, r)) || n.enumerable });
            return e;
            ...
            s = class e extends Error {
              ...
              showSourceCode(e) {
                ...
                let s = (e) => e,
                  ...
                  i = (e) => e;
                if (e) {
                  let { bold: e, gray: t, red: a } = r.createColors(!0);
                  (o = (t) => e(a(t))), (s = (e) => t(e)), n && (i = (e) => n(e));
                }
                let a = t.split(/\r?\n/),
                    ...
                    if (r === this.line) {
                      if (e.length > 160) {
                        let t = 20,
                          ...
                          l =
                            s(n.replace(/\d/g, ' ')) +
                            e.slice(0, Math.min(this.column - 1, t - 1)).replace(/[^\t]/g, ' ');
                        return o('>') + s(n) + i(u) + '\n ' + l + o('^');
                      }
                      let t =
                        s(n.replace(/\d/g, ' ')) +
          ...
          var r = {
            ...
            n = class {
              ...
              raw(e, t, n) {
                ...
                if (
                  'before' === n &&
                  (!o || ('root' === o.type && o.first === e) || (o && 'document' === o.type))
                )
                  return '';
                if (!o) return r[n];
                let i = e.root();
                ...
                var a;
                return typeof s > 'u' && (s = r[n]), (i.rawCache[n] = s), s;
              }
              rawBeforeClose(e) {
                let t;
                return (
              ...
              rawEmptyBody(e) {
                ...
                return (
                  e.walk((e) => {
                    if (e.nodes && 0 === e.nodes.length && ((t = e.raws.after), typeof t < 'u'))
                      return !1;
                  }),
                  t
                );
        ...
        v = l((e, t) => {
          ...
          var l = class {
            ...
            getProxyProcessor() {
              return {
                get: (e, t) =>
                  'proxyOf' === t ? e : 'root' === t ? () => e.root().toProxy() : e[t],
                set: (e, t, r) => (
                  e[t] === r ||
                    ((e[t] = r),
                    ('prop' === t ||
                  ...
                  ? {
                      ...
                      offset:
                        'number' == typeof this.source.end.offset
                          ...
                          : u(t, this.source.end) + 1,
                    }
                  : { column: r.column + 1, line: r.line, offset: r.offset + 1 };
              if (e.word) {
                let s = t.slice(u(t, this.source.start), u(t, this.source.end)).indexOf(e.word);
                -1 !== s &&
                  ((r = this.positionInside(s)), (n = this.positionInside(s + e.word.length)));
              } else
                e.start
                  ? (r = { column: e.start.column, line: e.start.line, offset: u(t, e.start) })
                  : e.index && (r = this.positionInside(e.index)),
                  e.end
                    ? (n = { column: e.end.column, line: e.end.line, offset: u(t, e.end) })
          ...
          var f = class e extends u {
            ...
            insertAfter(e, t) {
              ...
              for (let e in this.indexes)
                (r = this.indexes[e]), n < r && (this.indexes[e] = r + s.length);
              return this.markDirty(), this;
            }
            insertBefore(e, t) {
              let r,
                n = this.index(e),
                s = 0 === n && 'prepend',
                o = this.normalize(t, this.proxyOf.nodes[n], s).reverse();
              n = this.index(e);
            ...
            normalize(t, s) {
              if ('string' == typeof t) t = p(n(t).nodes);
                ...
                'string' != typeof t.value && (t.value = String(t.value)), (t = [new a(t)]);
              } else if (t.selector || t.selectors) t = [new o(t)];
              ...
              return t.map(
                (t) => (
                  ...
                  typeof t.raws.before > 'u' &&
                    ...
                    (t.raws.before = s.raws.before.replace(/\S/g, '')),
        ...
        C = l((e, t) => {
          var { nanoid: r } = k(),
            ...
            { SourceMapConsumer: o, SourceMapGenerator: i } = O(),
            { fileURLToPath: a, pathToFileURL: u } = {},
            l = d(),
            c = T(),
            p = f(),
          ...
          function g(e) {
            ...
            let t = e.css.split('\n'),
              ...
              n = 0;
            for (let e = 0, s = t.length; e < s; e++) (r[e] = n), (n += t[e].length + 1);
            return (e[h] = r), r;
          }
          var v = class {
            get from() {
            ...
            constructor(e, t = {}) {
              if (null === e || typeof e > 'u' || ('object' == typeof e && !e.toString))
              ...
              this.file || (this.id = '<input css ' + r(6) + '>'),
            ...
            error(e, t, r, n = {}) {
              ...
              if (t && 'object' == typeof t) {
                ...
                if ('number' == typeof n.offset) {
                  ...
                  (o = e.line), (s = e.col);
                } else (o = n.line), (s = n.column), (i = this.fromLineAndColumn(n.line, n.column));
              ...
              let p = this.origin(t, r, o, s);
              return (
                (c = p
                  ? new l(
                      e,
                      void 0 === p.endLine ? p.line : { column: p.column, line: p.line },
                      void 0 === p.endLine ? p.column : { column: p.endColumn, line: p.endLine },
                      p.source,
                      p.file,
                      n.plugin
                    )
                ...
                this.file &&
                  (u && (c.input.url = u(this.file).toString()), (c.input.file = this.file)),
                c
              );
            }
            ...
            origin(e, t, r, s) {
              ...
              let o,
                i,
                l = this.map.consumer(),
                c = l.originalPositionFor({ column: t, line: e });
              if (!c.source) return !1;
              'number' == typeof r && (o = l.originalPositionFor({ column: s, line: r })),
                (i = n(c.source)
                  ? u(c.source)
                  : new URL(c.source, this.map.consumer().sourceRoot || u(this.map.mapFile)));
              let p = {
                column: c.column,
              ...
              if ('file:' === i.protocol) {
                if (!a) throw new Error('file: protocol is not available in this PostCSS build');
                p.file = a(i);
              }
              ...
              nextToken: function (e) {
                ...
                switch (((i = y.charCodeAt(w)), i)) {
                  ...
                  case 12:
                    l = w;
                    do {
                      (l += 1), (i = y.charCodeAt(l));
                    } while (32 === i || 10 === i || 9 === i || 13 === i || 12 === i);
                    (p = ['space', y.slice(w, l)]), (w = l - 1);
                    break;
                  case 91:
                  case 93:
                  case 123:
                  ...
                  case 40:
                    if (
                      ...
                      do {
                        ...
                        for (f = l; 92 === y.charCodeAt(f - 1); ) (f -= 1), (h = !h);
                      } while (h);
                      (p = ['brackets', y.slice(w, l + 1), w, l]), (w = l);
                    } else
                      (l = y.indexOf(')', w + 1)),
                        (a = y.slice(w, l + 1)),
                        -1 === l || s.test(a)
                          ? (p = ['(', '(', w])
                          : ((p = ['brackets', a, w, l]), (w = l));
                    break;
                  case 39:
                  case 34:
                    (c = 39 === i ? "'" : '"'), (l = w);
                    do {
                      if (((h = !1), (l = y.indexOf(c, l + 1)), -1 === l)) {
                        if (g || t) {
                          l = w + 1;
                          break;
                        }
                    ...
                    (p = ['string', y.slice(w, l + 1), w, l]), (w = l);
                    break;
                  case 64:
                    (r.lastIndex = w + 1),
                      r.test(y),
                      (l = 0 === r.lastIndex ? y.length - 1 : r.lastIndex - 2),
                      (p = ['at-word', y.slice(w, l + 1), w, l]),
                      (w = l);
                    break;
                  case 92:
                    for (l = w, u = !0; 92 === y.charCodeAt(l + 1); ) (l += 1), (u = !u);
                    if (
                      ((i = y.charCodeAt(l + 1)),
                      u &&
                        47 !== i &&
                        ...
                        13 !== i &&
                        12 !== i &&
                        ((l += 1), o.test(y.charAt(l))))
                    ) {
                      for (; o.test(y.charAt(l + 1)); ) l += 1;
                      32 === y.charCodeAt(l + 1) && (l += 1);
                    }
                    (p = ['word', y.slice(w, l + 1), w, l]), (w = l);
                    break;
                  default:
                    47 === i && 42 === y.charCodeAt(w + 1)
                      ? ((l = y.indexOf('*/', w + 2) + 1),
                        0 === l && (g || t ? (l = y.length) : k('comment')),
                        (p = ['comment', y.slice(w, l + 1), w, l]),
                        (w = l))
                      : ((n.lastIndex = w + 1),
                        n.test(y),
                        (l = 0 === n.lastIndex ? y.length - 1 : n.lastIndex - 2),
                        (p = ['word', y.slice(w, l + 1), w, l]),
                        b.push(p),
                        (w = l));
                }
                return w++, p;
          ...
          t.exports = class {
            ...
            atrule(e) {
              ...
              for (; !this.tokenizer.endOfFile(); ) {
                if (
                  ((n = (e = this.tokenizer.nextToken())[0]),
                  '(' === n || '[' === n
                    ? l.push('(' === n ? ')' : ']')
                    : '{' === n && l.length > 0
                      ? l.push('}')
                      : n === l[l.length - 1] && l.pop(),
                  0 === l.length)
                ) {
                  if (';' === n) {
                  ...
                  if ('}' === n) {
                    if (u.length > 0) {
                      for (o = u.length - 1, s = u[o]; s && 'space' === s[0]; ) s = u[--o];
            ...
            decl(e, t) {
              ...
              let i,
                a = [];
              for (; e.length && ((i = e[0][0]), 'space' === i || 'comment' === i); )
                a.push(e.shift());
              ...
              for (let t = e.length - 1; t >= 0; t--) {
                ...
                if ('important' === n[1].toLowerCase()) {
                  ...
                  for (let e = t; e > 0; e--) {
                    let t = n[e][0];
                    if (s.trim().startsWith('!') && 'space' !== t) break;
                    s = n.pop()[1] + s;
                  }
                  s.trim().startsWith('!') && ((r.important = !0), (r.raws.important = s), (e = n));
                }
            ...
            other(e) {
              ...
              for (; u; ) {
                if (((r = u[0]), a.push(u), '(' === r || '[' === r))
                  s || (s = u), o.push('(' === r ? ')' : ']');
                else if (i && n && '{' === r) s || (s = u), o.push('}');
                else if (0 === o.length) {
                  if (';' === r) {
                    if (n) return void this.decl(a, i);
                    break;
                  }
                  ...
                  ':' === r && (n = !0);
                } else r === o[o.length - 1] && (o.pop(), 0 === o.length && (s = null));
              ...
              if (
                ...
                if (!i)
                  for (; a.length && ((u = a[a.length - 1][0]), 'space' === u || 'comment' === u); )
            ...
            spacesAndCommentsFromEnd(e) {
              let t,
                r = '';
              for (; e.length && ((t = e[e.length - 1][0]), 'space' === t || 'comment' === t); )
                r = e.pop()[1] + r;
              return r;
            }
            ...
            isInlineComment(e) {
              if ('word' === e[0] && '//' === e[1].slice(0, 2)) {
                ...
                for (; e; ) {
                  ...
                  i.push(e[1]), (t = e[2]), (e = this.tokenizer.nextToken({ ignoreUnclosed: !0 }));
                }
                let a = ['comment', i.join(''), o[2], t];
                return (
                  this.inlineComment(a),
                  s && ((this.input = new n(s)), (this.tokenizer = r(this.input))),
                  !0
                );
              }
              if ('/' === e[1]) {
                let r = this.tokenizer.nextToken({ ignoreUnclosed: !0 });
                if ('comment' === r[0] && /^\/\*/.test(r[1]))
                  return (
                    (r[0] = 'word'),
                    (r[1] = r[1].slice(1)),
                    (e[1] = '//'),
                    this.tokenizer.back(r),
                    t.exports.isInlineComment.bind(this)(e)
                  );
              }
              return !1;
            },
        ...
        $ = l((e, t) => {
          t.exports = {
            interpolation(e) {
              ...
              for (e = this.tokenizer.nextToken(); e && r.includes(e[0]); )
                t.push(e), (e = this.tokenizer.nextToken());
              let n = t.map((e) => e[1]),
                [s] = t,
                o = t.pop(),
                i = ['word', n.join(''), s[2], o[2]];
        ...
        W = l((e, t) => {
          ...
          t.exports = class extends n {
            ...
            atrule(e) {
              o.bind(this)(e) || (super.atrule(e), a(this.lastNode), u(this.lastNode));
            }
            decl(...e) {
              super.decl(...e),
            ...
            mixin(e) {
              ...
              let i = [];
              for (let t of e)
                if ((('!' === t[1] || i.length) && i.push(t), 'important' === t[1])) break;
              if (i.length) {
                let [t] = i,
                  r = e.indexOf(t),
                  n = i[i.length - 1],
                  s = [t[2], t[3]],
                  o = [n[4], n[5]],
                  a = ['word', i.map((e) => e[1]).join('')].concat(s, o);
                e.splice(r, i.length, a);
              }
              let a = e.findIndex((e) => l.test(e[1]));
            ...
            parse(e, t) {
              ...
              return (
                ...
                o.root.walk((e) => {
                  ...
                  if (0 === t) return;
                  if (t + e.source.input.css.length !== s.css.length)
                  ...
                  if (
                    ((e.source.start = { offset: r, line: n.line, column: n.col }), e.source.end)
                  ) {
        ...
        J = l((e, t) => {
          ...
          function w(e) {
            return (e[l] = !1), e.nodes && e.nodes.forEach((e) => w(e)), e;
          }
          var b = {},
            k = class e {
              get content() {
              ...
              constructor(t, n, s) {
                ...
                if (
                  ...
                  'object' != typeof n ||
                    null === n ||
                    ('root' !== n.type && 'document' !== n.type))
                )
                  if (n instanceof e || n instanceof i)
                    (a = w(n.root)),
                      n.map &&
                        (typeof s.map > 'u' && (s.map = {}),
              ...
              sync() {
                ...
                for (let e of this.plugins) if (d(this.runOnRoot(e))) throw this.getAsyncError();
                if ((this.prepareVisitors(), this.hasListener)) {
                  let e = this.result.root;
              ...
              visitSync(e, t) {
                for (let [r, n] of e) {
                  ...
                  if (d(e)) throw this.getAsyncError();
                }
              }
              visitTick(e) {
                let t = e[e.length - 1],
                ...
                if (0 !== t.iterator) {
                  ...
                  for (; (n = r.nodes[r.indexes[s]]); )
                    if (((r.indexes[s] += 1), !n[l])) return (n[l] = !0), void e.push(v(n));
          ...
          (k.registerPostcss = (e) => {
            ...
            (t.exports = k),
            (k.default = k),
            a.registerLazyResult(k),
            n.registerLazyResult(k);
        }),
        H = l((e, t) => {
          var r = U(),
            n = P(),
            ...
            i =
              ...
              class {
                ...
                constructor(e, t, n) {
                  ...
                  let i,
                    a = o;
                  (this.result = new s(this._processor, i, this._opts)), (this.result.css = t);
                  let u = this;
                  Object.defineProperty(this.result, 'root', { get: () => u.root });
                  let l = new r(a, i, this._opts, t);
                  if (l.isMap()) {
                    let [e, t] = l.generate();
        ...
        Q = l((e, t) => {
          ...
          (t.exports = i), (i.default = i), o.registerProcessor(i), r.registerProcessor(i);
        }),
        K = l((e, t) => {
          var r = S(),
            n = w(),
              ...
              nextToken: function (e) {
                ...
                switch (((a = g.charCodeAt(b)), a)) {
                  ...
                  case 40:
                    if (
                      ...
                      for (y = 1, h = !1, u = b + 1; u <= g.length - 1; ) {
                        if (((d = g.charCodeAt(u)), 92 === d)) h = !h;
                        else if (40 === d) y += 1;
                        else if (41 === d && ((y -= 1), 0 === y)) break;
                        u += 1;
                      }
                      (c = g.slice(b, u + 1)), (m = ['brackets', c, b, u]), (b = u);
                    } else
                      (u = g.indexOf(')', b + 1)),
                        (c = g.slice(b, u + 1)),
                        -1 === u || s.test(c)
                          ? (m = ['(', '(', b])
                          : ((m = ['brackets', c, b, u]), (b = u));
                    break;
                  case 39:
                  case 34:
                    for (
                      ...
                      92 === a ? (h = !h) : h ? (h = !1) : 35 === a && 123 === d && T();
                    (m = ['string', g.slice(b, u + 1), b, u]), (b = u);
                    break;
                  case 64:
                    (r.lastIndex = b + 1),
                      r.test(g),
                      (u = 0 === r.lastIndex ? g.length - 1 : r.lastIndex - 2),
                      (m = ['at-word', g.slice(b, u + 1), b, u]),
                      (b = u);
                    break;
                  case 92:
                    for (u = b, p = !0; 92 === g.charCodeAt(u + 1); ) (u += 1), (p = !p);
                    if (
                      ((a = g.charCodeAt(u + 1)),
                      p &&
                        47 !== a &&
                        ...
                        13 !== a &&
                        12 !== a &&
                        ((u += 1), o.test(g.charAt(u))))
                    ) {
                      for (; o.test(g.charAt(u + 1)); ) u += 1;
                  ...
                  default:
                    (d = g.charCodeAt(b + 1)),
                      35 === a && 123 === d
                        ? ((u = b), T(), (c = g.slice(b, u + 1)), (m = ['word', c, b, u]), (b = u))
                        : 47 === a && 42 === d
                          ? ((u = g.indexOf('*/', b + 2) + 1),
                            0 === u && (v || t ? (u = g.length) : O('comment')),
                            (m = ['comment', g.slice(b, u + 1), b, u]),
                            (b = u))
                          : 47 === a && 47 === d
                            ? ((i.lastIndex = b + 1),
                              i.test(g),
                              (u = 0 === i.lastIndex ? g.length - 1 : i.lastIndex - 2),
                              (c = g.slice(b, u + 1)),
                              (m = ['comment', c, b, u, 'inline']),
                              (b = u))
                            : ((n.lastIndex = b + 1),
                              n.test(g),
                              (u = 0 === n.lastIndex ? g.length - 1 : n.lastIndex - 2),
                              (m = ['word', g.slice(b, u + 1), b, u]),
                              x.push(m),
                              (b = u));
                }
                return b++, m;
          ...
          t.exports = class extends n {
            ...
            raw(e, t, r, n) {
              if ((super.raw(e, t, r, n), e.raws[t])) {
                let n = e.raws[t].raw;
                (e.raws[t].raw = r.reduce(
                  (e, t) =>
                    'comment' === t[0] && 'inline' === t[4]
                      ? e + '/*' + t[1].slice(2).replace(/(\*\/|\/\*)/g, '*//*') + '*/'
                      : e + t[1],
                  ''
                )),
              ...
              if (!t || '' === n.trim() || /^[#:A-Za-z-]/.test(n)) super.rule(e);
                ...
                for (let t = e.length - 1; t > 0; t--) {
                  ...
                  if ('important' === r[1]) {
                    ...
                    0 === s.trim().indexOf('!') &&
                      ((n.important = !0), (n.raws.important = s), (e = r));
                  }
        ...
        re = l((e) => {
          Object.defineProperty(e, '__esModule', { value: !0 });
          var t,
            r = (t = te()) && t.__esModule ? t : { default: t };
          function n(e) {
            var t = this;
            this.constructor(e),
              (this.nodes = e.nodes),
          ...
          (n.prototype = Object.create(r.default.prototype)),
            (n.constructor = r.default),
            (n.prototype.walk = function (e, t) {
              for (
                var r = 'string' == typeof e || e instanceof RegExp,
                  n = r ? t : e,
                  s = 'string' == typeof e ? new RegExp(e) : e,
                  o = 0;
                o < this.nodes.length;
                o++
              ) {
                var i = this.nodes[o];
                if (
                  ((!r || s.test(i.type)) && n && !1 === n(i, o, this.nodes)) ||
                  (i.nodes && !1 === i.walk(e, t))
                )
                  return !1;
              }
              return !0;
        ...
        ne = l((e) => {
          ...
          function s(e) {
            var t = [{ mode: 'normal', character: null }],
              ...
              u = e;
            '(' === e[0] && ')' === e[e.length - 1] && ((u = e.substring(1, e.length - 1)), a++);
            for (var l = 0; l < u.length; l++) {
              var c = u[l];
              if (
                (("'" === c || '"' === c) &&
                  (!0 === t[n].isCalculationEnabled
                    ? (t.push({ mode: 'string', isCalculationEnabled: !1, character: c }), n++)
                    : 'string' === t[n].mode &&
                      t[n].character === c &&
                      '\\' !== u[l - 1] &&
                      (t.pop(), n--)),
                '{' === c
                  ? (t.push({ mode: 'interpolation', isCalculationEnabled: !0 }), n++)
                  : '}' === c && (t.pop(), n--),
                'normal' === t[n].mode && ':' === c)
              ) {
                var p = u.substring(l + 1);
                ((i = {
                  type: 'value',
                  before: /^(\s*)/.exec(p)[1],
                  after: /(\s*)$/.exec(p)[1],
                  value: p.trim(),
                }).sourceIndex = i.before.length + l + 1 + a),
                  (o = { type: 'colon', sourceIndex: l + a, after: i.before, value: ':' });
                break;
              }
              s += c;
            }
            return (
              ((s = {
                ...
                after: /(\s*)$/.exec(s)[1],
                value: s.trim(),
              }).sourceIndex = s.before.length + a),
              r.push(s),
              null !== o && ((o.before = s.after), r.push(o)),
              null !== i && r.push(i),
              r
            );
          }
          function o(e) {
            ...
            for (var c = 0; c < e.length; c++) {
              var p = e[c];
              a
                ? ((u.value += p), ('{' === p || '(' === p) && i++, (')' === p || '}' === p) && i--)
                : -1 !== p.search(/\s/)
                  ? (u.before += p)
                  : ('(' === p && ((u.type = 'media-feature-expression'), i++),
                    (u.value = p),
                    (u.sourceIndex = n + c),
                    (a = !0)),
                a &&
                  ...
                  (-1 !== ['not', 'only', 'and'].indexOf(u.value) && (u.type = 'keyword'),
                  'media-feature-expression' === u.type && (u.nodes = s(u.value, u.sourceIndex)),
                  o.push(Array.isArray(u.nodes) ? new r.default(u) : new t.default(u)),
                  (u = l()),
                  (a = !1));
            }
            for (var h = 0; h < o.length; h++)
              if (((u = o[h]), h > 0 && (o[h - 1].after = u.before), void 0 === u.type)) {
                if (h > 0) {
                  ...
                  'media-type' === o[h - 1].type &&
                    (o[h + 1]
                      ? (u.type =
                          'media-feature-expression' === o[h + 1].type
                            ? 'keyword'
                ...
                if (0 === h) {
                  ...
                  if (
                    o[h + 1] &&
                    ('media-feature-expression' === o[h + 1].type || 'keyword' === o[h + 1].type)
                  ) {
                    u.type = 'media-type';
                    continue;
                  }
                  if (o[h + 2]) {
                    if ('media-feature-expression' === o[h + 2].type) {
                      (u.type = 'media-type'), (o[h + 1].type = 'keyword');
                      continue;
                    }
                    if ('keyword' === o[h + 2].type) {
                      (u.type = 'keyword'), (o[h + 1].type = 'media-type');
                      continue;
                    }
                  }
                  if (o[h + 3] && 'media-feature-expression' === o[h + 3].type) {
                    (u.type = 'keyword'),
                      (o[h + 1].type = 'media-type'),
                      (o[h + 2].type = 'keyword');
                    continue;
                  }
                }
        ...
        se = l((e) => {
          ...
          var t,
            r = (t = re()) && t.__esModule ? t : { default: t },
            n = ne();
        }),
        oe = l((e, t) => {
          t.exports = function (e, t) {
          ...
          t.exports = function (e, t, r) {
            return 0 === e.length
              ...
              : t
                ? (r || e.sort(t),
                  (function (e, t) {
                    for (var r = 1, n = e.length, s = e[0], o = e[0], i = 1; i < n; ++i)
                      if (((o = s), t((s = e[i]), o))) {
                        if (i === r) {
                          r++;
                          continue;
                ...
                : (r || e.sort(),
                  (function (e) {
                    for (var t = 1, r = e.length, n = e[0], s = e[0], o = 1; o < r; ++o, s = n)
                      if (((s = n), (n = e[o]) !== s)) {
                        if (o === t) {
                          t++;
                          continue;
        ...
        ce = l((e, t) => {
          ...
          var r,
            ...
            s = (r = ue()) && r.__esModule ? r : { default: r },
            o = (function (e) {
              ...
              return (
                ...
                (t.prototype.insertAfter = function (e, t) {
                  ...
                  for (var s in this.indexes)
                    r <= (n = this.indexes[s]) && (this.indexes[s] = n + this.nodes.length);
                  return this;
                }),
                ...
                (t.prototype.split = function (e) {
                  var t = this,
                    r = [];
                  return this.reduce(function (n, s, o) {
                    var i = e.call(t, s);
                    return (
                      r.push(s), i ? (n.push(r), (r = [])) : o === t.length - 1 && n.push(r), n
                    );
                  }, []);
                }),
        ...
        pe = l((e, t) => {
          e.__esModule = !0;
          var r,
            n = (r = ce()) && r.__esModule ? r : { default: r },
            s = le(),
            o = (function (e) {
              function t(r) {
                !(function (e, t) {
        ...
        fe = l((e, t) => {
          ...
          var r,
            ...
            })(((r = ue()) && r.__esModule ? r : { default: r }).default);
          (e.default = s), (t.exports = e.default);
        }),
        de = l((e, t) => {
          e.__esModule = !0;
          var r,
            n = (r = fe()) && r.__esModule ? r : { default: r },
            s = le(),
            o = (function (e) {
              function t(r) {
                !(function (e, t) {
        ...
        me = l((e, t) => {
          e.__esModule = !0;
          var r,
            n = (r = ue()) && r.__esModule ? r : { default: r },
            s = le(),
            o = (function (e) {
              function t(r) {
                !(function (e, t) {
          ...
          var r,
            ...
            o = (function (e) {
              function t(r) {
                ...
                return (n.type = s.ATTRIBUTE), (n.raws = {}), n;
              }
              return (
                (function (e, t) {
                  if ('function' != typeof t && null !== t)
            ...
            (e.default = function (e) {
              for (
                var t = [],
                  ...
                  D = 0,
                  U = function (t, r) {
                    if (!e.safe) throw e.error('Unclosed ' + t, q, D - z, D);
                    A = (_ += r).length - 1;
                  };
                D < B;
              ) {
                switch (((E = _.charCodeAt(D)) === i && ((z = D), (q += 1)), E)) {
                  case i:
                  case a:
                  case l:
                  case c:
                  case u:
                    A = D;
                    do {
                      (A += 1), (E = _.charCodeAt(A)) === i && ((z = A), (q += 1));
                    } while (E === a || E === i || E === l || E === c || E === u);
                    t.push(['space', _.slice(D, A), q, D - z, D]), (D = A - 1);
                    break;
                  case p:
                  case h:
                  case f:
                  case d:
                    A = D;
                    do {
                      (A += 1), (E = _.charCodeAt(A));
                    } while (E === p || E === h || E === f || E === d);
                    t.push(['combinator', _.slice(D, A), q, D - z, D]), (D = A - 1);
                    break;
                  case x:
                    t.push(['*', '*', q, D - z, D]);
                    break;
                  ...
                  case n:
                    ...
                    do {
                      for (
                        L = !1, -1 === (A = _.indexOf(j, A + 1)) && U('quote', j), W = A;
                        _.charCodeAt(W - 1) === s;
                      )
                        (W -= 1), (L = !L);
                    } while (L);
                    t.push(['string', _.slice(D, A + 1), q, D - z, q, A - z, D]), (D = A);
                    break;
                  case T:
                    (C.lastIndex = D + 1),
                      C.test(_),
                      (A = 0 === C.lastIndex ? _.length - 1 : C.lastIndex - 2),
                      t.push(['at-word', _.slice(D, A + 1), q, D - z, q, A - z, D]),
                      (D = A);
                    break;
                  case s:
                    for (A = D, $ = !0; _.charCodeAt(A + 1) === s; ) (A += 1), ($ = !$);
                    (E = _.charCodeAt(A + 1)),
                      $ &&
                        E !== o &&
                        E !== a &&
                        ...
                        E !== u &&
                        (A += 1),
                      t.push(['word', _.slice(D, A + 1), q, D - z, q, A - z, D]),
                      (D = A);
                    break;
                  default:
                    E === o && _.charCodeAt(D + 1) === x
                      ? (0 === (A = _.indexOf('*/', D + 2) + 1) && U('comment', '*/'),
                        (P = (I = (M = _.slice(D, A + 1)).split('\n')).length - 1) > 0
                          ? ((R = q + P), (N = A - I[P].length))
                          : ((R = q), (N = z)),
                        t.push(['comment', M, q, D - z, R, A - N, D]),
                        (z = N),
                        (q = R),
                        (D = A))
                      : ((S.lastIndex = D + 1),
                        S.test(_),
                        (A = 0 === S.lastIndex ? _.length - 1 : S.lastIndex - 2),
                        t.push(['word', _.slice(D, A + 1), q, D - z, q, A - z, D]),
                        (D = A));
                }
                D++;
          ...
          var k = (function () {
            function e(t) {
              ...
              return (
                ...
                (this.current = r),
                this.lossy
                  ? (this.tokens = (0, w.default)({ safe: t.safe, css: t.css.trim() }))
                  : (this.tokens = (0, w.default)(t)),
                this.loop()
              );
            }
            return (
              (e.prototype.attribute = function () {
                ...
                if (
                  (s.length > 1
                    ? ('' === s[0] && (s[0] = !0),
                      (o.attribute = this.parseValue(s[2])),
                      (o.namespace = this.parseNamespace(s[0])))
                    : (o.attribute = this.parseValue(n[0])),
                  (t = new d.default(o)),
                  n[2])
                ) {
                  var i = n[2].split(/(\s+i\s*?)$/),
                    a = i[0].trim();
                  (t.value = this.lossy ? a : i[0]),
                    i[1] && ((t.insensitive = !0), this.lossy || (t.raws.insensitive = i[1])),
                    (t.quoted = "'" === a[0] || '"' === a[0]),
                    (t.raws.unquoted = t.quoted ? a.slice(1, -1) : a);
                }
              ...
              (e.prototype.combinator = function () {
                ...
                for (
                  ...
                  this.position < this.tokens.length &&
                  this.currToken &&
                  ('space' === this.currToken[0] || 'combinator' === this.currToken[0]);
                )
              ...
              (e.prototype.parentheses = function () {
                ...
                if (e && e.type === b.PSEUDO) {
                  ...
                  var s = 1;
                  for (this.position++, e.value += '('; this.position < this.tokens.length && s; )
                    '(' === this.currToken[0] && s++,
                      ')' === this.currToken[0] && s--,
              ...
              (e.prototype.splitWord = function (e, t) {
                for (
                  var r = this, i = this.nextToken, a = this.currToken[1];
                  i && 'word' === i[0];
                ) {
                  this.position++;
                ...
                var y = (0, v.default)((0, o.default)((0, n.default)([[0], f, d])));
                y.forEach(function (n, s) {
                  var o = y[s + 1] || a.length,
                    i = a.slice(n, o);
                  if (0 === s && t) return t.call(r, i, y.length);
                  var l;
                  (l = ~f.indexOf(n)
                    ? new u.default({
                        value: i.slice(1),
                        source: {
                          ...
                          end: { line: r.currToken[4], column: r.currToken[3] + (o - 1) },
                        },
                        sourceIndex: r.currToken[6] + y[s],
                      })
                    : ~d.indexOf(n)
                      ? new c.default({
                          value: i.slice(1),
        ...
        _e = l((e, t) => {
          ...
          var r,
            ...
            s = (r = Se()) && r.__esModule ? r : { default: r },
            o = (function () {
              function e(t) {
                return (
                  (function (e, t) {
          ...
          t.exports = class {
            ...
            toJSON() {
              ...
              for (let t in this) {
                ...
                let r = this[t];
                r instanceof Array
                  ? (e[t] = r.map((e) => ('object' == typeof e && e.toJSON ? e.toJSON() : e)))
                  : 'object' == typeof r && r.toJSON
                    ? (e[t] = r.toJSON())
                    : (e[t] = r);
              }
              return e;
          ...
          var r = Ee(),
            n = class extends r {
              ...
              each(e) {
                ...
                if (((this.indexes[n] = 0), this.nodes)) {
                  for (
                    ...
                    ((t = this.indexes[n]), (r = e(this.nodes[t], t)), !1 !== r);
                  )
                    this.indexes[n] += 1;
                  return delete this.indexes[n], r;
                }
              ...
              insertAfter(e, t) {
                ...
                for (let e in this.indexes)
                  (r = this.indexes[e]), n <= r && (this.indexes[e] = r + this.nodes.length);
                return this;
              }
              insertBefore(e, t) {
                let r,
        ...
        Fe = l((e, t) => {
          ...
          t.exports = function (e, t) {
            ...
            let u,
              ...
              S = null;
            function _(e) {
              throw new a(`Unclosed ${e} at line: ${O}, column: ${T - k}, token: ${T}`);
            }
            for (; T < x; ) {
              switch (((u = b.charCodeAt(T)), 10 === u && ((k = T), (O += 1)), u)) {
                case 10:
                case 32:
                case 9:
                case 13:
                case 12:
                  l = T;
                  do {
                    (l += 1), (u = b.charCodeAt(l)), 10 === u && ((k = l), (O += 1));
                  } while (32 === u || 10 === u || 9 === u || 13 === u || 12 === u);
                  w.push(['space', b.slice(T, l), O, T - k, O, l - k, T]), (T = l - 1);
                  break;
                case 58:
                  (l = T + 1), w.push(['colon', b.slice(T, l), O, T - k, O, l - k, T]), (T = l - 1);
                  break;
                case 44:
                  (l = T + 1), w.push(['comma', b.slice(T, l), O, T - k, O, l - k, T]), (T = l - 1);
                  break;
                case 123:
                  w.push(['{', '{', O, T - k, O, l - k, T]);
                  break;
                case 125:
                  w.push(['}', '}', O, T - k, O, l - k, T]);
                  break;
                case 40:
                  ...
                  break;
                case 41:
                  C--, (S = S && C > 0), w.push([')', ')', O, T - k, O, l - k, T]);
                  break;
                case 39:
                case 34:
                  (c = 39 === u ? "'" : '"'), (l = T);
                  do {
                    for (
                      y = !1, l = b.indexOf(c, l + 1), -1 === l && _('quote'), g = l;
                      92 === b.charCodeAt(g - 1);
                    )
                      (g -= 1), (y = !y);
                  } while (y);
                  w.push(['string', b.slice(T, l + 1), O, T - k, O, l - k, T]), (T = l);
                  break;
                case 64:
                  (r.lastIndex = T + 1),
                    r.test(b),
                    (l = 0 === r.lastIndex ? b.length - 1 : r.lastIndex - 2),
                    w.push(['atword', b.slice(T, l + 1), O, T - k, O, l - k, T]),
                    (T = l);
                  break;
                case 92:
                  (l = T),
                    (u = b.charCodeAt(l + 1)),
                    w.push(['word', b.slice(T, l + 1), O, T - k, O, l - k, T]),
                    (T = l);
                  break;
                case 43:
                case 45:
                case 42:
                  if (
                    ...
                    (v = b.slice(T + 1, l + 1)),
                    b.slice(T - 1, T),
                    45 === u && 45 === v.charCodeAt(0))
                  ) {
                    l++, w.push(['word', b.slice(T, l), O, T - k, O, l - k, T]), (T = l - 1);
                    break;
                  }
                  w.push(['operator', b.slice(T, l), O, T - k, O, l - k, T]), (T = l - 1);
                  break;
                default:
                  if (
                    47 === u &&
                    (42 === b.charCodeAt(T + 1) || (t.loose && !S && 47 === b.charCodeAt(T + 1)))
                  ) {
                    if (42 === b.charCodeAt(T + 1))
                      (l = b.indexOf('*/', T + 2) + 1), 0 === l && _('comment');
                    else {
                      let e = b.indexOf('\n', T + 2);
                      l = -1 !== e ? e - 1 : x;
                    }
                    (f = b.slice(T, l + 1)),
                      (p = f.split('\n')),
                      (h = p.length - 1),
                      h > 0 ? ((d = O + h), (m = l - p[h].length)) : ((d = O), (m = k)),
                      w.push(['comment', f, O, T - k, d, l - m, T]),
                      (k = m),
                      (O = d),
                      (T = l);
                  } else if (35 !== u || o.test(b.slice(T + 1, T + 2)))
                    if ((117 !== u && 85 !== u) || 43 !== b.charCodeAt(T + 1))
                      if (47 === u)
                        (l = T + 1),
                          w.push(['operator', b.slice(T, l), O, T - k, O, l - k, T]),
                          (T = l - 1);
                      else {
                        let e = n;
                        if (
                          ...
                          (e.lastIndex = T + 1),
                          e.test(b),
                          (l = 0 === e.lastIndex ? b.length - 1 : e.lastIndex - 2),
                          e === s || 46 === u)
                        ) {
                          ...
                          (101 === e || 69 === e) &&
                            ...
                            ((s.lastIndex = l + 2),
                            s.test(b),
                            (l = 0 === s.lastIndex ? b.length - 1 : s.lastIndex - 2));
                        }
                        w.push(['word', b.slice(T, l + 1), O, T - k, O, l - k, T]), (T = l);
                      }
                    else {
                      l = T + 2;
                      do {
                        (l += 1), (u = b.charCodeAt(l));
                      } while (l < x && i.test(b.slice(l, l + 1)));
                      w.push(['unicoderange', b.slice(T, l), O, T - k, O, l - k, T]), (T = l - 1);
                    }
                  else
                    (l = T + 1), w.push(['#', b.slice(T, l), O, T - k, O, l - k, T]), (T = l - 1);
              }
              T++;
            }
            return w;
        ...
        Ge = l((e, t) => {
          ...
          t.exports = class {
            ...
            comment() {
              ...
              this.options.loose && r.startsWith('//') && ((r = r.substring(2)), (t = !0)),
                (e = new a({
                  value: r,
                  inline: t,
                  source: {
            ...
            operator() {
              ...
              if ('+' === t || '-' === t)
                if (
                  ...
                  if (
                    (!this.current.nodes.length ||
                      (this.current.last && 'operator' === this.current.last.type)) &&
                    'word' === this.nextToken[0]
                  )
                    return this.word();
                ...
                t.forEach((i, a) => {
                  ...
                  if (~e.indexOf(i))
                    c = new s({
                      value: h.slice(1),
                      source: {
                        start: { line: this.currToken[2], column: this.currToken[3] + i },
                        end: { line: this.currToken[4], column: this.currToken[3] + (p - 1) },
                      },
                      sourceIndex: this.currToken[6] + t[a],
                    });
                    ...
                    (c = new (r && '(' === r[0] ? u : f)({
                      ...
                      'word' === c.type
                        ? ((c.isHex = /^#(.+)/.test(h)),
                          (c.isColor = /^#([0-9a-f]{3}|[0-9a-f]{4}|[0-9a-f]{6}|[0-9a-f]{8})$/i.test(
                            h
                          )))
            ...
            string() {
              let e,
                ...
                s = n.test(r),
                o = '';
              s && ((o = r.match(n)[0]), (r = r.slice(1, r.length - 1))),
                (e = new h({
                  value: r,
                  source: {
        ...
        Je = {};
      c(Je, { languages: () => On, options: () => Tn, parsers: () => Cn, printers: () => ss });
      var He = (e, t, r, n) => {
          if (!e || null != t)
            return t.replaceAll
              ? t.replaceAll(r, n)
        ...
        st = 'indent-if-break',
        ot = 'line-suffix',
        it = 'line-suffix-boundary',
        at = 'line',
        ut = 'label',
        lt = 'break-parent',
        ct = new Set([Ye, Ze, Xe, et, tt, rt, nt, st, ot, it, at, ut, lt]),
        pt = (e, t, r) => {
          if (!e || null != t)
            return Array.isArray(t) || 'string' == typeof t ? t[r < 0 ? t.length + r : r] : t.at(r);
        },
        ht = function (e) {
          if ('string' == typeof e) return Qe;
          if (Array.isArray(e)) return Ke;
          if (!e) return;
          let { type: t } = e;
      ...
      function dt(e) {
        return e.type !== at || e.hard ? (e.type === nt ? e.flatContents : e) : e.soft ? '' : ' ';
      }
      var mt = () => {},
        yt = mt,
        gt = mt,
      ...
      function bt(e, t) {
        return yt(t), { type: Xe, contents: t, n: e };
      }
      function xt(e, t = {}) {
        return (
          yt(e),
          gt(t.expandedStates, !0),
          {
            type: tt,
            id: t.id,
            contents: e,
      ...
      function Ot(e) {
        return vt(e), { type: rt, parts: e };
      }
      function Tt(e, t = '', r = {}) {
        return (
          yt(e),
          '' !== t && yt(t),
          { type: nt, breakContents: e, flatContents: t, groupId: r.groupId }
        );
      }
      function Ct(e) {
        return yt(e), { type: ot, contents: e };
      }
      var St = { type: lt },
        _t = { type: at },
        Et = { type: at, soft: !0 },
        At = [{ type: at, hard: !0 }, St];
      function jt(e, t) {
        yt(e), gt(t);
        let r = [];
      ...
      function Bt(e, t, r) {
        if (
          (Lt(e) && 'yaml' === e.language && delete t.value,
          'css-comment' === e.type &&
            'css-root' === r.type &&
            r.nodes.length > 0 &&
            (((r.nodes[0] === e || (Lt(r.nodes[0]) && r.nodes[1] === e)) &&
              (delete t.text, /^\*\s*@(?:format|prettier)\s*$/u.test(e.text))) ||
              ('css-root' === r.type && pt(!1, r.nodes, -1) === e)))
        )
          return null;
        if (
          ...
          ('media-feature' === e.type ||
            ...
            e.value &&
            (t.value = (function (e) {
              return He(!1, He(!1, e, "'", '"'), /\\([^\da-f])/giu, '$1');
            })(e.value)),
          'selector-combinator' === e.type && (t.value = He(!1, t.value, /\s+/gu, ' ')),
          'media-feature' === e.type && (t.value = He(!1, t.value, ' ', '')),
          (('value-word' === e.type &&
            ((e.isColor && e.isHex) ||
              ['initial', 'inherit', 'unset', 'revert'].includes(e.value.toLowerCase()))) ||
            'media-feature' === e.type ||
          ...
          'value-unknown' === e.type && (t.value = He(!1, t.value, /;$/gu, '')),
          'selector-attribute' === e.type &&
            ((t.attribute = e.attribute.trim()),
            e.namespace &&
              'string' == typeof e.namespace &&
              (t.namespace = e.namespace.trim() || !0),
            e.value && ((t.value = He(!1, t.value.trim(), /^["']|["']$/gu, '')), delete t.quoted)),
          ('media-value' === e.type ||
            'media-type' === e.type ||
            'value-number' === e.type ||
            'selector-root-invalid' === e.type ||
            ...
            'selector-tag' === e.type) &&
            e.value &&
            (t.value = He(!1, t.value, /([\d+.e-]+)([a-z]*)/giu, (e, t, r) => {
              let n = Number(t);
        ...
        if (
          ('css-atrule' === e.type && 'supports' === e.name.toLowerCase() && delete t.value,
        ...
        return 'value-comma_group' === e.type &&
          e.groups.some(
            (e) =>
      ...
      var Dt = qt,
        Ut = null;
      function Ft(e) {
        if (null !== Ut && (Ut.property, 1)) {
          let e = Ut;
          return (Ut = Ft.prototype = null), e;
        }
        return (Ut = Ft.prototype = e ?? Object.create(null)), new Ft();
      }
      for (let e = 0; e <= 10; e++) Ft();
      var Vt = (function (e, t = 'type') {
          return (
            (function (e) {
              Ft(e);
            })(e),
      ...
      function Zt(e, t) {
        ...
        if (
          'number' ==
          typeof (null == (n = null == (r = e.source) ? void 0 : r.start) ? void 0 : n.offset)
        )
          return e.source.start.offset;
        if ('number' == typeof e.sourceIndex)
          return 'value-word' === e.type ? Yt(e, e.sourceIndex) : e.sourceIndex;
        if (null != (s = e.source) && s.start) return Gt(e.source.start, t);
        throw Object.assign(new Error('Can not locate node.'), { node: e });
      }
      function Xt(e, t) {
        var r, n;
        if ('css-comment' === e.type && e.inline) return Kt(t, e.source.startOffset);
        if (
          'number' ==
          typeof (null == (n = null == (r = e.source) ? void 0 : r.end) ? void 0 : n.offset)
        )
          return e.source.end.offset;
        if (e.source) {
          if (e.source.end) {
            let r = Gt(e.source.end, t);
            return 'value-word' === e.type ? Yt(e, r) : r;
          }
          if (It(e.nodes)) return Xt(pt(!1, e.nodes, -1), t);
        }
        return null;
      }
      function er(e, t) {
        e.source && ((e.source.startOffset = Zt(e, t)), (e.source.endOffset = Xt(e, t)));
        for (let r in e) {
          let n = e[r];
          'source' === r ||
            !n ||
            ...
            ('value-root' === n.type || 'value-unknown' === n.type
              ? tr(n, rr(e), n.text || n.value)
              : er(n, t));
        }
      }
      function tr(e, t, r) {
        e.source && ((e.source.startOffset = Zt(e, r) + t), (e.source.endOffset = Xt(e, r) + t));
        for (let n in e) {
          let s = e[n];
          'source' === n || !s || 'object' != typeof s || tr(s, t, r);
        }
      }
      function rr(e) {
        var t;
        ...
        return (
          ...
          'css-atrule' === e.type &&
            ...
            (r += 1 + e.name.length + e.raws.afterName.match(/^\s*:?\s*/u)[0].length),
          'css-atrule' !== e.type &&
            'string' == typeof (null == (t = e.raws) ? void 0 : t.between) &&
      ...
      var or = /\*\/$/,
        ...
        fr = [];
      function dr(e, t) {
        return [...fr, ...(Array.isArray(t) ? t : [t])].map((t) => `@${e} ${t}`.trim());
      }
      var mr = ['noformat', 'noprettier'],
        yr = ['format', 'prettier'],
        gr = 'format';
      function vr(e) {
        let t = (function (e) {
        ...
        let r = (function (e) {
          ...
          { pragmas: n, comments: s } = (function (e) {
            e = He(!1, e.replace(ir, '').replace(or, ''), hr, '$1');
            let t = '';
            for (; t !== e; ) (t = e), (e = He(!1, e, cr, '\n$1 $2\n'));
            e = e.replace(lr, '').trimEnd();
            let r,
              n = Object.create(null),
              s = He(!1, e, pr, '').replace(lr, '').trimEnd();
            for (; (r = pr.exec(e)); ) {
              let e = He(!1, r[2], ur, '');
              if ('string' == typeof n[r[1]] || Array.isArray(n[r[1]])) {
                let t = n[r[1]];
                n[r[1]] = [...fr, ...(Array.isArray(t) ? t : [t]), e];
              } else n[r[1]] = e;
            }
      ...
      var wr = function (e) {
          ...
          let { raw: r } = t;
          return { frontMatter: t, content: He(!1, r, /[^\n]/gu, ' ') + e.slice(r.length) };
        },
        br = new Set([
          'red',
          'green',
        ...
        xr = new Set(['initial', 'inherit', 'unset', 'revert']);
      function kr(e, t) {
        var r;
        let n = e.findAncestor((e) => 'css-atrule' === e.type);
        return (
          (null == (r = null == n ? void 0 : n.name)
            ? void 0
            : r.toLowerCase().endsWith('keyframes')) && ['from', 'to'].includes(t.toLowerCase())
        );
      }
      function Or(e) {
        return e.includes('$') ||
      ...
      function _r(e) {
        ...
        return (
          !!t &&
          (('string' == typeof t && /^@.+:.*$/u.test(t)) || (t.value && /^@.+:.*$/u.test(t.value)))
        );
      }
      function Er(e) {
      ...
      function Dr(e, t) {
        return (
          '$$' === e.value &&
          'value-func' === e.type &&
          'value-word' === (null == t ? void 0 : t.type) &&
          !t.raws.before
        );
      }
      function Ur(e) {
        ...
        return (
          'value-paren_group' ===
            (null == (n = null == (r = null == (t = e.value) ? void 0 : t.group) ? void 0 : r.group)
              ? void 0
              : n.type) &&
      ...
      function Vr(e) {
        ...
        return (
          'value-comma_group' === e.type &&
          'value-colon' === (null == (r = null == (t = e.groups) ? void 0 : t[1]) ? void 0 : r.type)
        );
      }
      function Gr(e) {
        var t;
      ...
      function Jr(e, t) {
        ...
        let s = e.grandparent;
        if (!(Gr(n) || (s && Gr(s)))) return !1;
        let o = e.findAncestor((e) => 'css-decl' === e.type);
        return !!(
          (null != (r = null == o ? void 0 : o.prop) && r.startsWith('$')) ||
          Gr(s) ||
          'value-func' === s.type
        );
      }
      ...
      function tn(e) {
        return 'value-func' === e.type && br.has(e.value.toLowerCase());
      }
      function rn(e) {
      ...
      function nn(e) {
        return (
          'value-atword' === (null == e ? void 0 : e.type) &&
      ...
      function sn(e) {
        ...
        return (
          'value-paren_group' === e.type &&
          '(' === (null == (t = e.open) ? void 0 : t.value) &&
          ')' === (null == (r = e.close) ? void 0 : r.value)
        );
      }
      var on = new Map([
        ['em', 'em'],
      ...
      function hn(e) {
        return He(!1, e, ln, (e, t, r, n, s) =>
          !r && n && (s ?? (s = ''), !(s = s.toLowerCase()) || 'n' === s || on.has(s))
            ? fn(n) + (s ? an(s) : '')
            : e
        );
      }
      ...
      var dn = function (e, t, r) {
        ...
        mn = function (e, t, r = {}) {
          let n = Ht(e, r.backwards ? t - 1 : t, r);
          return n !== dn(e, n, r);
        },
        yn = function (e, t) {
          if (!1 === t) return !1;
        ...
        gn = function (e, t) {
          let r = null,
            n = t;
          for (; n !== r; ) (r = n), (n = Qt(e, n)), (n = yn(e, n)), (n = Ht(e, n));
          return (
            (n = (function (e, t) {
              return !1 !== t && ('/' === e.charAt(t) && '/' === e.charAt(t + 1) ? Kt(e, t) : t);
            })(e, n)),
            (n = dn(e, n)),
            !1 !== n && mn(e, n)
          );
      ...
      function vn(e, t) {
        return (function (e) {
          ...
          (function ({ node: e, parent: t }, r) {
            return !(
              !e.source || !r.originalText.slice(nr(e), nr(t.close)).trimEnd().endsWith(',')
            );
          })(e, t)
          ? ','
          : 'value-comment' === e.node.type ||
              ('value-comma_group' === e.node.type &&
                e.node.groups.every((e) => 'value-comment' === e.type)) ||
              !(function (e) {
      ...
      var xn = function (e, t, r) {
          ...
          return (
            e.each(() => {
              let { node: s, previous: o } = e;
              if (
                ('css-comment' === (null == o ? void 0 : o.type) &&
                'prettier-ignore' === o.text.trim()
                  ? n.push(t.originalText.slice(nr(s), sr(s)))
                  : n.push(r()),
                e.isLast)
              )
                return;
              let { next: i } = e;
              ('css-comment' === i.type &&
                !mn(t.originalText, nr(i), { backwards: !0 }) &&
                !Lt(s)) ||
              ('css-atrule' === i.type && 'else' === i.name && 'css-comment' !== s.type)
                ? n.push(' ')
                : (n.push(t.__isHTMLStyleAttribute ? _t : At),
                  gn(t.originalText, sr(s)) && !Lt(s) && n.push(At));
            }, 'nodes'),
            n
          );
        },
            ...
            switch (l.type) {
              ...
              case 'css-root': {
                let n = xn(e, t, r),
                  s = l.raws.after.trim();
                return (
                  s.startsWith(';') && (s = s.slice(1).trim()),
                  [
                    l.frontMatter ? [r('frontMatter'), At] : '',
                    n,
                    s ? ` ${s}` : '',
                    l.nodes.length > 0 ? At : '',
                  ]
              ...
              case 'css-comment': {
                let e = l.inline || l.raws.inline,
                  r = t.originalText.slice(nr(l), sr(l));
              ...
              case 'css-rule':
                return [
                  ...
                  l.nodes
                    ? [
                        'selector-unknown' === (null == (n = l.selector) ? void 0 : n.type) &&
                        rn(l.selector.value)
                          ? _t
                          : l.selector
                            ? ' '
                            : '',
                        '{',
                        l.nodes.length > 0 ? wt([At, xn(e, t, r)]) : '',
                        At,
                        '}',
                        _r(l) ? ';' : '',
                      ]
              ...
              case 'css-decl': {
                let n = e.parent,
                  ...
                  a = i.trim(),
                  u = ':' === a,
                  c = 'string' == typeof l.value && /^ *$/u.test(l.value),
                  p = 'string' == typeof l.value ? l.value : r('value');
                return (
                  (p = (function (e) {
                    var t, r;
                    return (
                      'value-root' === (null == (t = e.value) ? void 0 : t.type) &&
                      'value-value' === (null == (r = e.value.group) ? void 0 : r.type) &&
                          ...
                          return (function e(n) {
                            ...
                            let s = (function (r) {
                              switch (ht(r)) {
                                ...
                                case tt: {
                                  let { expandedStates: n, contents: s } = r;
                                  return (
                                    n ? ((n = n.map(e)), (s = n[0])) : (s = e(s)),
                                    t({ ...r, contents: s, expandedStates: n })
                                  );
                                }
                                case Xe:
                                case Ze:
                  ...
                  !u &&
                    rn(a) &&
                    !(
                      null != (o = null == (s = l.value) ? void 0 : s.group) &&
                      o.group &&
                      e.call(() => wn(e), 'value', 'group', 'group')
                    ) &&
                    (p = wt([At, kt(p)])),
                  [
                    He(!1, l.raws.before, /[\s;]/gu, ''),
                    ('css-atrule' === n.type && n.variable) || Cr(e) ? l.prop : Or(l.prop),
                    a.startsWith('//') ? ' ' : '',
                    a,
                    l.extend || c ? '' : ' ',
                    'less' === t.parser && l.extend && l.selector
                      ? ['extend(', r('selector'), ')']
                      : '',
                    p,
                    l.raws.important
                      ? l.raws.important.replace(/\s*!\s*important/iu, ' !important')
                      : l.important
                        ? ' !important'
                        : '',
                    l.raws.scssDefault
                      ? l.raws.scssDefault.replace(/\s*!default/iu, ' !default')
                      : l.scssDefault
                        ? ' !default'
                        : '',
                    l.raws.scssGlobal
                      ? l.raws.scssGlobal.replace(/\s*!global/iu, ' !global')
                      : l.scssGlobal
                        ? ' !global'
                        : '',
                    l.nodes
                      ? [' {', wt([Et, xn(e, t, r)]), Et, '}']
                      : qr(l) && !n.raws.semicolon && ';' !== t.originalText[sr(l) - 1]
                        ? ''
                        : t.__isHTMLStyleAttribute && e.isLast
                          ? Tt(';')
                          : ';',
                  ]
                );
              ...
              case 'css-atrule': {
                let n = e.parent,
                  s = zr(l) && !n.raws.semicolon && ';' !== t.originalText[sr(l) - 1];
                if ('less' === t.parser) {
                  if (l.mixin)
                    return [r('selector'), l.important ? ' !important' : '', s ? '' : ';'];
                  if (l.function)
                    return [
                      l.name,
                      'string' == typeof l.params ? l.params : r('params'),
                      s ? '' : ';',
                    ];
                  if (l.variable)
                    return [
                      ...
                      ': ',
                      l.value ? r('value') : '',
                      l.raws.between.trim() ? l.raws.between.trim() + ' ' : '',
                      l.nodes
                        ? ['{', wt([l.nodes.length > 0 ? Et : '', xn(e, t, r)]), Et, '}']
                        : '',
                      s ? '' : ';',
                    ];
                }
                let o =
                  'import' === l.name &&
                  'value-unknown' === (null == (i = l.params) ? void 0 : i.type) &&
                  l.params.value.endsWith(';');
                return [
                  '@',
                  Br(l) || l.name.endsWith(':') || zr(l) ? l.name : Or(l.name),
                  l.params
                    ? [
                        Br(l)
                          ? ''
                    ...
                    : '',
                  l.selector ? wt([' ', r('selector')]) : '',
                  l.value
                    ? xt([' ', r('value'), Wr(l, t) ? (Ur(l) ? ' ' : _t) : ''])
                    : 'else' === l.name
                      ? ' '
                      : '',
                  l.nodes
                    ? [
                        Wr(l, t)
                          ...
                          : (l.selector &&
                                !l.selector.nodes &&
                                'string' == typeof l.selector.value &&
                                rn(l.selector.value)) ||
                              (!l.selector && 'string' == typeof l.params && rn(l.params))
                            ? _t
                            : ' ',
                        '{',
                        wt([l.nodes.length > 0 ? Et : '', xn(e, t, r)]),
                        Et,
                        '}',
                      ]
                    : s || o
              ...
              case 'media-query':
                return [jt(' ', e.map(r, 'nodes')), e.isLast ? '' : ','];
              case 'media-type':
              case 'media-value':
                return hn(cn(l.value, t));
              case 'media-feature-expression':
                return l.nodes ? ['(', ...e.map(r, 'nodes'), ')'] : l.value;
              case 'media-feature':
                return Or(cn(He(!1, l.value, / +/gu, ' '), t));
              case 'media-colon':
                return [l.value, ' '];
              case 'media-keyword':
              case 'selector-string':
                return cn(l.value, t);
              case 'media-url':
                return cn(He(!1, He(!1, l.value, /^url\(\s+/giu, 'url('), /\s+\)$/gu, ')'), t);
              case 'media-unknown':
              ...
              case 'selector-root':
                return xt([
                  Sr(e, 'custom-selector')
                    ? [e.findAncestor((e) => 'css-atrule' === e.type).customSelector, _t]
                    : '',
                  jt(
                    [',', Sr(e, ['extend', 'custom-selector', 'nest']) ? _t : At],
                    e.map(r, 'nodes')
                  ),
                ]);
              case 'selector-selector':
                return xt((l.nodes.length > 2 ? wt : (e) => e)(e.map(r, 'nodes')));
              case 'selector-tag':
                return [
                  l.namespace ? [!0 === l.namespace ? '' : l.namespace.trim(), '|'] : '',
                  'selector-nesting' === (null == (a = e.previous) ? void 0 : a.type)
                    ? l.value
                    : hn(kr(e, l.value) ? l.value.toLowerCase() : l.value),
                ];
              case 'selector-id':
                return ['#', l.value];
              case 'selector-class':
              ...
              case 'selector-attribute':
                return [
                  ...
                  l.attribute.trim(),
                  l.operator ?? '',
                  l.value ? pn(cn(l.value.trim(), t), t) : '',
                  l.insensitive ? ' i' : '',
                  ']',
                ];
              case 'selector-combinator':
                if ('+' === l.value || '>' === l.value || '~' === l.value || '>>>' === l.value) {
                  let t = e.parent;
                  return [
                    'selector-selector' === t.type && t.nodes[0] === l ? '' : _t,
                    l.value,
                    e.isLast ? '' : ' ',
                  ];
                }
                return [l.value.trim().startsWith('(') ? _t : '', hn(cn(l.value.trim(), t)) || _t];
              ...
              case 'selector-pseudo':
                return [
                  Or(l.value),
                  It(l.nodes) ? xt(['(', wt([Et, jt([',', _t], e.map(r, 'nodes'))]), Et, ')']) : '',
                ];
              case 'selector-unknown': {
                let r = e.findAncestor((e) => 'css-rule' === e.type);
                if (null != r && r.isSCSSNesterProperty) return hn(cn(Or(l.value), t));
                let n = e.parent;
                ...
                let s = e.grandparent;
                if (
                  'value-paren_group' === n.type &&
                  'value-func' === (null == s ? void 0 : s.type) &&
                  'selector' === s.value
                ) {
                  let e = sr(n.open) + 1,
                    r = nr(n.close),
              ...
              case 'value-root':
                return r('group');
              case 'value-comment':
                return t.originalText.slice(nr(l), sr(l));
                ...
                return (function (e, t, r) {
                  ...
                  let { node: s } = e,
                    ...
                    a = (function (e) {
                      ...
                      return null ==
                        (r =
                          null == (t = e.findAncestor((e) => 'css-decl' === e.type))
                            ? void 0
                            : t.prop)
                        ? void 0
                        : r.toLowerCase();
                    ...
                    u =
                      a &&
                      'value-value' === o.type &&
                      ('grid' === a || a.startsWith('grid-template')),
                    l = e.findAncestor((e) => 'css-atrule' === e.type),
                    c = l && Wr(l, t),
                    p = s.groups.some((e) => Hr(e)),
                    h = e.map(r, 'groups'),
                    f = [''],
                    d = Tr(e, 'url'),
                    m = !1,
                  ...
                  for (let r = 0; r < s.groups.length; ++r) {
                    ...
                    if ((f.push([f.pop(), h[r]]), d)) {
                      ((g && Mr(g)) || Mr(p)) && f.push([f.pop(), ' ']);
                      continue;
                    }
                    if (
                      (Xr(g) &&
                        'value-word' === p.type &&
                        f.length > 2 &&
                        s.groups.slice(0, r).every((e) => 'value-comment' === e.type) &&
                        !Hr(a) &&
                        (f[f.length - 2] = kt(pt(!1, f, -2))),
                      (Sr(e, 'forward') &&
                        'value-word' === p.type &&
                        p.value &&
                        void 0 !== a &&
                        ...
                        (Sr(e, 'utility') &&
                          ...
                          '*' === g.value) ||
                        !g ||
                        ('value-word' === p.type && nn(g) && sr(p) === nr(g)))
                    )
                      continue;
                    ...
                    if (
                      ...
                      Xr(p) ||
                      Xr(g) ||
                      ('value-atword' === p.type && ('' === p.value || p.value.endsWith('['))) ||
                      ('value-word' === g.type && g.value.startsWith(']')) ||
                      '~' === p.value ||
                      ('value-string' !== p.type &&
                        p.value &&
                        p.value.includes('\\') &&
                      ...
                      (null != a &&
                        a.value &&
                        a.value.indexOf('\\') === a.value.length - 1 &&
                        'value-operator' === p.type &&
                        '/' === p.value) ||
                      '\\' === p.value ||
                      Dr(p, g) ||
                      Qr(p) ||
                    ...
                    if (
                      (((w && Qr(g)) || (b && Yr(p))) && Fr(g)) ||
                      (!a && Pr(p)) ||
                      (Tr(e, 'calc') && (Mr(p) || Mr(g) || $r(p) || $r(g)) && Fr(g))
                    )
                      continue;
                    let x =
                        (Mr(p) || $r(p)) &&
                        ...
                        !Fr(g),
                      k =
                        'value-func' === (null == v ? void 0 : v.type) ||
                        (v && Zr(v)) ||
                        'value-func' === p.type ||
                        Zr(p),
                      O =
                        'value-func' === g.type ||
                        Zr(g) ||
                        'value-func' === (null == a ? void 0 : a.type) ||
                        (a && Zr(a));
                    if (
                      'scss' === t.parser &&
                      w &&
                      ...
                      if (u) {
                        p.source && g.source && p.source.start.line !== g.source.start.line
                          ? (f.push(At, ''), (y = !0))
                          : f.push([f.pop(), ' ']);
                        continue;
                      }
                      ...
                      if (
                        ...
                        if (nn(p) && sn(g) && sr(p) === nr(g.open)) {
                          f.push(Et, '');
                          continue;
                        }
                        if ('with' === p.value && sn(g)) {
                          f = [[Ot(f), ' ']];
                          continue;
                        }
                        (null != (n = p.value) &&
                  ...
                  return (
                    ...
                    c
                      ...
                      : (function (e) {
                            ...
                            let { node: r } = e;
                            return (
                              'url' === r.groups[0].value &&
                              2 === r.groups.length &&
                              'import' ===
                                (null == (t = e.findAncestor((e) => 'css-atrule' === e.type))
                                  ? void 0
                                  : t.name)
                            );
                          })(e)
              ...
              case 'value-paren_group':
                return (function (e, t, r) {
                  let { node: n, parent: s } = e,
                    o = e.map(({ node: e }) => ('string' == typeof e ? e : r()), 'groups');
                  if (
                    s &&
                    (function (e) {
                    ...
                    return [n.open ? r('open') : '', jt(',', o), n.close ? r('close') : ''];
                  if (!n.open) {
                    let t = wn(e);
                    gt(o);
                    let r = (function (e) {
                      ...
                      n = jt(t ? At : _t, r);
                    return wt(t ? [At, n] : xt([bn(e) ? Et : '', Ot(n)]));
                  }
                  let i = e.map(({ node: r, isLast: n, index: s }) => {
                      var i;
                      let a = o[s];
                      Vr(r) &&
                        'value-comma_group' === r.type &&
                        r.groups &&
                        'value-paren_group' !== r.groups[0].type &&
                        'value-paren_group' === (null == (i = r.groups[2]) ? void 0 : i.type) &&
                        ht(a) === tt &&
                        ht(a.contents) === Ze &&
                        ht(a.contents.contents) === rt &&
                        (a = xt(kt(a)));
                      let u = [a, n ? vn(e, t) : ','];
                      if (!n && 'value-comma_group' === r.type && It(r.groups)) {
                        let e = pt(!1, r.groups, -1);
                        !e.source && e.close && (e = e.close),
                          e.source && gn(t.originalText, sr(e)) && u.push(At);
                      }
                      return u;
                    }, 'groups'),
                    a = (function (e, t) {
                    ...
                    u = (function (e, t) {
                      var r, n;
                      if (
                        '(' !== (null == (r = e.open) ? void 0 : r.value) ||
                        ')' !== (null == (n = e.close) ? void 0 : n.value) ||
                        e.groups.some((e) => 'value-comma_group' !== e.type)
                      )
                        return !1;
                      if ('value-comma_group' === t.type) {
                        let r = t.groups.indexOf(e) - 1,
                          n = t.groups[r];
                        if ('value-word' === (null == n ? void 0 : n.type) && 'with' === n.value)
                          return !0;
                      }
                      return !1;
                    })(n, s),
                    ...
                    p = u || a,
                    h = xt(
                      [n.open ? r('open') : '', wt([Et, jt(_t, i)]), Et, n.close ? r('close') : ''],
                      { shouldBreak: c }
                    );
                  return p ? kt(h) : h;
                })(e, t, r);
              case 'value-func':
                return [l.value, Sr(e, 'supports') && en(l) ? ' ' : '', r('group')];
              case 'value-number':
                return [fn(l.value), an(l.unit)];
              case 'value-word':
              ...
              case 'value-colon': {
                ...
                return xt([
                  l.value,
                  ('string' == typeof (null == t ? void 0 : t.value) && t.value.endsWith('\\')) ||
                  Tr(e, 'url')
                    ? ''
                    : _t,
                ]);
              ...
              case 'value-atword':
                return ['@', l.value];
              default:
                throw new Nt(l, 'PostCSS');
            }
          },
          embed: Dt,
          insertPragma: function (e) {
            let { frontMatter: t, content: r } = wr(e);
            return (
              (t ? t.raw + '\n\n' : '') +
              (function (e) {
                let { shebang: t, text: r, pragmas: n, comments: s } = vr(e),
                  o = (function (e) {
                    let t = e.match(ar),
                      r = null == t ? void 0 : t[0];
                    return null == r ? e : e.slice(r.length);
                  })(r),
                  i = (function ({ comments: e = '', pragmas: t = {} }) {
                    let r = '\n',
                      n = ' *',
                      s = Object.keys(t),
                      o = s
                    ...
                    let i =
                      e
                        ...
                        .map((e) => `${n} ${e}`)
                        .join(r) + r;
                    return '/**\n' + (e ? i : '') + (e && s.length > 0 ? n + r : '') + o + ' */';
                  })({ pragmas: { [gr]: '', ...n }, comments: s.trimStart() });
                return (t ? `${t}\n` : '') + i + (o.startsWith('\n') ? '\n' : '\n\n') + o;
              })(r)
            );
          },
      ...
      function jn(e) {
        if (e && 'object' == typeof e) {
          delete e.parent;
          for (let t in e) jn(e[t]);
          !Array.isArray(e) && e.value && !e.type && (e.type = 'unknown');
        }
        return e;
      }
      var In = p(se(), 1).default.default,
        Pn = function (e) {
          let t;
          try {
            t = In(e);
        ...
        Bn = function (e) {
          return e.some(
            (e) => 'string' === e.type || ('func' === e.type && !e.value.endsWith('\\'))
          );
        },
        zn = function (e, t) {
          return !(
            'scss' !== t.parser ||
            'word' !== (null == e ? void 0 : e.type) ||
            !e.value.startsWith('$')
          );
        },
        qn = (e) => 'paren' === e.type && ')' === e.value;
      function Dn(e, t) {
        var r;
        let { nodes: n } = e,
        ...
        for (let i = 0; i < n.length; ++i) {
          ...
          if (
            ...
            'func' === l.type &&
              'selector' === l.value &&
              (l.group.groups = [
                $n(Nn(e).text.slice(l.group.open.sourceIndex + 1, l.group.close.sourceIndex)),
              ]),
            'func' === l.type && 'url' === l.value)
          ) {
            let e = (null == (r = l.group) ? void 0 : r.groups) ?? [],
              n = [];
            for (let t = 0; t < e.length; t++) {
              let r = e[t];
              'comma_group' === r.type ? (n = [...n, ...r.groups]) : n.push(r);
            }
            (Wn(n) || (!Bn(n) && !zn(n[0], t))) && (l.group.groups = [Ln(l)]);
          }
          if ('paren' === l.type && '(' === l.value)
            (s = { open: l, close: null, groups: [], type: 'paren_group' }),
              o.push(s),
              (a = { groups: [], type: 'comma_group' }),
              u.push(a);
          else if (qn(l)) {
            if ((a.groups.length > 0 && s.groups.push(a), (s.close = l), 1 === u.length))
              throw new Error('Unbalanced parenthesis');
            u.pop(), (a = pt(!1, u, -1)), a.groups.push(s), o.pop(), (s = pt(!1, o, -1));
          } else if ('comma' === l.type) {
            if (i === n.length - 3 && 'comment' === n[i + 1].type && qn(n[i + 2])) continue;
            s.groups.push(a), (a = { groups: [], type: 'comma_group' }), (u[u.length - 1] = a);
          } else a.groups.push(l);
        }
        return a.groups.length > 0 && s.groups.push(a), i;
      }
      function Un(e) {
        return ('paren_group' === e.type && !e.open && !e.close && 1 === e.groups.length) ||
          ('comma_group' === e.type && 1 === e.groups.length)
          ? Un(e.groups[0])
          : 'paren_group' === e.type || 'comma_group' === e.type
            ? { ...e, groups: e.groups.map(Un) }
            : e;
      }
      function Fn(e, t) {
        if (e && 'object' == typeof e)
          for (let r in e)
            'parent' !== r &&
              (Fn(e[r], t), 'nodes' === r && ((e.group = Un(Dn(e, t))), delete e[r]));
        return e;
      }
      var Vn = function (e, t) {
          ...
          let r = null;
          try {
            r = new Rn.default(e, { loose: !0 }).parse();
          } catch {
            return { type: 'value-unknown', value: e };
          }
          return (r.text = e), An(Fn(r, t), 'value-', /^selector-/u);
        },
        Gn = new Set(['import', 'use', 'forward']),
        Jn = /(\s*)(!default).*$/u,
        Hn = /(\s*)(!global).*$/u;
      function Qn(e, t) {
        var r, n;
        if (e && 'object' == typeof e) {
          delete e.parent;
          for (let r in e) Qn(e[r], t);
          if (!e.type) return e;
          if (
            (e.raws ?? (e.raws = {}),
            'css-decl' === e.type &&
              'string' == typeof e.prop &&
              e.prop.startsWith('--') &&
              'string' == typeof e.value &&
              e.value.startsWith('{'))
          ) {
            ...
            if (e.value.trimEnd().endsWith('}')) {
              let s,
                ...
                a =
                  'a'.repeat(e.prop.length) +
                  t.originalText.slice(e.source.start.offset + e.prop.length, e.source.end.offset),
                u = He(!1, i, /[^\n]/gu, ' ') + a;
              s = 'scss' === t.parser ? Xn : 'less' === t.parser ? Zn : Yn;
              try {
                o = s(u, { ...t });
              } catch {}
              1 === (null == (r = null == o ? void 0 : o.nodes) ? void 0 : r.length) &&
                'css-rule' === o.nodes[0].type &&
                (n = o.nodes[0].nodes);
            }
            return (
              (e.value = n
                ? { type: 'css-rule', nodes: n }
                : { type: 'value-unknown', value: e.raws.value.raw }),
              e
            );
          }
          let s = '';
          'string' == typeof e.selector &&
            ((s = e.raws.selector ? (e.raws.selector.scss ?? e.raws.selector.raw) : e.selector),
            e.raws.between && e.raws.between.trim().length > 0 && (s += e.raws.between),
            (e.raws.selector = s));
          let o = '';
          'string' == typeof e.value &&
            ((o = e.raws.value ? (e.raws.value.scss ?? e.raws.value.raw) : e.value),
            (e.raws.value = o.trim()));
          let i = '';
          if (
            ('string' == typeof e.params &&
              ((i = e.raws.params ? (e.raws.params.scss ?? e.raws.params.raw) : e.params),
              e.raws.afterName && e.raws.afterName.trim().length > 0 && (i = e.raws.afterName + i),
          ...
          if (o.trim().length > 0) {
            ...
            r &&
              ((o = o.slice(0, r.index)),
              (e.scssDefault = !0),
              '!default' !== r[0].trim() && (e.raws.scssDefault = r[0]));
            let n = o.match(Hn);
            if (
              (n &&
                ((o = o.slice(0, n.index)),
                (e.scssGlobal = !0),
                '!global' !== n[0].trim() && (e.raws.scssGlobal = n[0])),
              o.startsWith('progid:'))
            )
          ...
          if (
            ('less' === t.parser &&
              ...
              e.extend && !e.selector && (delete e.value, (e.selector = $n(o.slice(7, -1))))),
            'css-atrule' === e.type)
          ) {
            if ('less' === t.parser) {
              if (e.mixin) {
                let t = e.raws.identifier + e.name + e.raws.afterName + e.raws.params;
                return (e.selector = $n(t)), delete e.params, e;
              }
            ...
            if ('css' === t.parser && 'custom-selector' === e.name) {
              ...
              return (
                (e.customSelector = t),
                (e.selector = $n(e.params.slice(t.length).trim())),
                delete e.params,
                e
              );
            }
            if ('less' === t.parser) {
              if (e.name.includes(':') && !e.params) {
                e.variable = !0;
                let r = e.name.split(':');
                (e.name = r[0]), (e.value = Vn(r.slice(1).join(':'), t));
              }
              if (
                !['page', 'nest', 'keyframes'].includes(e.name) &&
                ':' === (null == (n = e.params) ? void 0 : n[0])
              ) {
                e.variable = !0;
                let r = e.params.slice(1);
                r && (e.value = Vn(r, t)), (e.raws.afterName += ':');
              }
          ...
          if ('css-atrule' === e.type && i.length > 0) {
            ...
            return 'warn' === r || 'error' === r
              ? ((e.params = { type: 'media-unknown', value: i }), e)
              : 'extend' === r || 'nest' === r
                ? ((e.selector = $n(i)), delete e.params, e)
                : 'at-root' === r
                  ? (/^\(\s*(?:without|with)\s*:.+\)$/su.test(i)
                      ? (e.params = Vn(i, t))
                      : ((e.selector = $n(i)), delete e.params),
                    e)
                  : (function (e) {
                        return Gn.has(e);
                      })(n)
                    ? ((e.import = !0), delete e.filename, (e.params = Vn(i, t)), e)
                    : [
                          'namespace',
                          'supports',
                          'if',
                      ...
                      ? ((i = i.replace(/(\$\S+?)(\s+)?\.{3}/u, '$1...$2')),
                        (i = i.replace(/^(?!if)(\S+)(\s+)\(/u, '$1($2')),
                        (e.value = Vn(i, t)),
                        delete e.params,
                        e)
      ...
      function Kn(e, t, r) {
        ...
        try {
          ...
          let { name: t, reason: r, line: n, column: s } = e;
          throw 'number' != typeof n
            ? e
            : (function (e, t) {
              ...
              })(`${t}: ${r}`, { loc: { start: { line: n, column: s } }, cause: e });
        }
        return (
          (r.originalText = t),
          (n = Qn(An(n, 'css-'), r)),
          er(n, t),
          o && ((o.source = { startOffset: 0, endOffset: o.raw.length }), (n.frontMatter = o)),
          n
        );
      }
      function Yn(e, t = {}) {
        return Kn(Sn.default.default, e, t);
      }
      function Zn(e, t = {}) {
        return Kn(
          (e) =>
                ...
                for (let i = 0; i < e.length; i++) {
                  ...
                  switch (r) {
                    case 'initial':
                      ...
                      if ('/' === a && '/' === e[i - 1]) {
                        (r = 'comment-inline'), (t = i - 1);
                        continue;
                      }
                      continue;
                    case 'single-quotes':
                      if (
                        ("'" === a && '\\' !== e[i - 1] && ((r = n), (n = 'initial')),
                        '\n' === a || '\r' === a)
                      )
                        return e;
                      continue;
                    ...
                    case 'comment-inline':
                      ('"' === a || "'" === a || '*' === a) && (s = !0),
                        ('\n' === a || '\r' === a) &&
                          (s && o.push([t, i]), (r = 'initial'), (s = !1));
                      continue;
                  }
                }
                for (let [t, r] of o)
                  e = e.slice(0, t) + He(!1, e.slice(t, r), /["'*]/gu, ' ') + e.slice(r);
                return e;
              })(e)
            ),
          e,
      ...
      var es = {
          ...
          hasPragma: function (e) {
            return (function (e) {
              let { pragmas: t } = vr(e);
              return yr.some((e) => Object.prototype.hasOwnProperty.call(t, e));
            })(wr(e).content);
          },
          hasIgnorePragma: function (e) {
            return (function (e) {
              let { pragmas: t } = vr(e);
              return mr.some((e) => Object.prototype.hasOwnProperty.call(t, e));
            })(wr(e).content);
          },
          locStart: nr,
          locEnd: sr,
...
//# sourceMappingURL=220.extension.js.map
