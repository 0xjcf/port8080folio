(() => {
  ...
  type Theme = typeof LIGHT_THEME | typeof DARK_THEME | typeof AUTO_THEME;

  class ThemeManager {
    private currentTheme: Theme;
    private mediaQuery: MediaQueryList;
    private toggleButton: HTMLButtonElement | null = null;
    private _transformTimeout: ReturnType<typeof setTimeout> | null = null;
    private _mediaChangeHandler: ((e: MediaQueryListEvent | MediaQueryList) => void) | null = null;
    ...
    createToggleButton() {
      ...
      const controls = document.querySelector('.site-nav__controls');
      if (controls) {
    ...
    getNextTheme(): Theme {
      const themes: Theme[] = [LIGHT_THEME, DARK_THEME, AUTO_THEME];
    ...
    bindEvents() {
      ...
      const mediaChangeHandler = (_e: MediaQueryListEvent | MediaQueryList) => {
        if (this.currentTheme === AUTO_THEME) {
          this.applyTheme();
        }
      };
