...
const parentMachine = setup({
    ...
    async createHighlightedOutput(code) {
        ...
        // Debug log
        console.log('XState test - highlighted content sample:', highlightedContent.substring(0, 200) + '...');
    ...
    generateDebugInfo(testCase, result) {
        ...
        const xstateVars = ['--xstate-keyword', '--context-property', '--event-property', '--state-name', '--event-name'];
...
console.log('v2-test-xstate registered');
