...
const taskMachine = createMachine({
    ...
    async createHighlightedOutput(code) {
        ...
        // Debug log
        console.log('Sections test - highlighted content sample:', highlightedContent.substring(0, 200) + '...');
    ...
    validateSectionHighlighting(content, originalCode) {
        ...
        const hasSectionElements = content.includes('section-marker') || 
        ...
        validations.push({
            ...
            issues: hasSectionElements || sections.length === 0 ? [] : 
        ...
        const sectionHeaders = sections.filter(section => 
        ...
        validations.push({
            ...
            issues: sectionHeaders.length >= Math.min(2, sections.length) ? [] : 
        ...
        const hasCodeStructure = content.includes('import') || 
...
console.log('V2 Sections Parser registered');